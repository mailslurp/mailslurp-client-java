...
- [JavaDoc library website](https://mailslurp.github.io/mailslurp-client-java/)
- [Method Documentation](https://docs.mailslurp.com/java/docs)
...
- [EmailController](https://mailslurp.github.io/mailslurp-client-java/com/mailslurp/apis/EmailControllerApi.html) read and send emails
- [InboxController](https://mailslurp.github.io/mailslurp-client-java/com/mailslurp/apis/InboxControllerApi.html) create email account inboxes
- [WaitForController](https://mailslurp.github.io/mailslurp-client-java/com/mailslurp/apis/WaitForControllerApi.html) wait for expected emails or sms to arrive
- [SMSController](https://mailslurp.github.io/mailslurp-client-java/com/mailslurp/apis/SmsControllerApi.html) control phone and sms

For more controller documentation see the [JavaDocs](https://mailslurp.github.io/mailslurp-client-java/).
...
The library is organized into controller classes that reflect the [MailSlurp REST API](https://mailslurp.github.io/mailslurp-client-java/com/mailslurp/apis/package-summary.html). To use a controller first create a default client with your API Key.
...
You can use either the [`InboxControllerApi`](https://mailslurp.github.io/mailslurp-client-java/com/mailslurp/apis/InboxControllerApi.html) or the [`CommonActionsControllerApi`](https://mailslurp.github.io/mailslurp-client-java/com/mailslurp/apis/CommonActionsControllerApi.html) classes to interact with inboxes.
...
Inbox responses are paginated. You can set the page index and size with [method parameters](https://mailslurp.github.io/mailslurp-client-java/com/mailslurp/apis/InboxControllerApi.html).
...
Verify that an email address is a real mailbox using the EmailVerificationControllerApi methods.
...
#### Verify emails during email sending

You can filter email addresses that have bounced or an non-existing when you send an email to maintain a good sender reputation.
...
To send attachments first upload them as base64 strings before sending (that way you can re-use them). Use the [AttachmentController](https://mailslurp.github.io/mailslurp-client-java/com/mailslurp/apis/AttachmentControllerApi.html) methods to send and receive attachments in Java.
...
You can receive emails using the `waitFor` methods on the [WaitForControllerApi](https://mailslurp.github.io/mailslurp-client-java/com/mailslurp/apis/WaitForControllerApi.html) class.
...
You can fetch metadata for an email's attachments or fetch the attachment files themselves as byte streams using the [attachment controller](https://mailslurp.github.io/mailslurp-client-java/com/mailslurp/apis/AttachmentControllerApi.html).
...
You can reply to an email in Java using the [email controller](https://mailslurp.github.io/mailslurp-client-java/com/mailslurp/models/Email.html). Here is an example.
...
There are various search and match options available in the [WaitForControllerApi](https://mailslurp.github.io/mailslurp-client-java/com/mailslurp/apis/WaitForControllerApi.html).
