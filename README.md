...
- [EmailController](https://docs.mailslurp.com/java/docs/EmailControllerApi/) read and send emails
- [InboxController](https://docs.mailslurp.com/java/docs/InboxControllerApi/) create email account inboxes
- [WaitForController](https://docs.mailslurp.com/java/docs/WaitForControllerApi/) wait for expected emails or sms to arrive
- [SMSController](https://docs.mailslurp.com/java/docs/SmsControllerApi/) control phone and sms
