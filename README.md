...
- [Java Method Documentation](https://docs.mailslurp.com/java/docs)
...
- [WaitForController](https://docs.mailslurp.com/java/docs/WaitForControllerApi/) wait for expected emails to arrive
