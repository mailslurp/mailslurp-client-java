...
- [SMSController](https://mailslurp.github.io/mailslurp-client-java/index.html?com/mailslurp/apis/EmailControllerApi.html) control phone and sms
...
The library is organized into controller classes that reflect the [MailSlurp REST API](https://docs.mailslurp.com/java/docs/). To use a controller first create a default client with your API Key.
...
You can use either the [`InboxControllerApi`](https://docs.mailslurp.com/java/docs/InboxControllerApi/) or the [`CommonActionsControllerApi`](https://docs.mailslurp.com/java/docs/CommonActionsControllerApi/) classes to interact with inboxes.
...
Inbox responses are paginated. You can set the page index and size with [method parameters](https://docs.mailslurp.com/java/docs/InboxControllerApi/).
...
To send attachments first upload them as base64 strings before sending (that way you can re-use them). Use the [AttachmentController](https://docs.mailslurp.com/java/docs/AttachmentControllerApi/) methods to send and receive attachments in Java.
...
You can receive emails using the `waitFor` methods on the [WaitForControllerApi](https://docs.mailslurp.com/java/docs/WaitForControllerApi/) class.
...
You can fetch metadata for an email's attachments or fetch the attachment files themselves as byte streams using the [attachment controller](https://docs.mailslurp.com/java/docs/AttachmentControllerApi/).
...
You can reply to an email in Java using the [email controller](https://docs.mailslurp.com/java/docs/Email/). Here is an example.
...
There are various search and match options available in the [WaitForControllerApi](https://docs.mailslurp.com/java/docs/WaitForControllerApi/).
