...
public class CommonActionsControllerApiTest {
    ...
    public void createNewEmailAddressTest() throws ApiException {
        ...
        Inbox response = api.createNewEmailAddress(allowTeamAccess, expiresAt, expiresIn, useDomainPool);
    ...
    public void createNewEmailAddress1Test() throws ApiException {
        ...
        Long expiresIn = null;
        Boolean useDomainPool = null;
        Inbox response = api.createNewEmailAddress1(allowTeamAccess, expiresAt, expiresIn, useDomainPool);
