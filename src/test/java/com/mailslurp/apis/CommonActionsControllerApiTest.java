...
public class CommonActionsControllerApiTest {
    ...
    public void createNewEmailAddressTest() throws ApiException {
        ...
        InboxDto response = api.createNewEmailAddress(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox);
    ...
    public void createRandomInboxTest() throws ApiException {
        ...
        Boolean favourite = null;
        Boolean virtualInbox = null;
        InboxDto response = api.createRandomInbox(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox);
