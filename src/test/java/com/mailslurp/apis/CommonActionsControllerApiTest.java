...
public class CommonActionsControllerApiTest {
    ...
    public void createNewEmailAddressTest() throws ApiException {
        ...
        InboxDto response = api.createNewEmailAddress(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite);
    ...
    public void createNewEmailAddress1Test() throws ApiException {
        ...
        List<String> tags = null;
        Boolean favourite = null;
        InboxDto response = api.createNewEmailAddress1(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite);
