...
public class PhoneControllerApiTest {
    ...
    public void getPhoneNumbersTest() throws ApiException {
        ...
        PagePhoneNumberProjection response = api.getPhoneNumbers(phoneCountry, page, size, sort, since, before);
    ...
    public void testPhoneNumberSendSmsTest() throws ApiException {
        ...
        String xTestId = null;
        api.testPhoneNumberSendSms(phoneNumberId, testPhoneNumberOptions, xTestId);
