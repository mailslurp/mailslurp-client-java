...
public class WaitForControllerApiTest {
    ...
    public void waitForEmailCountTest() throws ApiException {
        ...
        List<EmailPreview> response = api.waitForEmailCount(count, delay, inboxId, since, sort, timeout, unreadOnly);
    ...
    public void waitForLatestEmailTest() throws ApiException {
        ...
        Long timeout = null;
        Boolean unreadOnly = null;
        Email response = api.waitForLatestEmail(delay, inboxId, since, sort, timeout, unreadOnly);
    ...
    public void waitForMatchingEmailsTest() throws ApiException {
        ...
        Long timeout = null;
        Boolean unreadOnly = null;
        List<EmailPreview> response = api.waitForMatchingEmails(matchOptions, count, delay, inboxId, since, sort, timeout, unreadOnly);
    ...
    public void waitForMatchingFirstEmailTest() throws ApiException {
        ...
        Long timeout = null;
        Boolean unreadOnly = null;
        Email response = api.waitForMatchingFirstEmail(matchOptions, delay, inboxId, since, sort, timeout, unreadOnly);
    ...
    public void waitForNthEmailTest() throws ApiException {
        ...
        Long timeout = null;
        Boolean unreadOnly = null;
        Email response = api.waitForNthEmail(delay, inboxId, index, since, sort, timeout, unreadOnly);
