...
public class WaitForControllerApiTest {
    ...
    public void waitForEmailCountTest() throws ApiException {
        ...
        String sort = null;
        Long delay = null;
        List<EmailPreview> response = api.waitForEmailCount(inboxId, count)
                .timeout(timeout)
    ...
    public void waitForLatestEmailTest() throws ApiException {
        ...
        String sort = null;
        Long delay = null;
        Email response = api.waitForLatestEmail()
                .inboxId(inboxId)
                .timeout(timeout)
                .unreadOnly(unreadOnly)
                .before(before)
    ...
    public void waitForMatchingEmailsTest() throws ApiException {
        ...
        Long timeout = null;
        Boolean unreadOnly = null;
        List<EmailPreview> response = api.waitForMatchingEmails(inboxId, count, matchOptions)
                .before(before)
                .since(since)
                .sort(sort)
                .delay(delay)
    ...
    public void waitForMatchingFirstEmailTest() throws ApiException {
        ...
        String sort = null;
        Long delay = null;
        Email response = api.waitForMatchingFirstEmail(inboxId, matchOptions)
                .timeout(timeout)
                .unreadOnly(unreadOnly)
                .since(since)
                .before(before)
    ...
    public void waitForNthEmailTest() throws ApiException {
        ...
        String sort = null;
        Long delay = null;
        Email response = api.waitForNthEmail()
                .inboxId(inboxId)
                .index(index)
                .timeout(timeout)
                .unreadOnly(unreadOnly)
