...
public class EmailControllerApiTest {
    ...
    public void getEmailsPaginatedTest() throws ApiException {
        ...
        PageEmailProjection response = api.getEmailsPaginated(inboxId, page, searchFilter, size, sort, unreadOnly);
    ...
    public void getOrganizationEmailsPaginatedTest() throws ApiException {
        ...
        String sort = null;
        Boolean unreadOnly = null;
        PageEmailProjection response = api.getOrganizationEmailsPaginated(inboxId, page, searchFilter, size, sort, unreadOnly);
