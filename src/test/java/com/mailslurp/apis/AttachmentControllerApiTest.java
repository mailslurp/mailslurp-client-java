...
public class AttachmentControllerApiTest {
    ...
    public void downloadAttachmentAsBytesTest() throws ApiException {
        String attachmentId = null;
        List<byte[]> response = api.downloadAttachmentAsBytes(attachmentId);
    ...
    public void getAttachments1Test() throws ApiException {
        ...
        PageAttachmentEntity response = api.getAttachments1(page, size, sort, fileNameFilter, since, before);
    ...
    public void uploadAttachmentBytesTest() throws ApiException {
        ...
        List<String> response = api.uploadAttachmentBytes(requestBody, contentType, filename);
    ...
    public void uploadMultipartFormTest() throws ApiException {
        ...
        List<String> response = api.uploadMultipartForm(contentType, filename, xFilename, inlineObject);
