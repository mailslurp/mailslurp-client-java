...
public class AttachmentControllerApiTest {
    ...
    public void getAttachmentsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageAttachmentEntity response = api.getAttachments(before, fileNameFilter, page, since, size, sort);
    ...
    public void uploadAttachmentBytesTest() throws ApiException {
        ...
        byte[] byteArray = null;
        List<String> response = api.uploadAttachmentBytes(contentType, filename, byteArray);
