...
public class ExpiredControllerApiTest {
    ...
    public void getExpiredInboxRecordTest() throws ApiException {
        UUID idOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId = null;
        ExpiredInboxDto response = api.getExpiredInboxRecord(idOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId);
    ...
    public void getExpiredInboxesTest() throws ApiException {
        ...
        PageExpiredInboxRecordProjection response = api.getExpiredInboxes(page, size, sort, since, before);
