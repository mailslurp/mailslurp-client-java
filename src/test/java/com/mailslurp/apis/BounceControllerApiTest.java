...
public class BounceControllerApiTest {
    ...
    public void getBouncedEmailTest() throws ApiException {
        UUID id = null;
        Bounce response = api.getBouncedEmail(id);
    ...
    public void getBouncedEmailsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageBouncedEmail response = api.getBouncedEmails(page, size, sort);
    ...
    public void getBouncedRecipientTest() throws ApiException {
        UUID id = null;
        BounceRecipient response = api.getBouncedRecipient(id);
    ...
    public void getBouncedRecipientsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageBouncedRecipients response = api.getBouncedRecipients(page, size, sort);
