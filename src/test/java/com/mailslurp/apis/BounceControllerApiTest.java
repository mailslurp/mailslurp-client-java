...
public class BounceControllerApiTest {
     ...
     */
    @Test
    public void getBouncedEmail1Test() throws ApiException {
        UUID id = null;
        api.getBouncedEmail1(id);
    ...
    public void getBouncedEmailsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        api.getBouncedEmails(page, size, sort);
    ...
    public void getBouncedRecipientsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        api.getBouncedRecipients(page, size, sort);
