...
public class InboxForwarderControllerApiTest {
    ...
    public void createNewInboxForwarderTest() throws ApiException {
        ...
        InboxForwarderDto response = api.createNewInboxForwarder(inboxId, createInboxForwarderOptions);
    ...
    public void getInboxForwarderEventsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageInboxForwarderEvents response = api.getInboxForwarderEvents(id, page, size, sort);
    ...
    public void getInboxForwardersTest() throws ApiException {
        ...
        PageInboxForwarderDto response = api.getInboxForwarders(inboxId, page, size, sort, searchFilter, since, before);
