...
public class WebhookControllerApiTest {
    ...
    public void getAllWebhookResultsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageWebhookResult response = api.getAllWebhookResults(before, page, searchFilter, since, size, sort);
    ...
    public void getWebhookResultsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageWebhookResult response = api.getWebhookResults(webhookId, before, page, searchFilter, since, size, sort);
