...
public class AiControllerApiTest {
     ...
     */
    @Test
    public void exportTransformerResultsTest() throws ApiException {
        ExportTransformerOptions exportTransformerOptions = null;
        ExportTransformerResponse response = api.exportTransformerResults(exportTransformerOptions)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getExportTransformerResultsJobTest() throws ApiException {
        UUID id = null;
        ExportTransformerResultJobDto response = api.getExportTransformerResultsJob(id)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getTransformerResultsTableTest() throws ApiException {
        Boolean includeMetaData = null;
        Boolean flattenArraysToRows = null;
        UUID emailId = null;
        UUID smsId = null;
        String attachmentId = null;
        UUID aiTransformId = null;
        ...
        Integer size = null;
        String sort = null;
        PageTableData response = api.getTransformerResultsTable(includeMetaData, flattenArraysToRows)
                .emailId(emailId)
                .smsId(smsId)
                .attachmentId(attachmentId)
                .aiTransformId(aiTransformId)
     ...
     */
    @Test
    public void testTransformerMappingMatchTest() throws ApiException {
        UUID id = null;
        UUID emailId = null;
        UUID smsId = null;
        String attachmentId = null;
        AITransformMappingMatchResult response = api.testTransformerMappingMatch(id)
                .emailId(emailId)
                .smsId(smsId)
                .attachmentId(attachmentId)
                .execute();
