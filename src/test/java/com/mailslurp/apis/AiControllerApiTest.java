...
public class AiControllerApiTest {
    ...
    public void createTransformerTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageAITransformProjection response = api.createTransformer(options)
                .page(page)
                .size(size)
                .sort(sort)
                .execute();
     ...
     */
    @Test
    public void createTransformer1Test() throws ApiException {
        AITranformCreateOptions aiTranformCreateOptions = null;
        AITransformDto response = api.createTransformer1(aiTranformCreateOptions)
                .execute();
        // TODO: test validations
    }
