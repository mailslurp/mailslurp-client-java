...
public class SmsControllerApiTest {
     ...
     */
    @Test
    public void getSmsCodesTest() throws ApiException {
        UUID smsId = null;
        ExtractCodesOptions extractCodesOptions = null;
        ExtractCodesResult response = api.getSmsCodes(smsId)
     ...
     */
    @Test
    public void markAllSmsAsReadTest() throws ApiException {
        Boolean read = null;
        UUID phoneNumberId = null;
        api.markAllSmsAsRead()
                .read(read)
                .phoneNumberId(phoneNumberId)
                .execute();
        // TODO: test validations
     ...
     */
    @Test
    public void markSmsAsReadTest() throws ApiException {
        UUID smsId = null;
        Boolean read = null;
        SmsDto response = api.markSmsAsRead(smsId)
                .read(read)
                .execute();
        // TODO: test validations
    }
