...
public class InboxControllerApiTest {
    ...
    public void createInboxTest() throws ApiException {
        ...
        Boolean isTheInboxAFavoriteMarkingAnInboxAsAFavoriteIsTypicallyDoneInTheDashboardForQuickAccessOrFiltering = null;
        ...
        Boolean dePRECATEDTeamAccessIsAlwaysTrueGrantTeamAccessToThisInboxAndTheEmailsThatBelongToItForTeamMembersOfYourOrganization = null;
    ...
    public void flushExpiredTest() throws ApiException {
        ...
        FlushExpiredInboxesResult response = api.flushExpired(before);
    ...
    public void getAllInboxesTest() throws ApiException {
        ...
        String search = null;
        String tag = null;
        Boolean dePRECATEDOptionallyFilterByTeamAccess = null;
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageInboxProjection response = api.getAllInboxes(page, size, sort, favourite, search, tag, dePRECATEDOptionallyFilterByTeamAccess, since, before);
    ...
    public void getEmailsTest() throws ApiException {
        UUID idOfInboxThatEmailsBelongsTo = null;
        Integer aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit = null;
        Integer limit = null;
        ...
        OffsetDateTime excludeEmailsReceivedAfterThisISO8601DateTime = null;
        OffsetDateTime excludeEmailsReceivedBeforeThisISO8601DateTime = null;
        List<EmailPreview> response = api.getEmails(idOfInboxThatEmailsBelongsTo, aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit, limit, sortTheResultsByReceivedDateAndDirectionASCOrDESC, retryTimeout, delayTimeout, minCount, unreadOnly, excludeEmailsReceivedAfterThisISO8601DateTime, excludeEmailsReceivedBeforeThisISO8601DateTime);
    ...
    public void getInboxEmailCountTest() throws ApiException {
        UUID idOfInboxThatEmailsBelongsTo = null;
        CountDto response = api.getInboxEmailCount(idOfInboxThatEmailsBelongsTo);
    ...
    public void getInboxEmailsPaginatedTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageEmailPreview response = api.getInboxEmailsPaginated(idOfInboxThatEmailsBelongsTo, page, size, sort, since, before);
    ...
    public void getInboxSentEmailsTest() throws ApiException {
        UUID inboxId = null;
        Integer page = null;
        Integer optionalPageSizeInInboxSentEmailListPagination = null;
        String sort = null;
        String searchFilter = null;
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageSentEmailProjection response = api.getInboxSentEmails(inboxId, page, optionalPageSizeInInboxSentEmailListPagination, sort, searchFilter, since, before);
    ...
    public void getInboxesTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        List<InboxDto> response = api.getInboxes(size, sort, since, before);
    ...
    public void getOrganizationInboxesTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageOrganizationInboxProjection response = api.getOrganizationInboxes(page, size, sort, searchFilter, since, before);
    ...
    public void listInboxRulesetsTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageInboxRulesetDto response = api.listInboxRulesets(inboxId, page, size, sort, searchFilter, since, before);
    ...
    public void listInboxTrackingPixelsTest() throws ApiException {
        UUID inboxId = null;
        Integer page = null;
        Integer optionalPageSizeInInboxTrackingPixelListPagination = null;
        String sort = null;
        String searchFilter = null;
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageTrackingPixelProjection response = api.listInboxTrackingPixels(inboxId, page, optionalPageSizeInInboxTrackingPixelListPagination, sort, searchFilter, since, before);
    ...
    public void sendEmailTest() throws ApiException {
        UUID idOfTheInboxYouWantToSendTheEmailFrom = null;
        SendEmailOptions sendEmailOptions = null;
        api.sendEmail(idOfTheInboxYouWantToSendTheEmailFrom, sendEmailOptions);
    ...
    public void sendEmailAndConfirmTest() throws ApiException {
        UUID idOfTheInboxYouWantToSendTheEmailFrom = null;
        SendEmailOptions sendEmailOptions = null;
        SentEmailDto response = api.sendEmailAndConfirm(idOfTheInboxYouWantToSendTheEmailFrom, sendEmailOptions);
