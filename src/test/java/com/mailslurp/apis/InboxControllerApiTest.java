...
public class InboxControllerApiTest {
    ...
    public void createInboxTest() throws ApiException {
        ...
        InboxDto response = api.createInbox(emailAddress, tags, name, description, useDomainPool, favourite, expiresAt, expiresIn, allowTeamAccess, inboxType);
    ...
    public void getAllInboxesTest() throws ApiException {
        ...
        OffsetDateTime before = null;
        PageInboxProjection response = api.getAllInboxes(page, size, sort, favourite, search, tag, teamAccess, since, before);
    ...
    public void getEmailsTest() throws ApiException {
        ...
        OffsetDateTime before = null;
        OffsetDateTime since = null;
        List<EmailPreview> response = api.getEmails(inboxId, aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit, limit, sortTheResultsByReceivedDateAndDirectionASCOrDESC, retryTimeout, delayTimeout, minCount, unreadOnly, before, since);
