...
public class InboxControllerApiTest {
    ...
    public void createInboxRulesetTest() throws ApiException {
        ...
        RulesetDto response = api.createInboxRuleset(inboxId, createRulesetOptions)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getOrCreateInboxPlusAddressTest() throws ApiException {
        UUID inboxId = null;
        String fullAddress = null;
        PlusAddressDto response = api.getOrCreateInboxPlusAddress(inboxId, fullAddress)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getOrCreatePlusAddressByFullAddressTest() throws ApiException {
        String fullAddress = null;
        PlusAddressDto response = api.getOrCreatePlusAddressByFullAddress(fullAddress)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void importEmailIntoInboxTest() throws ApiException {
        UUID inboxId = null;
        ImportEmailOptions importEmailOptions = null;
        Email response = api.importEmailIntoInbox(inboxId, importEmailOptions)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void importEmailIntoInboxBytesTest() throws ApiException {
        UUID inboxId = null;
        byte[] body = null;
        String externalId = null;
        Boolean runPipeline = null;
        Boolean overrideMessageId = null;
        Email response = api.importEmailIntoInboxBytes(inboxId, body)
     ...
     */
    @Test
    public void importEmailIntoInboxMultipartTest() throws ApiException {
        UUID inboxId = null;
        File _file = null;
        String externalId = null;
        Boolean runPipeline = null;
        Boolean overrideMessageId = null;
        Email response = api.importEmailIntoInboxMultipart(inboxId, _file)
                .externalId(externalId)
                .runPipeline(runPipeline)
                .overrideMessageId(overrideMessageId)
                .execute();
    ...
    public void listInboxRulesetsTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageRulesetDto response = api.listInboxRulesets(inboxId)
                .page(page)
                .size(size)
                .sort(sort)
                .searchFilter(searchFilter)
