...
public class InboxControllerApiTest {
    ...
    public void createInboxTest() throws ApiException {
        ...
        InboxDto response = api.createInbox(emailAddress, tags, name, description, useDomainPool, favourite, expiresAt, expiresIn, allowTeamAccess, inboxType, virtualInbox, useShortAddress, domainId, domainName);
    ...
    public void doesInboxExistTest() throws ApiException {
        ...
        InboxExistsDto response = api.doesInboxExist(emailAddress, allowCatchAll);
    ...
    public void getAllInboxesTest() throws ApiException {
        ...
        String inboxType = null;
        UUID domainId = null;
        PageInboxProjection response = api.getAllInboxes(page, size, sort, favourite, search, tag, teamAccess, since, before, inboxType, domainId);
    ...
    public void getAllScheduledJobsTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageScheduledJobs response = api.getAllScheduledJobs(page, size, sort, since, before);
    ...
    public void getDeliveryStatusesByInboxIdTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageDeliveryStatus response = api.getDeliveryStatusesByInboxId(inboxId, page, size, sort, since, before);
    ...
    public void getEmailsTest() throws ApiException {
        ...
        OffsetDateTime before = null;
        OffsetDateTime since = null;
        List<EmailPreview> response = api.getEmails(inboxId, size, limit, sort, retryTimeout, delayTimeout, minCount, unreadOnly, before, since);
    ...
    public void getImapSmtpAccessTest() throws ApiException {
        UUID inboxId = null;
        ImapSmtpAccessDetails response = api.getImapSmtpAccess(inboxId);
    ...
    public void getInboxEmailsPaginatedTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageEmailPreview response = api.getInboxEmailsPaginated(inboxId, page, size, sort, since, before);
    ...
    public void getInboxSentEmailsTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageSentEmailProjection response = api.getInboxSentEmails(inboxId, page, size, sort, searchFilter, since, before);
    ...
    public void getInboxesTest() throws ApiException {
        ...
        OffsetDateTime before = null;
        List<InboxDto> response = api.getInboxes(size, sort, since, excludeCatchAllInboxes, before);
    ...
    public void getScheduledJobsByInboxIdTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageScheduledJobs response = api.getScheduledJobsByInboxId(inboxId, page, size, sort, since, before);
    ...
    public void listInboxTrackingPixelsTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageTrackingPixelProjection response = api.listInboxTrackingPixels(inboxId, page, size, sort, searchFilter, since, before);
    ...
    public void sendWithScheduleTest() throws ApiException {
        ...
        Boolean validateBeforeEnqueue = null;
        ScheduledJobDto response = api.sendWithSchedule(inboxId, sendEmailOptions, sendAtTimestamp, sendAtNowPlusSeconds, validateBeforeEnqueue);
