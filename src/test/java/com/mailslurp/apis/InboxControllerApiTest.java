...
public class InboxControllerApiTest {
    ...
    public void createInboxTest() throws ApiException {
        ...
        InboxDto response = api.createInbox(emailAddress, tags, name, description, useDomainPool, favourite, expiresAt, expiresIn, allowTeamAccess, inboxType, virtualInbox);
