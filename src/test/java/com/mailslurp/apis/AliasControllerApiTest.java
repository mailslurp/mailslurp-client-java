...
public class AliasControllerApiTest {
    ...
    public void getAliasEmailsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageEmailProjection response = api.getAliasEmails(aliasId, before, page, since, size, sort);
    ...
    public void getAliasThreadsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageThreadProjection response = api.getAliasThreads(aliasId, before, page, since, size, sort);
    ...
    public void getAliasesTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageAlias response = api.getAliases(before, page, since, size, sort);
