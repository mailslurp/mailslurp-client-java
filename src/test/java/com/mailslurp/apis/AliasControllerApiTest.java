...
public class AliasControllerApiTest {
    ...
    public void getAliasEmailsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageEmailProjection response = api.getAliasEmails(aliasId, page, size, sort);
    ...
    public void getAliasThreadsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageThreadProjection response = api.getAliasThreads(aliasId, page, size, sort);
    ...
    public void replyToEmailTest() throws ApiException {
        ...
        SentEmailDto response = api.replyToEmail(aliasId, emailId, replyToAliasEmailOptions);
