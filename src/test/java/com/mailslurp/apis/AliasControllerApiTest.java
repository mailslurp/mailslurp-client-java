...
public class AliasControllerApiTest {
    ...
    public void createAliasTest() throws ApiException {
        ...
        Alias response = api.createAlias(createAliasOptions);
     ...
     */
    @Test
    public void getAliasVerificationTest() throws ApiException {
        UUID aliasId = null;
        String emailAddress = null;
        String verificationToken = null;
        AliasVerificationResult response = api.getAliasVerification(aliasId, emailAddress, verificationToken);
