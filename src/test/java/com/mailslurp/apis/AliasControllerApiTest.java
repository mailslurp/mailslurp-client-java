...
public class AliasControllerApiTest {
    ...
    public void getAliasEmailsTest() throws ApiException {
        ...
        PageEmailProjection response = api.getAliasEmails(aliasId)
                .page(page)
                .size(size)
                .sort(sort)
                .since(since)
    ...
    public void getAliasThreadsTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageAliasThreadProjection response = api.getAliasThreads(aliasId)
                .page(page)
                .size(size)
                .sort(sort)
                .since(since)
    ...
    public void getAliasesTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageAlias response = api.getAliases()
                .search(search)
                .page(page)
                .size(size)
                .sort(sort)
    ...
    public void getThreadTest() throws ApiException {
        UUID threadId = null;
        AliasThreadProjection response = api.getThread(threadId)
                .execute();
        // TODO: test validations
    }
     ...
     */
    @Test
    public void getThreadsPaginatedTest() throws ApiException {
        Integer page = null;
        Integer size = null;
        String sort = null;
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageAliasThreadProjection response = api.getThreadsPaginated()
                .page(page)
                .size(size)
                .sort(sort)
                .since(since)
