...
public class InboxReplierControllerApiTest {
    ...
    public void deleteInboxRepliersTest() throws ApiException {
        UUID inboxId = null;
        api.deleteInboxRepliers(inboxId);
    ...
    public void getInboxReplierEventsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageInboxReplierEvents response = api.getInboxReplierEvents(id, page, size, sort);
    ...
    public void getInboxRepliersTest() throws ApiException {
        ...
        PageInboxReplierDto response = api.getInboxRepliers(inboxId, page, size, sort, since, before);
