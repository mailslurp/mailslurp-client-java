...
public class GroupControllerApiTest {
    ...
    public void getAllGroupsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageGroupProjection response = api.getAllGroups(before, page, since, size, sort);
    ...
    public void getGroupWithContactsPaginatedTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageContactProjection response = api.getGroupWithContactsPaginated(groupId, before, page, since, size, sort);
