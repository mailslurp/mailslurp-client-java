...
public class SentEmailsControllerApiTest {
    ...
    public void getSentDeliveryStatusesTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageDeliveryStatus response = api.getSentDeliveryStatuses(page, size, sort, since, before);
    ...
    public void getSentDeliveryStatusesBySentIdTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageDeliveryStatus response = api.getSentDeliveryStatusesBySentId(sentId, page, size, sort, since, before);
    ...
    public void getSentEmailsWithQueueResultsTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        PageSentEmailWithQueueProjection response = api.getSentEmailsWithQueueResults(page, size, sort, since, before);
    ...
    public void waitForDeliveryStatusesTest() throws ApiException {
        ...
        OffsetDateTime since = null;
        OffsetDateTime before = null;
        DeliveryStatusDto response = api.waitForDeliveryStatuses(sentId, inboxId, timeout, index, since, before);
