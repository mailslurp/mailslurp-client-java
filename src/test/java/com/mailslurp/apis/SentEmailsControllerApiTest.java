...
public class SentEmailsControllerApiTest {
    ...
    public void getAllSentTrackingPixelsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageTrackingPixelProjection response = api.getAllSentTrackingPixels(before, page, searchFilter, since, size, sort);
    ...
    public void getSentEmailTrackingPixelsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageTrackingPixelProjection response = api.getSentEmailTrackingPixels(id, before, page, searchFilter, since, size, sort);
    ...
    public void getSentEmailsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageSentEmailProjection response = api.getSentEmails(before, inboxId, page, searchFilter, since, size, sort);
    ...
    public void getSentOrganizationEmailsTest() throws ApiException {
        ...
        Integer size = null;
        String sort = null;
        PageSentEmailProjection response = api.getSentOrganizationEmails(before, inboxId, page, searchFilter, since, size, sort);
