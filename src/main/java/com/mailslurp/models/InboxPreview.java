...
public class InboxPreview {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Virtual inbox can receive email but will not send emails to real recipients. Will save sent email record but never send an actual email. Perfect for testing mail server actions.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, emailAddress, createdAt, favourite, name, tags, teamAccess, inboxType, virtualInbox, expiresAt);
  }
