...
public class PageComplaint {
  ...
  private List<Complaint> content = new ArrayList<>();
  ...
  public PageComplaint content(@javax.annotation.Nullable List<Complaint> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<Complaint> content) {
    this.content = content;
  }


  public PageComplaint pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageComplaint totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageComplaint totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageComplaint last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageComplaint numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageComplaint sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageComplaint first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageComplaint size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageComplaint number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageComplaint empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageComplaint
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageComplaint.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageComplaint.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageComplaint` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageComplaint.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            Complaint.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
