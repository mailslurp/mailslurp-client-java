...
public class SimpleSendEmailOptions {
  ...
  public SimpleSendEmailOptions senderId(@javax.annotation.Nullable UUID senderId) {
  ...
  public SimpleSendEmailOptions to(@javax.annotation.Nonnull String to) {
    this.to = to;
    return this;
  }
  ...
  public SimpleSendEmailOptions body(@javax.annotation.Nullable String body) {
    this.body = body;
    return this;
  }
  ...
  public SimpleSendEmailOptions subject(@javax.annotation.Nullable String subject) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to SimpleSendEmailOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!SimpleSendEmailOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SimpleSendEmailOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SimpleSendEmailOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
