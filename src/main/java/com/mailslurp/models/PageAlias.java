...
public class PageAlias {
  ...
  private List<AliasProjection> content = new ArrayList<>();
  ...
  public PageAlias content(@javax.annotation.Nullable List<AliasProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<AliasProjection> content) {
    this.content = content;
  }


  public PageAlias pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageAlias totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageAlias totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageAlias last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageAlias numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageAlias sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageAlias first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageAlias size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageAlias number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageAlias empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageAlias
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageAlias.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageAlias.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageAlias` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageAlias.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            AliasProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
