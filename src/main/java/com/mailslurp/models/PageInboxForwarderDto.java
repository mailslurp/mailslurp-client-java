...
public class PageInboxForwarderDto {
  ...
  private List<InboxForwarderDto> content = new ArrayList<>();
  ...
  public PageInboxForwarderDto content(@javax.annotation.Nullable List<InboxForwarderDto> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<InboxForwarderDto> content) {
    this.content = content;
  }


  public PageInboxForwarderDto pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageInboxForwarderDto totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageInboxForwarderDto totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageInboxForwarderDto last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageInboxForwarderDto numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageInboxForwarderDto sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageInboxForwarderDto first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageInboxForwarderDto size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageInboxForwarderDto number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageInboxForwarderDto empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageInboxForwarderDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageInboxForwarderDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageInboxForwarderDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageInboxForwarderDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageInboxForwarderDto.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            InboxForwarderDto.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
