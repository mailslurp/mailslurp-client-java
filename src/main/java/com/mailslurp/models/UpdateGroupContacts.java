...
public class UpdateGroupContacts {
  ...
  public UpdateGroupContacts contactIds(@javax.annotation.Nonnull List<UUID> contactIds) {
  ...
  public void setContactIds(@javax.annotation.Nonnull List<UUID> contactIds) {
    this.contactIds = contactIds;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGroupContacts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!UpdateGroupContacts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGroupContacts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateGroupContacts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
