...
public class TestPhoneNumberOptions {
  ...
  public TestPhoneNumberOptions message(@javax.annotation.Nonnull String message) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to TestPhoneNumberOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!TestPhoneNumberOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TestPhoneNumberOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TestPhoneNumberOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
