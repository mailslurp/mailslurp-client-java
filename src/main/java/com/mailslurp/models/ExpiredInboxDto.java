...
public class ExpiredInboxDto {
  ...
  public ExpiredInboxDto id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ExpiredInboxDto inboxId(@javax.annotation.Nonnull UUID inboxId) {
  ...
  public ExpiredInboxDto emailAddress(@javax.annotation.Nonnull String emailAddress) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpiredInboxDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!ExpiredInboxDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExpiredInboxDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExpiredInboxDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
