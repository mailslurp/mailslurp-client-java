...
public class AITransformMappingProjection {
  ...
  public AITransformMappingProjection entityId(@javax.annotation.Nonnull UUID entityId) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(userId, aiTransformId, entityId, entityType, contentSelector, triggerSelector, name, id);
  }
