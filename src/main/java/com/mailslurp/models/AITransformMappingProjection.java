...
public class AITransformMappingProjection {
  ...
  public AITransformMappingProjection() {
  }

  public AITransformMappingProjection userId(@javax.annotation.Nonnull UUID userId) {
    this.userId = userId;
    return this;
  }
  ...
  public AITransformMappingProjection createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public AITransformMappingProjection aiTransformId(@javax.annotation.Nonnull UUID aiTransformId) {
  ...
  public AITransformMappingProjection entityId(@javax.annotation.Nullable UUID entityId) {
  ...
  public AITransformMappingProjection entityType(@javax.annotation.Nonnull EntityTypeEnum entityType) {
  ...
  public AITransformMappingProjection contentSelector(@javax.annotation.Nullable ContentSelectorEnum contentSelector) {
  ...
  public AITransformMappingProjection triggerSelector(@javax.annotation.Nullable TriggerSelectorEnum triggerSelector) {
  ...
  public AITransformMappingProjection name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AITransformMappingProjection id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AITransformMappingProjection aiTransformMappingProjection = (AITransformMappingProjection) o;
    return Objects.equals(this.userId, aiTransformMappingProjection.userId) &&
        Objects.equals(this.createdAt, aiTransformMappingProjection.createdAt) &&
        Objects.equals(this.aiTransformId, aiTransformMappingProjection.aiTransformId) &&
        Objects.equals(this.entityId, aiTransformMappingProjection.entityId) &&
        Objects.equals(this.entityType, aiTransformMappingProjection.entityType) &&
        Objects.equals(this.contentSelector, aiTransformMappingProjection.contentSelector) &&
        Objects.equals(this.triggerSelector, aiTransformMappingProjection.triggerSelector) &&
        Objects.equals(this.name, aiTransformMappingProjection.name) &&
        Objects.equals(this.id, aiTransformMappingProjection.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userId, createdAt, aiTransformId, entityId, entityType, contentSelector, triggerSelector, name, id);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AITransformMappingProjection {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AITransformMappingProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!AITransformMappingProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AITransformMappingProjection is not found in the empty JSON string", AITransformMappingProjection.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AITransformMappingProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AITransformMappingProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AITransformMappingProjection.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AITransformMappingProjection.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AITransformMappingProjection' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AITransformMappingProjection> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AITransformMappingProjection.class));

       return (TypeAdapter<T>) new TypeAdapter<AITransformMappingProjection>() {
           @Override
           public void write(JsonWriter out, AITransformMappingProjection value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AITransformMappingProjection read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AITransformMappingProjection given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AITransformMappingProjection
   * @throws IOException if the JSON string is invalid with respect to AITransformMappingProjection
   */
  public static AITransformMappingProjection fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AITransformMappingProjection.class);
  }

  /**
   * Convert an instance of AITransformMappingProjection to an JSON string
   *
   * @return JSON string
   */
