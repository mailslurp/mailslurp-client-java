...
public class ValidateEmailAddressListResult {
  ...
  public ValidateEmailAddressListResult validEmailAddresses(@javax.annotation.Nonnull List<String> validEmailAddresses) {
  ...
  public ValidateEmailAddressListResult addValidEmailAddressesItem(String validEmailAddressesItem) {
    if (this.validEmailAddresses == null) {
      this.validEmailAddresses = new ArrayList<>();
    }
  ...
  public void setValidEmailAddresses(@javax.annotation.Nonnull List<String> validEmailAddresses) {
    this.validEmailAddresses = validEmailAddresses;
  }


  public ValidateEmailAddressListResult invalidEmailAddresses(@javax.annotation.Nonnull List<String> invalidEmailAddresses) {
  ...
  public ValidateEmailAddressListResult addInvalidEmailAddressesItem(String invalidEmailAddressesItem) {
    if (this.invalidEmailAddresses == null) {
      this.invalidEmailAddresses = new ArrayList<>();
    }
  ...
  public void setInvalidEmailAddresses(@javax.annotation.Nonnull List<String> invalidEmailAddresses) {
    this.invalidEmailAddresses = invalidEmailAddresses;
  }


  public ValidateEmailAddressListResult resultMapEmailAddressIsValid(@javax.annotation.Nonnull Map<String, Boolean> resultMapEmailAddressIsValid) {
  ...
  public ValidateEmailAddressListResult putResultMapEmailAddressIsValidItem(String key, Boolean resultMapEmailAddressIsValidItem) {
    if (this.resultMapEmailAddressIsValid == null) {
      this.resultMapEmailAddressIsValid = new HashMap<>();
    }
  ...
  public void setResultMapEmailAddressIsValid(@javax.annotation.Nonnull Map<String, Boolean> resultMapEmailAddressIsValid) {
    this.resultMapEmailAddressIsValid = resultMapEmailAddressIsValid;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValidateEmailAddressListResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!ValidateEmailAddressListResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValidateEmailAddressListResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValidateEmailAddressListResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
