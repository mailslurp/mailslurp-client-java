...
public class RawEmailJson {
  ...
  public RawEmailJson content(@javax.annotation.Nonnull String content) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to RawEmailJson
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!RawEmailJson.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RawEmailJson.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RawEmailJson` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
