...
public class InboxRulesetDto {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(action, createdAt, handler, id, inboxId, scope, target);
  }
