...
public class WebhookProjection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, id, url, password, username, userId, inboxId, eventName, createdAt, updatedAt, healthStatus, aiTransformerId, aiTransformId, phoneNumberId);
  }
