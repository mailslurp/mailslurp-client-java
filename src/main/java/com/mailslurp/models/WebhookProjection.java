...
public class WebhookProjection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(url, password, username, updatedAt, userId, inboxId, eventName, createdAt, aiTransformId, healthStatus, aiTransformerId, phoneNumberId, name, id);
  }
