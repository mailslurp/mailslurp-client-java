...
public class WebhookTestResult {
  ...
  public WebhookTestResult message(@javax.annotation.Nullable String message) {
  ...
  public WebhookTestResult response(@javax.annotation.Nonnull WebhookTestResponse response) {
  ...
  public void setResponse(@javax.annotation.Nonnull WebhookTestResponse response) {
    this.response = response;
  }


  public WebhookTestResult request(@javax.annotation.Nonnull WebhookTestRequest request) {
  ...
  public void setRequest(@javax.annotation.Nonnull WebhookTestRequest request) {
    this.request = request;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookTestResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!WebhookTestResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookTestResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookTestResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      WebhookTestResponse.validateJsonElement(jsonObj.get("response"));
      // validate the required field `request`
      WebhookTestRequest.validateJsonElement(jsonObj.get("request"));
  }
