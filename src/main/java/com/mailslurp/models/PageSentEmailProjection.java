...
public class PageSentEmailProjection {
  ...
  public PageSentEmailProjection content(@javax.annotation.Nullable List<SentEmailProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<SentEmailProjection> content) {
    this.content = content;
  }


  public PageSentEmailProjection pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageSentEmailProjection totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageSentEmailProjection totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageSentEmailProjection last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageSentEmailProjection numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageSentEmailProjection sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageSentEmailProjection first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageSentEmailProjection size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageSentEmailProjection number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageSentEmailProjection empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageSentEmailProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageSentEmailProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageSentEmailProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageSentEmailProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            SentEmailProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
