...
public class PageSentEmailProjection {
  ...
  **/
  ...
  @ApiModelProperty(value = "Collection of items")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Size of page requested")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Page number starting at 0")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of items returned")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Total number of items available for querying")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(content, pageable, size, number, numberOfElements, totalElements, totalPages, last, sort, first, empty);
  }
