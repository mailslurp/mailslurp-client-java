...
public class DomainIssuesDto {
  ...
  public DomainIssuesDto hasIssues(@javax.annotation.Nonnull Boolean hasIssues) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainIssuesDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!DomainIssuesDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainIssuesDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainIssuesDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
