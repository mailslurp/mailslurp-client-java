...
public class PagePhoneNumberProjection {
  ...
  private List<PhoneNumberProjection> content = new ArrayList<>();
  ...
  public PagePhoneNumberProjection content(@javax.annotation.Nullable List<PhoneNumberProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<PhoneNumberProjection> content) {
    this.content = content;
  }


  public PagePhoneNumberProjection pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PagePhoneNumberProjection totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PagePhoneNumberProjection totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PagePhoneNumberProjection last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PagePhoneNumberProjection numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PagePhoneNumberProjection sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PagePhoneNumberProjection first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PagePhoneNumberProjection size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PagePhoneNumberProjection number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PagePhoneNumberProjection empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PagePhoneNumberProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PagePhoneNumberProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PagePhoneNumberProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PagePhoneNumberProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PagePhoneNumberProjection.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            PhoneNumberProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
