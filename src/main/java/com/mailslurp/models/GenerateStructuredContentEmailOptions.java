...
public class GenerateStructuredContentEmailOptions {
  ...
  public GenerateStructuredContentEmailOptions outputSchema(@javax.annotation.Nonnull StructuredOutputSchema outputSchema) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(emailId, contentSelector, instructions, outputSchema);
  }
