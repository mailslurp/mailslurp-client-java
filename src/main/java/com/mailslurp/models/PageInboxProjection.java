 ...
 */
@ApiModel(description = "Paginated inbox results. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full inbox entity use the projection ID with individual method calls.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2021-03-31T23:00:03.586Z[GMT]")
public class PageInboxProjection {
  public static final String SERIALIZED_NAME_CONTENT = "content";
  @SerializedName(SERIALIZED_NAME_CONTENT)
  private List<InboxProjection> content = null;
  ...
  public PageInboxProjection content(List<InboxProjection> content) {
    
    this.content = content;
    return this;
  }

  public PageInboxProjection addContentItem(InboxProjection contentItem) {
  ...
  **/
  ...
  public List<InboxProjection> getContent() {
    return content;
  }


  public void setContent(List<InboxProjection> content) {
    this.content = content;
  }
  ...
  **/
  ...
  public PageInboxProjection pageable(Pageable pageable) {
