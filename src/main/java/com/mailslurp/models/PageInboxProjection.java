...
public class PageInboxProjection {
  ...
  private List<InboxPreview> content = new ArrayList<>();
  ...
  public PageInboxProjection content(@javax.annotation.Nullable List<InboxPreview> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<InboxPreview> content) {
    this.content = content;
  }


  public PageInboxProjection pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageInboxProjection totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageInboxProjection totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageInboxProjection last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageInboxProjection numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageInboxProjection sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageInboxProjection first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageInboxProjection size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageInboxProjection number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageInboxProjection empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageInboxProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageInboxProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageInboxProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageInboxProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageInboxProjection.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            InboxPreview.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
