...
public class PageAttachmentEntity {
  ...
  private List<AttachmentProjection> content = new ArrayList<>();
  ...
  public PageAttachmentEntity content(@javax.annotation.Nullable List<AttachmentProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<AttachmentProjection> content) {
    this.content = content;
  }


  public PageAttachmentEntity pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageAttachmentEntity totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageAttachmentEntity totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageAttachmentEntity last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageAttachmentEntity numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageAttachmentEntity sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageAttachmentEntity first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageAttachmentEntity size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageAttachmentEntity number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageAttachmentEntity empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageAttachmentEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageAttachmentEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageAttachmentEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageAttachmentEntity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageAttachmentEntity.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            AttachmentProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
