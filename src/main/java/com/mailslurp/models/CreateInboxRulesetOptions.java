...
public class CreateInboxRulesetOptions {
  ...
  public CreateInboxRulesetOptions scope(@javax.annotation.Nonnull ScopeEnum scope) {
    this.scope = scope;
    return this;
  }
  ...
  public CreateInboxRulesetOptions action(@javax.annotation.Nonnull ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  public CreateInboxRulesetOptions target(@javax.annotation.Nonnull String target) {
    this.target = target;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateInboxRulesetOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!CreateInboxRulesetOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateInboxRulesetOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateInboxRulesetOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
