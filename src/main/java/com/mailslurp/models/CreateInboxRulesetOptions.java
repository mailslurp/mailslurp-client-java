 ...
 */
@ApiModel(description = "Options for creating inbox rulesets. Inbox rulesets can be used to block, allow, or forward emails when sending or receiving using the inbox.")
...
public class CreateInboxRulesetOptions {
  ...
  **/
  ...
  @ApiModelProperty(value = "Action to be taken when the ruleset matches an email for the given scope. For example: `BLOCK` action with target `*` and scope `SENDING_EMAILS` blocks sending to all recipients. Note `ALLOW` takes precedent over `BLOCK`.")
