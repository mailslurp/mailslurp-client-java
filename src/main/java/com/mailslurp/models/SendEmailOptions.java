...
public class SendEmailOptions {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Optional HTML flag (Deprecated: use isHTML instead)")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Use name of inbox as sender email address name. Will construct RFC 5322 email address with `Inbox name <inbox@address.com>`")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(attachments, bcc, body, cc, charset, from, html, isHTML, replyTo, sendStrategy, subject, template, templateVariables, to, toContacts, toGroup, useInboxName);
  }
