...
public class PageScheduledJobs {
  ...
  private List<ScheduledJob> content = new ArrayList<>();
  ...
  public PageScheduledJobs content(@javax.annotation.Nullable List<ScheduledJob> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<ScheduledJob> content) {
    this.content = content;
  }


  public PageScheduledJobs pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageScheduledJobs totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageScheduledJobs totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageScheduledJobs last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageScheduledJobs numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageScheduledJobs sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageScheduledJobs first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageScheduledJobs size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageScheduledJobs number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageScheduledJobs empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageScheduledJobs
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageScheduledJobs.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageScheduledJobs.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageScheduledJobs` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageScheduledJobs.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            ScheduledJob.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
