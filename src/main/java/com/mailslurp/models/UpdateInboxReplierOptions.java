...
public class UpdateInboxReplierOptions {
  ...
  public UpdateInboxReplierOptions inboxId(@javax.annotation.Nonnull UUID inboxId) {
  ...
  public UpdateInboxReplierOptions name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateInboxReplierOptions field(@javax.annotation.Nullable FieldEnum field) {
    this.field = field;
    return this;
  }
  ...
  public UpdateInboxReplierOptions match(@javax.annotation.Nullable String match) {
    this.match = match;
    return this;
  }
  ...
  public UpdateInboxReplierOptions replyTo(@javax.annotation.Nullable String replyTo) {
  ...
  public UpdateInboxReplierOptions subject(@javax.annotation.Nullable String subject) {
  ...
  public UpdateInboxReplierOptions from(@javax.annotation.Nullable String from) {
    this.from = from;
    return this;
  }
  ...
  public UpdateInboxReplierOptions charset(@javax.annotation.Nullable String charset) {
  ...
  public UpdateInboxReplierOptions isHTML(@javax.annotation.Nullable Boolean isHTML) {
    this.isHTML = isHTML;
    return this;
  }
  ...
  public UpdateInboxReplierOptions ignoreReplyTo(@javax.annotation.Nullable Boolean ignoreReplyTo) {
  ...
  public UpdateInboxReplierOptions body(@javax.annotation.Nullable String body) {
    this.body = body;
    return this;
  }
  ...
  public UpdateInboxReplierOptions templateId(@javax.annotation.Nullable UUID templateId) {
  ...
  public UpdateInboxReplierOptions templateVariables(@javax.annotation.Nullable Map<String, Object> templateVariables) {
  ...
  public UpdateInboxReplierOptions should(@javax.annotation.Nullable ShouldEnum should) {
    this.should = should;
    return this;
  }
  ...
  public UpdateInboxReplierOptions matchOptions(@javax.annotation.Nullable InboxAutomationMatchOptions matchOptions) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.inboxId, updateInboxReplierOptions.inboxId) &&
        ...
        Objects.equals(this.should, updateInboxReplierOptions.should) &&
        Objects.equals(this.matchOptions, updateInboxReplierOptions.matchOptions);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(inboxId, name, field, match, replyTo, subject, from, charset, isHTML, ignoreReplyTo, body, templateId, templateVariables, should, matchOptions);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateInboxReplierOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!UpdateInboxReplierOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateInboxReplierOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateInboxReplierOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
