...
public class UpdateInboxReplierOptions {
  ...
  public UpdateInboxReplierOptions field(@javax.annotation.Nonnull FieldEnum field) {
    this.field = field;
    return this;
  }
  ...
  public UpdateInboxReplierOptions match(@javax.annotation.Nonnull String match) {
    this.match = match;
    return this;
  }
