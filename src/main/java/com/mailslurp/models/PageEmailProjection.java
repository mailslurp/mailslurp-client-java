...
public class PageEmailProjection {
  ...
  private List<EmailProjection> content = new ArrayList<>();
  ...
  public PageEmailProjection content(@javax.annotation.Nullable List<EmailProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<EmailProjection> content) {
    this.content = content;
  }


  public PageEmailProjection pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageEmailProjection totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageEmailProjection totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageEmailProjection last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageEmailProjection numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageEmailProjection sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageEmailProjection first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageEmailProjection size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageEmailProjection number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageEmailProjection empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageEmailProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageEmailProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageEmailProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageEmailProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageEmailProjection.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            EmailProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
