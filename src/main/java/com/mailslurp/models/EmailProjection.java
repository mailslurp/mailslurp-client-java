...
public class EmailProjection {
  ...
  public static final String SERIALIZED_NAME_IMAP_UID = "imapUid";
  @SerializedName(SERIALIZED_NAME_IMAP_UID)
  @javax.annotation.Nullable
  ...
  public EmailProjection imapUid(@javax.annotation.Nullable Long imapUid) {
  ...
  public void setImapUid(@javax.annotation.Nullable Long imapUid) {
    this.imapUid = imapUid;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.subject, emailProjection.subject) &&
        ...
        Objects.equals(this.imapUid, emailProjection.imapUid) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(subject, inboxId, attachments, sender, recipients, sizeBytes, createdAt, to, cc, bcc, messageId, domainId, favourite, plusAddress, imapUid, inReplyTo, read, bodyExcerpt, textExcerpt, bodyPartContentTypes, bodyMD5Hash, teamAccess, id, threadId, from);
  }
  ...
  public String toString() {
    ...
    sb.append("    imapUid: ").append(toIndentedString(imapUid)).append("\n");
