...
public class EmailProjection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(subject, sender, recipients, attachments, inboxId, createdAt, to, cc, bcc, messageId, domainId, favourite, plusAddress, sizeBytes, inReplyTo, read, bodyExcerpt, textExcerpt, bodyPartContentTypes, bodyMD5Hash, teamAccess, id, threadId, from);
  }
