...
public class EmailProjection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sender, recipients, inboxId, attachments, createdAt, to, cc, bcc, messageId, domainId, favourite, plusAddress, sizeBytes, inReplyTo, read, bodyExcerpt, textExcerpt, bodyPartContentTypes, bodyMD5Hash, teamAccess, subject, id, threadId, from);
  }
