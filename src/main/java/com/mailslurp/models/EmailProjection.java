...
public class EmailProjection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, threadId, from, subject, sender, recipients, inboxId, attachments, sizeBytes, createdAt, to, cc, bcc, messageId, favourite, domainId, plusAddress, imapUid, inReplyTo, read, bodyExcerpt, textExcerpt, bodyPartContentTypes, bodyMD5Hash, teamAccess);
  }
