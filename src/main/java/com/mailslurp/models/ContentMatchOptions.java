...
public class ContentMatchOptions {
  ...
  public ContentMatchOptions pattern(@javax.annotation.Nonnull String pattern) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ContentMatchOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!ContentMatchOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ContentMatchOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ContentMatchOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
