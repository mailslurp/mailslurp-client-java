...
public class PageBouncedRecipients {
  ...
  private List<BounceRecipientProjection> content = new ArrayList<>();
  ...
  public PageBouncedRecipients content(@javax.annotation.Nullable List<BounceRecipientProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<BounceRecipientProjection> content) {
    this.content = content;
  }


  public PageBouncedRecipients pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageBouncedRecipients totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageBouncedRecipients totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageBouncedRecipients last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageBouncedRecipients numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageBouncedRecipients sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageBouncedRecipients first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageBouncedRecipients size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageBouncedRecipients number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageBouncedRecipients empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageBouncedRecipients
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageBouncedRecipients.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageBouncedRecipients.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageBouncedRecipients` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageBouncedRecipients.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            BounceRecipientProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
