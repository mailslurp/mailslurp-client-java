...
public class PageBouncedEmail {
  ...
  private List<BounceProjection> content = new ArrayList<>();
  ...
  public PageBouncedEmail content(@javax.annotation.Nullable List<BounceProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<BounceProjection> content) {
    this.content = content;
  }


  public PageBouncedEmail pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageBouncedEmail totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageBouncedEmail totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageBouncedEmail last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageBouncedEmail numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageBouncedEmail sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageBouncedEmail first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageBouncedEmail size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageBouncedEmail number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageBouncedEmail empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageBouncedEmail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageBouncedEmail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageBouncedEmail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageBouncedEmail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageBouncedEmail.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            BounceProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
