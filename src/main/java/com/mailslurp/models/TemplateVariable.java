...
public class TemplateVariable {
  ...
  public TemplateVariable name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public TemplateVariable variableType(@javax.annotation.Nonnull VariableTypeEnum variableType) {
  ...
  public void setVariableType(@javax.annotation.Nonnull VariableTypeEnum variableType) {
    this.variableType = variableType;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplateVariable
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!TemplateVariable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateVariable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateVariable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
