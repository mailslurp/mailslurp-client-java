...
public class SentEmailProjection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, threadId, inReplyTo, from, sender, recipients, subject, userId, attachments, inboxId, createdAt, to, cc, bcc, messageId, virtualSend, bodyExcerpt, textExcerpt, bodyMD5Hash);
  }
