...
public class SentEmailProjection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, threadId, from, subject, sender, recipients, userId, inboxId, attachments, createdAt, to, cc, bcc, messageId, inReplyTo, virtualSend, bodyExcerpt, textExcerpt, bodyMD5Hash);
  }
