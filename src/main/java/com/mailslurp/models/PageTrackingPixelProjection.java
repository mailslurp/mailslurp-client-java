...
public class PageTrackingPixelProjection {
  ...
  private List<TrackingPixelProjection> content = new ArrayList<>();
  ...
  public PageTrackingPixelProjection content(@javax.annotation.Nullable List<TrackingPixelProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<TrackingPixelProjection> content) {
    this.content = content;
  }


  public PageTrackingPixelProjection pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageTrackingPixelProjection totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageTrackingPixelProjection totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageTrackingPixelProjection last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageTrackingPixelProjection numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageTrackingPixelProjection sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageTrackingPixelProjection first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageTrackingPixelProjection size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageTrackingPixelProjection number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageTrackingPixelProjection empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageTrackingPixelProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageTrackingPixelProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageTrackingPixelProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageTrackingPixelProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageTrackingPixelProjection.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            TrackingPixelProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
