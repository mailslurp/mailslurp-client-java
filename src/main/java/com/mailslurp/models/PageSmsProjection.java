...
public class PageSmsProjection {
  ...
  private List<SmsProjection> content = new ArrayList<>();
  ...
  public PageSmsProjection content(@javax.annotation.Nullable List<SmsProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<SmsProjection> content) {
    this.content = content;
  }


  public PageSmsProjection pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageSmsProjection totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageSmsProjection totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageSmsProjection last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageSmsProjection numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageSmsProjection sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageSmsProjection first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageSmsProjection size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageSmsProjection number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageSmsProjection empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageSmsProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageSmsProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageSmsProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageSmsProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageSmsProjection.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            SmsProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
