...
public class Email {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "An excerpt of the body of the email message")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID of the email entity")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Is the email body HTML")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Read flag. Has the email ever been viewed in the dashboard or fetched via the API? If so the email is marked as read.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "ID of user that email belongs to")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(analysis, attachments, bcc, body, bodyExcerpt, bodyMD5Hash, cc, charset, createdAt, from, headers, id, inboxId, isHTML, read, replyTo, subject, teamAccess, to, updatedAt, userId);
  }
