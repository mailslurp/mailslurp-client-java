...
public class Email {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, userId, inboxId, to, from, sender, recipients, replyTo, cc, bcc, headers, attachments, subject, body, bodyExcerpt, bodyMD5Hash, charset, analysis, createdAt, updatedAt, read, teamAccess, html);
  }
