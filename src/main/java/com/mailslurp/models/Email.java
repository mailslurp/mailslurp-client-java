...
public class Email {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(analysis, attachments, bcc, body, bodyMD5Hash, cc, charset, createdAt, from, headers, id, inboxId, isHTML, read, replyTo, subject, to, updatedAt, userId);
  }
