...
public class Email {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "List of `To` recipient email addresses that the email was addressed to. See recipients object for names.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(analysis, attachments, bcc, body, bodyExcerpt, bodyMD5Hash, cc, charset, createdAt, from, headers, id, inboxId, isHTML, read, recipients, replyTo, sender, subject, teamAccess, to, updatedAt, userId);
  }
