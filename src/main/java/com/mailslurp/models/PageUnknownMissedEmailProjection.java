...
public class PageUnknownMissedEmailProjection {
  ...
  private List<UnknownMissedEmailProjection> content = new ArrayList<>();
  ...
  public PageUnknownMissedEmailProjection content(@javax.annotation.Nullable List<UnknownMissedEmailProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<UnknownMissedEmailProjection> content) {
    this.content = content;
  }


  public PageUnknownMissedEmailProjection pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageUnknownMissedEmailProjection totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageUnknownMissedEmailProjection totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageUnknownMissedEmailProjection last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageUnknownMissedEmailProjection numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageUnknownMissedEmailProjection sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageUnknownMissedEmailProjection first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageUnknownMissedEmailProjection size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageUnknownMissedEmailProjection number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageUnknownMissedEmailProjection empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageUnknownMissedEmailProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageUnknownMissedEmailProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageUnknownMissedEmailProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageUnknownMissedEmailProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageUnknownMissedEmailProjection.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            UnknownMissedEmailProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
