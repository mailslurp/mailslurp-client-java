...
public class WaitForConditions {
  ...
  public WaitForConditions inboxId(@javax.annotation.Nonnull UUID inboxId) {
  ...
  public WaitForConditions count(@javax.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public WaitForConditions delayTimeout(@javax.annotation.Nullable Long delayTimeout) {
  ...
  public WaitForConditions timeout(@javax.annotation.Nonnull Long timeout) {
  ...
  public WaitForConditions unreadOnly(@javax.annotation.Nullable Boolean unreadOnly) {
  ...
  public WaitForConditions countType(@javax.annotation.Nullable CountTypeEnum countType) {
  ...
  public WaitForConditions matches(@javax.annotation.Nullable List<MatchOption> matches) {
  ...
  public WaitForConditions sortDirection(@javax.annotation.Nullable SortDirectionEnum sortDirection) {
  ...
  public WaitForConditions since(@javax.annotation.Nullable OffsetDateTime since) {
    this.since = since;
    return this;
  }
  ...
  public WaitForConditions before(@javax.annotation.Nullable OffsetDateTime before) {
    this.before = before;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to WaitForConditions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!WaitForConditions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WaitForConditions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WaitForConditions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
