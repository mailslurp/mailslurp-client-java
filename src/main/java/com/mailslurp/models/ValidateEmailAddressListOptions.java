...
public class ValidateEmailAddressListOptions {
  ...
  public static final String SERIALIZED_NAME_IGNORE_OLD_RESULTS = "ignoreOldResults";
  @SerializedName(SERIALIZED_NAME_IGNORE_OLD_RESULTS)
  @javax.annotation.Nullable
  private Boolean ignoreOldResults;

  public ValidateEmailAddressListOptions() {
  }

  public ValidateEmailAddressListOptions emailAddressList(@javax.annotation.Nonnull List<String> emailAddressList) {
  ...
  public void setEmailAddressList(@javax.annotation.Nonnull List<String> emailAddressList) {
    this.emailAddressList = emailAddressList;
  }


  public ValidateEmailAddressListOptions ignoreOldResults(@javax.annotation.Nullable Boolean ignoreOldResults) {
    this.ignoreOldResults = ignoreOldResults;
    return this;
  }

  /**
   * Get ignoreOldResults
   * @return ignoreOldResults
   */
  @javax.annotation.Nullable
  public Boolean getIgnoreOldResults() {
    return ignoreOldResults;
  }

  public void setIgnoreOldResults(@javax.annotation.Nullable Boolean ignoreOldResults) {
    this.ignoreOldResults = ignoreOldResults;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.emailAddressList, validateEmailAddressListOptions.emailAddressList) &&
        Objects.equals(this.ignoreOldResults, validateEmailAddressListOptions.ignoreOldResults);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(emailAddressList, ignoreOldResults);
  }
  ...
  public String toString() {
    ...
    sb.append("    ignoreOldResults: ").append(toIndentedString(ignoreOldResults)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("ignoreOldResults");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValidateEmailAddressListOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!ValidateEmailAddressListOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValidateEmailAddressListOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValidateEmailAddressListOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
