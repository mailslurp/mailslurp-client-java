...
public class ExpirationDefaults {
  ...
  public ExpirationDefaults defaultExpirationMillis(@javax.annotation.Nullable Long defaultExpirationMillis) {
  ...
  public void setDefaultExpirationMillis(@javax.annotation.Nullable Long defaultExpirationMillis) {
    this.defaultExpirationMillis = defaultExpirationMillis;
  }


  public ExpirationDefaults maxExpirationMillis(@javax.annotation.Nullable Long maxExpirationMillis) {
  ...
  public void setMaxExpirationMillis(@javax.annotation.Nullable Long maxExpirationMillis) {
    this.maxExpirationMillis = maxExpirationMillis;
  }


  public ExpirationDefaults defaultExpiresAt(@javax.annotation.Nullable OffsetDateTime defaultExpiresAt) {
  ...
  public void setDefaultExpiresAt(@javax.annotation.Nullable OffsetDateTime defaultExpiresAt) {
    this.defaultExpiresAt = defaultExpiresAt;
  }


  @Deprecated
  public ExpirationDefaults canPermanentInbox(@javax.annotation.Nonnull Boolean canPermanentInbox) {
  ...
  @Deprecated
  public void setCanPermanentInbox(@javax.annotation.Nonnull Boolean canPermanentInbox) {
    this.canPermanentInbox = canPermanentInbox;
  }


  public ExpirationDefaults nextInboxAllowsPermanent(@javax.annotation.Nonnull Boolean nextInboxAllowsPermanent) {
  ...
  public void setNextInboxAllowsPermanent(@javax.annotation.Nonnull Boolean nextInboxAllowsPermanent) {
    this.nextInboxAllowsPermanent = nextInboxAllowsPermanent;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExpirationDefaults
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!ExpirationDefaults.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExpirationDefaults.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExpirationDefaults` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
