...
public class PhoneMessageThreadItemProjection {
  ...
  public PhoneMessageThreadItemProjection id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, phoneMessageThreadItemProjection.id) &&
        Objects.equals(this.body, phoneMessageThreadItemProjection.body) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, body, phoneNumberId, created, messageDirection, fromPhoneNumber, toPhoneNumber);
  }
