...
public class PageWebhookProjection {
  ...
  private List<WebhookProjection> content = new ArrayList<>();
  ...
  public PageWebhookProjection content(@javax.annotation.Nullable List<WebhookProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<WebhookProjection> content) {
    this.content = content;
  }


  public PageWebhookProjection pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageWebhookProjection totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageWebhookProjection totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageWebhookProjection last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageWebhookProjection numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageWebhookProjection sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageWebhookProjection first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageWebhookProjection size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageWebhookProjection number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageWebhookProjection empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageWebhookProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageWebhookProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageWebhookProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageWebhookProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageWebhookProjection.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            WebhookProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
