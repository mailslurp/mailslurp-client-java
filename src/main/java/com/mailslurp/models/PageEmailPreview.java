...
public class PageEmailPreview {
  ...
  private List<EmailPreview> content = new ArrayList<>();
  ...
  public PageEmailPreview content(@javax.annotation.Nullable List<EmailPreview> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<EmailPreview> content) {
    this.content = content;
  }


  public PageEmailPreview pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageEmailPreview totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageEmailPreview totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageEmailPreview last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageEmailPreview numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageEmailPreview sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageEmailPreview first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageEmailPreview size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageEmailPreview number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageEmailPreview empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageEmailPreview
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageEmailPreview.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageEmailPreview.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageEmailPreview` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageEmailPreview.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            EmailPreview.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
