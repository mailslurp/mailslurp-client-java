...
public class CreateAITransformerMappingOptions {
  ...
  public CreateAITransformerMappingOptions name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateAITransformerMappingOptions entityId(@javax.annotation.Nullable UUID entityId) {
  ...
  public CreateAITransformerMappingOptions matchOptions(@javax.annotation.Nullable AIMappingMatchOptions matchOptions) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createAITransformerMappingOptions.name) &&
        ...
        Objects.equals(this.matchOptions, createAITransformerMappingOptions.matchOptions);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, aiTransformId, entityId, entityType, contentSelector, triggerSelector, spreadRootArray, matchOptions);
  }
