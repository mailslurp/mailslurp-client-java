...
public class RulesetDto {
  ...
  public RulesetDto id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public RulesetDto inboxId(@javax.annotation.Nullable UUID inboxId) {
  ...
  public RulesetDto phoneId(@javax.annotation.Nullable UUID phoneId) {
  ...
  public RulesetDto scope(@javax.annotation.Nonnull ScopeEnum scope) {
    this.scope = scope;
    return this;
  }
  ...
  public RulesetDto action(@javax.annotation.Nonnull ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  public RulesetDto target(@javax.annotation.Nonnull String target) {
    this.target = target;
    return this;
  }
  ...
  public RulesetDto handler(@javax.annotation.Nonnull HandlerEnum handler) {
  ...
  public RulesetDto createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public boolean equals(Object o) {
    ...
    RulesetDto rulesetDto = (RulesetDto) o;
    return Objects.equals(this.id, rulesetDto.id) &&
        Objects.equals(this.inboxId, rulesetDto.inboxId) &&
        Objects.equals(this.phoneId, rulesetDto.phoneId) &&
        Objects.equals(this.scope, rulesetDto.scope) &&
        Objects.equals(this.action, rulesetDto.action) &&
        Objects.equals(this.target, rulesetDto.target) &&
        Objects.equals(this.handler, rulesetDto.handler) &&
        Objects.equals(this.createdAt, rulesetDto.createdAt);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, inboxId, phoneId, scope, action, target, handler, createdAt);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RulesetDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!RulesetDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RulesetDto is not found in the empty JSON string", RulesetDto.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RulesetDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RulesetDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RulesetDto.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RulesetDto.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RulesetDto' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RulesetDto> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RulesetDto.class));

       return (TypeAdapter<T>) new TypeAdapter<RulesetDto>() {
           @Override
           public void write(JsonWriter out, RulesetDto value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RulesetDto read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RulesetDto given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RulesetDto
   * @throws IOException if the JSON string is invalid with respect to RulesetDto
   */
  public static RulesetDto fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RulesetDto.class);
  }

  /**
   * Convert an instance of RulesetDto to an JSON string
   *
   * @return JSON string
   */
