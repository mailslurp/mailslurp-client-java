...
public class WebhookBounceRecipientPayload {
  ...
  public WebhookBounceRecipientPayload messageId(@javax.annotation.Nonnull String messageId) {
  ...
  public WebhookBounceRecipientPayload webhookId(@javax.annotation.Nonnull UUID webhookId) {
  ...
  public WebhookBounceRecipientPayload eventName(@javax.annotation.Nonnull EventNameEnum eventName) {
  ...
  public WebhookBounceRecipientPayload webhookName(@javax.annotation.Nullable String webhookName) {
  ...
  public WebhookBounceRecipientPayload recipient(@javax.annotation.Nonnull String recipient) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookBounceRecipientPayload
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!WebhookBounceRecipientPayload.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookBounceRecipientPayload.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookBounceRecipientPayload` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
