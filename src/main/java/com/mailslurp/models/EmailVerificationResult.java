 ...
 */
@ApiModel(description = "Email verification result. Valid means email address exists according to response from mail server running at the domian and port given.")
...
public class EmailVerificationResult {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(domainName, emailAddress, error, isValid, port);
  }
