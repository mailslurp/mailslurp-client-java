...
public class WebhookRedriveResult {
  ...
  public WebhookRedriveResult webhookResultId(@javax.annotation.Nonnull UUID webhookResultId) {
  ...
  public void setWebhookResultId(@javax.annotation.Nonnull UUID webhookResultId) {
    this.webhookResultId = webhookResultId;
  }


  public WebhookRedriveResult success(@javax.annotation.Nonnull Boolean success) {
  ...
  public WebhookRedriveResult message(@javax.annotation.Nullable String message) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookRedriveResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!WebhookRedriveResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookRedriveResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookRedriveResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
