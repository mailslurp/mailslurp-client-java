...
public class TemplatePreview {
  ...
  public TemplatePreview preview(@javax.annotation.Nonnull String preview) {
  ...
  public void setPreview(@javax.annotation.Nonnull String preview) {
    this.preview = preview;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TemplatePreview
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!TemplatePreview.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplatePreview.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplatePreview` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
