...
public class PageSentEmailWithQueueProjection {
  ...
  public PageSentEmailWithQueueProjection content(@javax.annotation.Nullable List<SendWithQueueResult> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<SendWithQueueResult> content) {
    this.content = content;
  }


  public PageSentEmailWithQueueProjection pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageSentEmailWithQueueProjection totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageSentEmailWithQueueProjection totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageSentEmailWithQueueProjection last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageSentEmailWithQueueProjection numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageSentEmailWithQueueProjection sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageSentEmailWithQueueProjection first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageSentEmailWithQueueProjection size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageSentEmailWithQueueProjection number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageSentEmailWithQueueProjection empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageSentEmailWithQueueProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageSentEmailWithQueueProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageSentEmailWithQueueProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageSentEmailWithQueueProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            SendWithQueueResult.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
