...
public class PageListUnsubscribeRecipients {
  ...
  private List<ListUnsubscribeRecipientProjection> content = new ArrayList<>();
  ...
  public PageListUnsubscribeRecipients content(@javax.annotation.Nullable List<ListUnsubscribeRecipientProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<ListUnsubscribeRecipientProjection> content) {
    this.content = content;
  }


  public PageListUnsubscribeRecipients pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageListUnsubscribeRecipients totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageListUnsubscribeRecipients totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageListUnsubscribeRecipients last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageListUnsubscribeRecipients numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageListUnsubscribeRecipients sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageListUnsubscribeRecipients first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageListUnsubscribeRecipients size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageListUnsubscribeRecipients number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageListUnsubscribeRecipients empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageListUnsubscribeRecipients
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageListUnsubscribeRecipients.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageListUnsubscribeRecipients.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageListUnsubscribeRecipients` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageListUnsubscribeRecipients.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            ListUnsubscribeRecipientProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
