...
public class CreateInboxDto {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(emailAddress, name, description, useDomainPool, tags, expiresAt, favourite, expiresIn, allowTeamAccess, inboxType, virtualInbox, useShortAddress);
  }
