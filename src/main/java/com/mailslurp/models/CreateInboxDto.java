...
public class CreateInboxDto {
  ...
  public CreateInboxDto emailAddress(@javax.annotation.Nullable String emailAddress) {
  ...
  public CreateInboxDto domainName(@javax.annotation.Nullable String domainName) {
  ...
  public CreateInboxDto domainId(@javax.annotation.Nullable UUID domainId) {
  ...
  public CreateInboxDto name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateInboxDto description(@javax.annotation.Nullable String description) {
  ...
  public CreateInboxDto useDomainPool(@javax.annotation.Nullable Boolean useDomainPool) {
  ...
  public void setUseDomainPool(@javax.annotation.Nullable Boolean useDomainPool) {
    this.useDomainPool = useDomainPool;
  }


  public CreateInboxDto tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public CreateInboxDto expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public CreateInboxDto favourite(@javax.annotation.Nullable Boolean favourite) {
  ...
  public CreateInboxDto expiresIn(@javax.annotation.Nullable Long expiresIn) {
  ...
  @Deprecated
  public CreateInboxDto allowTeamAccess(@javax.annotation.Nullable Boolean allowTeamAccess) {
  ...
  @Deprecated
  public void setAllowTeamAccess(@javax.annotation.Nullable Boolean allowTeamAccess) {
    this.allowTeamAccess = allowTeamAccess;
  }


  public CreateInboxDto inboxType(@javax.annotation.Nullable InboxTypeEnum inboxType) {
  ...
  public CreateInboxDto virtualInbox(@javax.annotation.Nullable Boolean virtualInbox) {
  ...
  public void setVirtualInbox(@javax.annotation.Nullable Boolean virtualInbox) {
    this.virtualInbox = virtualInbox;
  }


  public CreateInboxDto useShortAddress(@javax.annotation.Nullable Boolean useShortAddress) {
  ...
  public void setUseShortAddress(@javax.annotation.Nullable Boolean useShortAddress) {
    this.useShortAddress = useShortAddress;
  }


  public CreateInboxDto prefix(@javax.annotation.Nullable String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.emailAddress, createInboxDto.emailAddress) &&
        ...
        Objects.equals(this.prefix, createInboxDto.prefix);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(emailAddress, domainName, domainId, name, description, useDomainPool, tags, expiresAt, favourite, expiresIn, allowTeamAccess, inboxType, virtualInbox, useShortAddress, prefix);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateInboxDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!CreateInboxDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateInboxDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateInboxDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
