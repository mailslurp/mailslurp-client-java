...
public class PageInboxReplierDto {
  ...
  private List<InboxReplierDto> content = new ArrayList<>();
  ...
  public PageInboxReplierDto content(@javax.annotation.Nullable List<InboxReplierDto> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<InboxReplierDto> content) {
    this.content = content;
  }


  public PageInboxReplierDto pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageInboxReplierDto totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageInboxReplierDto totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageInboxReplierDto last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageInboxReplierDto numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageInboxReplierDto sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageInboxReplierDto first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageInboxReplierDto size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageInboxReplierDto number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageInboxReplierDto empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageInboxReplierDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageInboxReplierDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageInboxReplierDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageInboxReplierDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageInboxReplierDto.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            InboxReplierDto.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
