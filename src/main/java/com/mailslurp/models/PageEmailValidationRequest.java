...
public class PageEmailValidationRequest {
  ...
  private List<EmailValidationRequest> content = null;
  ...
  public PageEmailValidationRequest content(List<EmailValidationRequest> content) {
    
    this.content = content;
    return this;
  }

  public PageEmailValidationRequest addContentItem(EmailValidationRequest contentItem) {
  ...
  **/
  ...
  public List<EmailValidationRequest> getContent() {
    return content;
  }


  public void setContent(List<EmailValidationRequest> content) {
    this.content = content;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(content, pageable, total, last, totalPages, totalElements, size, number, sort, first, numberOfElements, empty);
  }
