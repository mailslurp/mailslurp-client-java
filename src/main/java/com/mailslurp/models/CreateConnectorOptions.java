...
public class CreateConnectorOptions {
  ...
  public CreateConnectorOptions name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateConnectorOptions emailAddress(@javax.annotation.Nullable String emailAddress) {
  ...
  public CreateConnectorOptions enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createConnectorOptions.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, emailAddress, enabled);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateConnectorOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!CreateConnectorOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateConnectorOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateConnectorOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
