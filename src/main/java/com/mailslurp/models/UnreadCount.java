...
public class UnreadCount {
  ...
  public UnreadCount count(@javax.annotation.Nonnull Long count) {
    this.count = count;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnreadCount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!UnreadCount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UnreadCount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UnreadCount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
