...
public class ContactDto {
  ...
  public ContactDto id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ContactDto groupId(@javax.annotation.Nullable UUID groupId) {
  ...
  public ContactDto firstName(@javax.annotation.Nullable String firstName) {
  ...
  public ContactDto lastName(@javax.annotation.Nullable String lastName) {
  ...
  public ContactDto company(@javax.annotation.Nullable String company) {
  ...
  public ContactDto emailAddresses(@javax.annotation.Nonnull List<String> emailAddresses) {
  ...
  public ContactDto primaryEmailAddress(@javax.annotation.Nullable String primaryEmailAddress) {
  ...
  public ContactDto tags(@javax.annotation.Nonnull List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ContactDto metaData(@javax.annotation.Nullable Object metaData) {
  ...
  public ContactDto optOut(@javax.annotation.Nullable Boolean optOut) {
    this.optOut = optOut;
    return this;
  }
  ...
  public ContactDto createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
