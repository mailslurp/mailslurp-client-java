...
public class CreateDomainOptions {
  ...
  public CreateDomainOptions domain(@javax.annotation.Nonnull String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public CreateDomainOptions description(@javax.annotation.Nullable String description) {
  ...
  public CreateDomainOptions createdCatchAllInbox(@javax.annotation.Nullable Boolean createdCatchAllInbox) {
  ...
  public void setCreatedCatchAllInbox(@javax.annotation.Nullable Boolean createdCatchAllInbox) {
    this.createdCatchAllInbox = createdCatchAllInbox;
  }


  public CreateDomainOptions domainType(@javax.annotation.Nullable DomainTypeEnum domainType) {
  ...
  public void setDomainType(@javax.annotation.Nullable DomainTypeEnum domainType) {
    this.domainType = domainType;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateDomainOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!CreateDomainOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateDomainOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateDomainOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
