...
public class UploadAttachmentOptions {
  ...
  **/
  @ApiModelProperty(required = true, value = "Base64 encoded string of file contents. Typically this means reading the bytes or string content of a file and then converting that to a base64 encoded string.")
