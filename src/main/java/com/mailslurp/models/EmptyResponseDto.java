...
public class EmptyResponseDto {
  ...
  public EmptyResponseDto message(@javax.annotation.Nullable String message) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmptyResponseDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!EmptyResponseDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmptyResponseDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmptyResponseDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
