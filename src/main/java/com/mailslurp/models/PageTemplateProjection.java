...
public class PageTemplateProjection {
  ...
  private List<TemplateProjection> content = new ArrayList<>();
  ...
  public PageTemplateProjection content(@javax.annotation.Nullable List<TemplateProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<TemplateProjection> content) {
    this.content = content;
  }


  public PageTemplateProjection pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageTemplateProjection totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageTemplateProjection totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageTemplateProjection last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageTemplateProjection numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageTemplateProjection sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageTemplateProjection first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageTemplateProjection size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageTemplateProjection number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageTemplateProjection empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageTemplateProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageTemplateProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageTemplateProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageTemplateProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageTemplateProjection.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            TemplateProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
