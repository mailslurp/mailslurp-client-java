...
public class MatchOption {
  ...
  public MatchOption field(@javax.annotation.Nonnull FieldEnum field) {
    this.field = field;
    return this;
  }
  ...
  public MatchOption should(@javax.annotation.Nonnull ShouldEnum should) {
    this.should = should;
    return this;
  }
  ...
  public MatchOption value(@javax.annotation.Nonnull String value) {
    this.value = value;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MatchOption
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!MatchOption.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MatchOption.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MatchOption` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
