...
public class PageInboxRulesetDto {
  ...
  private List<InboxRulesetDto> content = new ArrayList<>();
  ...
  public PageInboxRulesetDto content(@javax.annotation.Nullable List<InboxRulesetDto> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<InboxRulesetDto> content) {
    this.content = content;
  }


  public PageInboxRulesetDto pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageInboxRulesetDto totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageInboxRulesetDto totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageInboxRulesetDto last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageInboxRulesetDto numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageInboxRulesetDto first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageInboxRulesetDto size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageInboxRulesetDto number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageInboxRulesetDto sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageInboxRulesetDto empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageInboxRulesetDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageInboxRulesetDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageInboxRulesetDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageInboxRulesetDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageInboxRulesetDto.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            InboxRulesetDto.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
