...
public class ScheduledJobDto {
  ...
  public ScheduledJobDto id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ScheduledJobDto userId(@javax.annotation.Nonnull UUID userId) {
    this.userId = userId;
    return this;
  }
  ...
  public ScheduledJobDto inboxId(@javax.annotation.Nonnull UUID inboxId) {
  ...
  public ScheduledJobDto jobId(@javax.annotation.Nonnull String jobId) {
    this.jobId = jobId;
    return this;
  }
  ...
  public ScheduledJobDto groupId(@javax.annotation.Nonnull String groupId) {
  ...
  public ScheduledJobDto triggerId(@javax.annotation.Nonnull String triggerId) {
  ...
  public ScheduledJobDto status(@javax.annotation.Nonnull StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public ScheduledJobDto sendAtTimestamp(@javax.annotation.Nonnull OffsetDateTime sendAtTimestamp) {
  ...
  public ScheduledJobDto createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public ScheduledJobDto updatedAt(@javax.annotation.Nonnull OffsetDateTime updatedAt) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScheduledJobDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!ScheduledJobDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScheduledJobDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScheduledJobDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
