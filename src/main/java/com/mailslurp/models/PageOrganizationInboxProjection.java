...
public class PageOrganizationInboxProjection {
  ...
  private List<OrganizationInboxProjection> content = new ArrayList<>();
  ...
  public PageOrganizationInboxProjection content(@javax.annotation.Nullable List<OrganizationInboxProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<OrganizationInboxProjection> content) {
    this.content = content;
  }


  public PageOrganizationInboxProjection pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageOrganizationInboxProjection totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageOrganizationInboxProjection totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageOrganizationInboxProjection last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageOrganizationInboxProjection numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageOrganizationInboxProjection sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageOrganizationInboxProjection first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageOrganizationInboxProjection size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageOrganizationInboxProjection number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageOrganizationInboxProjection empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageOrganizationInboxProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageOrganizationInboxProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageOrganizationInboxProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageOrganizationInboxProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageOrganizationInboxProjection.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            OrganizationInboxProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
