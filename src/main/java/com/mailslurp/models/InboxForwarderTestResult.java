...
public class InboxForwarderTestResult {
  ...
  public InboxForwarderTestResult matches(@javax.annotation.Nonnull Map<String, Boolean> matches) {
  ...
  public void setMatches(@javax.annotation.Nonnull Map<String, Boolean> matches) {
    this.matches = matches;
  }


  public InboxForwarderTestResult doesMatch(@javax.annotation.Nonnull Boolean doesMatch) {
  ...
  public void setDoesMatch(@javax.annotation.Nonnull Boolean doesMatch) {
    this.doesMatch = doesMatch;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InboxForwarderTestResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!InboxForwarderTestResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InboxForwarderTestResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InboxForwarderTestResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
