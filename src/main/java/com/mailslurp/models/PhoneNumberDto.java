...
public class PhoneNumberDto {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, userId, complianceAddress, emergencyAddress, phoneNumber, phoneCountry, phonePlan, createdAt, updatedAt, favourite, phoneVariant);
  }
