...
public class PhoneNumberDto {
  ...
  public PhoneNumberDto tags(@javax.annotation.Nonnull List<String> tags) {
    this.tags = tags;
    return this;
  }

  public PhoneNumberDto addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, phoneNumberDto.id) &&
        ...
        Objects.equals(this.tags, phoneNumberDto.tags) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, tags, userId, complianceAddress, emergencyAddress, phoneNumber, phoneCountry, phonePlan, createdAt, updatedAt, favourite, phoneVariant, lineType, carrierName, mobileCountryCode, mobileNetworkCode, providerLabel);
  }
