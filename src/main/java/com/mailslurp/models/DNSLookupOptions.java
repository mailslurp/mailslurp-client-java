...
public class DNSLookupOptions {
  ...
  public enum RecordTypesEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      ...
      RecordTypesEnum.fromValue(value);
    }
  }
  ...
  public DNSLookupOptions hostname(@javax.annotation.Nonnull String hostname) {
  ...
  public DNSLookupOptions recordTypes(@javax.annotation.Nonnull List<RecordTypesEnum> recordTypes) {
  ...
  public void setRecordTypes(@javax.annotation.Nonnull List<RecordTypesEnum> recordTypes) {
    this.recordTypes = recordTypes;
  }


  public DNSLookupOptions omitFinalDNSDot(@javax.annotation.Nonnull Boolean omitFinalDNSDot) {
  ...
  public void setOmitFinalDNSDot(@javax.annotation.Nonnull Boolean omitFinalDNSDot) {
    this.omitFinalDNSDot = omitFinalDNSDot;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DNSLookupOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!DNSLookupOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DNSLookupOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DNSLookupOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
