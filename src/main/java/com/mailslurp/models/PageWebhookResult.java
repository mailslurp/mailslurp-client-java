...
public class PageWebhookResult {
  ...
  private List<WebhookResultEntity> content = null;
  ...
  public PageWebhookResult content(List<WebhookResultEntity> content) {
    
    this.content = content;
    return this;
  }

  public PageWebhookResult addContentItem(WebhookResultEntity contentItem) {
  ...
  **/
  ...
  public List<WebhookResultEntity> getContent() {
    return content;
  }


  public void setContent(List<WebhookResultEntity> content) {
    this.content = content;
  }
  ...
  **/
  ...
  public PageWebhookResult pageable(Pageable pageable) {
