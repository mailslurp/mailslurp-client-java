...
public class PageWebhookResult {
  ...
  private List<WebhookResultDto> content = new ArrayList<>();
  ...
  public PageWebhookResult content(@javax.annotation.Nullable List<WebhookResultDto> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<WebhookResultDto> content) {
    this.content = content;
  }


  public PageWebhookResult pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageWebhookResult totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageWebhookResult totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageWebhookResult last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageWebhookResult numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageWebhookResult sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageWebhookResult first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageWebhookResult size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageWebhookResult number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageWebhookResult empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageWebhookResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageWebhookResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageWebhookResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageWebhookResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageWebhookResult.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            WebhookResultDto.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
