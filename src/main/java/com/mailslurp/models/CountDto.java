...
public class CountDto {
  ...
  public CountDto totalElements(@javax.annotation.Nonnull Long totalElements) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CountDto
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!CountDto.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CountDto.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CountDto` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
