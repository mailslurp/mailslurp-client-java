...
public class CreateInboxReplierOptions {
  ...
  public CreateInboxReplierOptions field(@javax.annotation.Nullable FieldEnum field) {
    this.field = field;
    return this;
  }
  ...
  public CreateInboxReplierOptions match(@javax.annotation.Nullable String match) {
    this.match = match;
    return this;
  }
  ...
  public CreateInboxReplierOptions should(@javax.annotation.Nullable ShouldEnum should) {
    this.should = should;
    return this;
  }
  ...
  public CreateInboxReplierOptions matchOptions(@javax.annotation.Nullable InboxAutomationMatchOptions matchOptions) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.inboxId, createInboxReplierOptions.inboxId) &&
        ...
        Objects.equals(this.should, createInboxReplierOptions.should) &&
        Objects.equals(this.matchOptions, createInboxReplierOptions.matchOptions);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(inboxId, name, field, match, replyTo, subject, from, charset, ignoreReplyTo, isHTML, body, templateId, templateVariables, should, matchOptions);
  }
