 ...
 */
@ApiModel(description = "Paginated expired inbox results. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full inbox entity use the projection ID with individual method calls.")
...
public class PageExpiredInboxRecordProjection {
  ...
  **/
  ...
  public PageExpiredInboxRecordProjection pageable(Pageable pageable) {
