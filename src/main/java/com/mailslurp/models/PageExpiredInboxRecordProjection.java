...
public class PageExpiredInboxRecordProjection {
  ...
  private List<ExpiredInboxRecordProjection> content = new ArrayList<>();
  ...
  public PageExpiredInboxRecordProjection content(@javax.annotation.Nullable List<ExpiredInboxRecordProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<ExpiredInboxRecordProjection> content) {
    this.content = content;
  }


  public PageExpiredInboxRecordProjection pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageExpiredInboxRecordProjection totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageExpiredInboxRecordProjection totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageExpiredInboxRecordProjection last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageExpiredInboxRecordProjection numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageExpiredInboxRecordProjection sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageExpiredInboxRecordProjection first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageExpiredInboxRecordProjection size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageExpiredInboxRecordProjection number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageExpiredInboxRecordProjection empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageExpiredInboxRecordProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageExpiredInboxRecordProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageExpiredInboxRecordProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageExpiredInboxRecordProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageExpiredInboxRecordProjection.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            ExpiredInboxRecordProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
