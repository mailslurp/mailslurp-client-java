...
public class PageContactProjection {
  ...
  private List<ContactProjection> content = new ArrayList<>();
  ...
  public PageContactProjection content(@javax.annotation.Nullable List<ContactProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<ContactProjection> content) {
    this.content = content;
  }


  public PageContactProjection pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageContactProjection totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageContactProjection totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageContactProjection last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageContactProjection numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageContactProjection sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageContactProjection first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageContactProjection size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageContactProjection number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageContactProjection empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageContactProjection
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageContactProjection.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageContactProjection.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageContactProjection` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageContactProjection.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            ContactProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
