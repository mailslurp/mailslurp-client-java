...
public class InboxByNameResult {
  ...
  public InboxByNameResult inboxId(@javax.annotation.Nullable UUID inboxId) {
  ...
  public InboxByNameResult exists(@javax.annotation.Nonnull Boolean exists) {
    this.exists = exists;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InboxByNameResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!InboxByNameResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InboxByNameResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InboxByNameResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
