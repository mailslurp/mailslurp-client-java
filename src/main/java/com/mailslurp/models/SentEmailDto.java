...
public class SentEmailDto {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, userId, inboxId, to, from, replyTo, cc, bcc, attachments, subject, bodyMD5Hash, body, toContacts, toGroup, charset, isHTML, sentAt, pixelIds, messageId, messageIds, virtualSend, templateId, templateVariables, html);
  }
