...
public class PageInboxReplierEvents {
  ...
  private List<InboxReplierEventProjection> content = new ArrayList<>();
  ...
  public PageInboxReplierEvents content(@javax.annotation.Nullable List<InboxReplierEventProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<InboxReplierEventProjection> content) {
    this.content = content;
  }


  public PageInboxReplierEvents pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageInboxReplierEvents totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageInboxReplierEvents totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageInboxReplierEvents last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageInboxReplierEvents numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageInboxReplierEvents sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageInboxReplierEvents first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageInboxReplierEvents size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageInboxReplierEvents number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageInboxReplierEvents empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageInboxReplierEvents
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageInboxReplierEvents.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageInboxReplierEvents.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageInboxReplierEvents` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageInboxReplierEvents.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            InboxReplierEventProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
