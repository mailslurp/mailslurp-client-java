...
public class PageConnector {
  ...
  private List<ConnectorProjection> content = new ArrayList<>();
  ...
  public PageConnector content(@javax.annotation.Nullable List<ConnectorProjection> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<ConnectorProjection> content) {
    this.content = content;
  }


  public PageConnector pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageConnector totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageConnector totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageConnector last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageConnector numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageConnector sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageConnector first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageConnector size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageConnector number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageConnector empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageConnector
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageConnector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageConnector.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageConnector` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageConnector.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            ConnectorProjection.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
