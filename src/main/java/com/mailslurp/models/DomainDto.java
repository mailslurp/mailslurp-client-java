...
public class DomainDto {
  ...
  **/
  ...
  @ApiModelProperty(value = "DNS records for DKIM approval")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A TXT record that you must place in the DNS settings of the domain to complete domain verification")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, dkimTokens, domain, id, isVerified, updatedAt, userId, verificationToken);
  }
