...
public class UploadMultipartFormRequest {
  ...
  public UploadMultipartFormRequest _file(@javax.annotation.Nonnull File _file) {
    this._file = _file;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._file, uploadMultipartFormRequest._file);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UploadMultipartFormRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!UploadMultipartFormRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UploadMultipartFormRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UploadMultipartFormRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
