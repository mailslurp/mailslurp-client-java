...
public class WebhookDto {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, userId, basicAuth, name, phoneId, inboxId, requestBodyTemplate, url, method, payloadJsonSchema, createdAt, updatedAt, eventName, requestHeaders, ignoreInsecureSslCertificates, useStaticIpRange, healthStatus);
  }
