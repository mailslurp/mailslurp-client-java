...
public class WebhookDto {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The inbox that the Webhook will be triggered by. If null then webhook triggered at account level")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, userId, basicAuth, name, inboxId, url, method, payloadJsonSchema, createdAt, updatedAt, eventName, requestHeaders);
  }
