...
public class EmailFeatureFamilyStatistics {
  /**
  ...
  @javax.annotation.Nonnull
  private List<EmailFeaturePlatformStatistics> platforms = new ArrayList<>();

  public EmailFeatureFamilyStatistics() {
  }

  public EmailFeatureFamilyStatistics feature(@javax.annotation.Nonnull FeatureEnum feature) {
  ...
  public EmailFeatureFamilyStatistics family(@javax.annotation.Nonnull FamilyEnum family) {
    this.family = family;
    return this;
  }
  ...
  public void setFamily(@javax.annotation.Nonnull FamilyEnum family) {
    this.family = family;
  }


  public EmailFeatureFamilyStatistics platforms(@javax.annotation.Nonnull List<EmailFeaturePlatformStatistics> platforms) {
    this.platforms = platforms;
    return this;
  }

  public EmailFeatureFamilyStatistics addPlatformsItem(EmailFeaturePlatformStatistics platformsItem) {
   ...
   */
  @javax.annotation.Nonnull
  public List<EmailFeaturePlatformStatistics> getPlatforms() {
    return platforms;
  }

  public void setPlatforms(@javax.annotation.Nonnull List<EmailFeaturePlatformStatistics> platforms) {
    this.platforms = platforms;
  }
  ...
  public boolean equals(Object o) {
    ...
    EmailFeatureFamilyStatistics emailFeatureFamilyStatistics = (EmailFeatureFamilyStatistics) o;
    return Objects.equals(this.feature, emailFeatureFamilyStatistics.feature) &&
        Objects.equals(this.family, emailFeatureFamilyStatistics.family) &&
        Objects.equals(this.platforms, emailFeatureFamilyStatistics.platforms);
  }

  @Override
  public int hashCode() {
    return Objects.hash(feature, family, platforms);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EmailFeatureFamilyStatistics
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!EmailFeatureFamilyStatistics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailFeatureFamilyStatistics is not found in the empty JSON string", EmailFeatureFamilyStatistics.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EmailFeatureFamilyStatistics.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EmailFeatureFamilyStatistics` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailFeatureFamilyStatistics.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayplatforms.size(); i++) {
        EmailFeaturePlatformStatistics.validateJsonElement(jsonArrayplatforms.get(i));
      };
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailFeatureFamilyStatistics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailFeatureFamilyStatistics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailFeatureFamilyStatistics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailFeatureFamilyStatistics.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailFeatureFamilyStatistics>() {
           @Override
           public void write(JsonWriter out, EmailFeatureFamilyStatistics value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EmailFeatureFamilyStatistics read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EmailFeatureFamilyStatistics given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EmailFeatureFamilyStatistics
   * @throws IOException if the JSON string is invalid with respect to EmailFeatureFamilyStatistics
   */
  public static EmailFeatureFamilyStatistics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailFeatureFamilyStatistics.class);
  }

  /**
   * Convert an instance of EmailFeatureFamilyStatistics to an JSON string
   *
   * @return JSON string
   */
