...
public class PageDeliveryStatus {
  ...
  private List<DeliveryStatusDto> content = new ArrayList<>();
  ...
  public PageDeliveryStatus content(@javax.annotation.Nullable List<DeliveryStatusDto> content) {
  ...
  public void setContent(@javax.annotation.Nullable List<DeliveryStatusDto> content) {
    this.content = content;
  }


  public PageDeliveryStatus pageable(@javax.annotation.Nullable PageableObject pageable) {
  ...
  public PageDeliveryStatus totalElements(@javax.annotation.Nonnull Long totalElements) {
  ...
  public PageDeliveryStatus totalPages(@javax.annotation.Nonnull Integer totalPages) {
  ...
  public PageDeliveryStatus last(@javax.annotation.Nullable Boolean last) {
    this.last = last;
    return this;
  }
  ...
  public PageDeliveryStatus numberOfElements(@javax.annotation.Nullable Integer numberOfElements) {
  ...
  public PageDeliveryStatus sort(@javax.annotation.Nullable SortObject sort) {
    this.sort = sort;
    return this;
  }
  ...
  public PageDeliveryStatus first(@javax.annotation.Nullable Boolean first) {
    this.first = first;
    return this;
  }
  ...
  public PageDeliveryStatus size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public PageDeliveryStatus number(@javax.annotation.Nullable Integer number) {
    this.number = number;
    return this;
  }
  ...
  public PageDeliveryStatus empty(@javax.annotation.Nullable Boolean empty) {
    this.empty = empty;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PageDeliveryStatus
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!PageDeliveryStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PageDeliveryStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageDeliveryStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PageDeliveryStatus.openapiRequiredFields) {
      ...
      if (jsonObj.get("content") != null && !jsonObj.get("content").isJsonNull()) {
        ...
        if (jsonArraycontent != null) {
          ...
          for (int i = 0; i < jsonArraycontent.size(); i++) {
            DeliveryStatusDto.validateJsonElement(jsonArraycontent.get(i));
          };
        }
      }
