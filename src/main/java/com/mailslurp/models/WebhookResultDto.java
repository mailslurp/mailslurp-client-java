...
public class WebhookResultDto {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(createdAt, httpMethod, id, inboxId, messageId, redriveId, responseBodyExtract, responseStatus, responseTimeMillis, resultType, updatedAt, userId, webhookEvent, webhookId, webhookUrl);
  }
