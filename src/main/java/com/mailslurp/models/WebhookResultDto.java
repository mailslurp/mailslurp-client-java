...
public class WebhookResultDto {
  ...
  public static final String SERIALIZED_NAME_AI_TRANSFORMER_ID = "aiTransformerId";
  @SerializedName(SERIALIZED_NAME_AI_TRANSFORMER_ID)
  @javax.annotation.Nullable
  ...
  public WebhookResultDto aiTransformerId(@javax.annotation.Nullable UUID aiTransformerId) {
  ...
  /**
   * Get aiTransformerId
   * @return aiTransformerId
   */
  @javax.annotation.Nullable
  public UUID getAiTransformerId() {
    return aiTransformerId;
  }

  public void setAiTransformerId(@javax.annotation.Nullable UUID aiTransformerId) {
    this.aiTransformerId = aiTransformerId;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, webhookResultDto.id) &&
        ...
        Objects.equals(this.aiTransformerId, webhookResultDto.aiTransformerId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, userId, webhookId, webhookUrl, messageId, redriveId, httpMethod, webhookEvent, responseStatus, responseTimeMillis, responseBodyExtract, resultType, createdAt, updatedAt, seen, inboxId, emailId, attachmentId, phoneId, smsId, aiTransformerId);
  }
  ...
  public String toString() {
    ...
    sb.append("    aiTransformerId: ").append(toIndentedString(aiTransformerId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("aiTransformerId");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      ...
      if ((jsonObj.get("aiTransformerId") != null && !jsonObj.get("aiTransformerId").isJsonNull()) && !jsonObj.get("aiTransformerId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `aiTransformerId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("aiTransformerId").toString()));
      }
  }
