...
public class GravatarUrl {
  ...
  public GravatarUrl url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public GravatarUrl hash(@javax.annotation.Nonnull String hash) {
    this.hash = hash;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GravatarUrl
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!GravatarUrl.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GravatarUrl.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GravatarUrl` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
