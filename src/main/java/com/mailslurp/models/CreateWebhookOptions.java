...
public class CreateWebhookOptions {
  ...
  public CreateWebhookOptions url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public CreateWebhookOptions basicAuth(@javax.annotation.Nullable BasicAuthOptions basicAuth) {
  ...
  public void setBasicAuth(@javax.annotation.Nullable BasicAuthOptions basicAuth) {
    this.basicAuth = basicAuth;
  }


  public CreateWebhookOptions name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateWebhookOptions eventName(@javax.annotation.Nullable EventNameEnum eventName) {
  ...
  public CreateWebhookOptions includeHeaders(@javax.annotation.Nullable WebhookHeaders includeHeaders) {
  ...
  public void setIncludeHeaders(@javax.annotation.Nullable WebhookHeaders includeHeaders) {
    this.includeHeaders = includeHeaders;
  }


  public CreateWebhookOptions requestBodyTemplate(@javax.annotation.Nullable String requestBodyTemplate) {
  ...
  public CreateWebhookOptions aiTransformId(@javax.annotation.Nullable UUID aiTransformId) {
  ...
  public CreateWebhookOptions useStaticIpRange(@javax.annotation.Nullable Boolean useStaticIpRange) {
  ...
  public CreateWebhookOptions ignoreInsecureSslCertificates(@javax.annotation.Nullable Boolean ignoreInsecureSslCertificates) {
  ...
  public CreateWebhookOptions tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public CreateWebhookOptions addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, createWebhookOptions.url) &&
        ...
        Objects.equals(this.aiTransformId, createWebhookOptions.aiTransformId) &&
        ...
        Objects.equals(this.tags, createWebhookOptions.tags);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(url, basicAuth, name, eventName, includeHeaders, requestBodyTemplate, aiTransformId, useStaticIpRange, ignoreInsecureSslCertificates, tags);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateWebhookOptions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!CreateWebhookOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateWebhookOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateWebhookOptions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("basicAuth") != null && !jsonObj.get("basicAuth").isJsonNull()) {
        BasicAuthOptions.validateJsonElement(jsonObj.get("basicAuth"));
      }
      ...
      if (jsonObj.get("includeHeaders") != null && !jsonObj.get("includeHeaders").isJsonNull()) {
        WebhookHeaders.validateJsonElement(jsonObj.get("includeHeaders"));
      }
