...
public class InboxByEmailAddressResult {
  ...
  public InboxByEmailAddressResult inboxId(@javax.annotation.Nullable UUID inboxId) {
  ...
  public InboxByEmailAddressResult exists(@javax.annotation.Nonnull Boolean exists) {
    this.exists = exists;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to InboxByEmailAddressResult
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException { if (true) { return; }
      if (jsonElement == null) {
        if (!InboxByEmailAddressResult.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InboxByEmailAddressResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InboxByEmailAddressResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
