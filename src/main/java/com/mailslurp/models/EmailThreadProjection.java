...
public class EmailThreadProjection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, from, subject, sender, recipients, userId, inboxId, createdAt, to, cc, bcc, updatedAt, hasAttachments, unread, messageCount, lastBodyExcerpt, lastTextExcerpt, lastCreatedAt, lastFrom, lastSender);
  }
