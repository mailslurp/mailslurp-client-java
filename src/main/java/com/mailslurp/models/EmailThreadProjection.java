...
public class EmailThreadProjection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sender, recipients, userId, inboxId, updatedAt, createdAt, to, cc, bcc, hasAttachments, lastBodyExcerpt, lastTextExcerpt, lastCreatedAt, lastFrom, lastSender, messageCount, unread, subject, id, from);
  }
