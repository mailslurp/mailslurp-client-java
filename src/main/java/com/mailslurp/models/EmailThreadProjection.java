...
public class EmailThreadProjection {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, emailThreadProjection.id) &&
        Objects.equals(this.from, emailThreadProjection.from) &&
        Objects.equals(this.subject, emailThreadProjection.subject) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, from, subject, sender, recipients, userId, inboxId, updatedAt, createdAt, to, cc, bcc, hasAttachments, unread, messageCount, lastBodyExcerpt, lastTextExcerpt, lastCreatedAt, lastFrom, lastSender);
  }
