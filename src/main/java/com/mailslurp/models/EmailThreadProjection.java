...
public class EmailThreadProjection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(subject, updatedAt, userId, inboxId, createdAt, to, cc, bcc, sender, recipients, hasAttachments, unread, messageCount, lastBodyExcerpt, lastTextExcerpt, lastCreatedAt, lastFrom, lastSender, id, from);
  }
