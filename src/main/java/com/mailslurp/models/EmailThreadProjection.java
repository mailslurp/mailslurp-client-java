...
public class EmailThreadProjection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sender, recipients, userId, inboxId, createdAt, updatedAt, to, cc, bcc, hasAttachments, unread, messageCount, lastBodyExcerpt, lastTextExcerpt, lastCreatedAt, lastFrom, lastSender, subject, id, from);
  }
