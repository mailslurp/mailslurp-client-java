...
public class EmailThreadProjection {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(subject, userId, inboxId, sender, recipients, updatedAt, createdAt, to, cc, bcc, hasAttachments, lastCreatedAt, lastFrom, lastSender, unread, messageCount, lastBodyExcerpt, lastTextExcerpt, id, from);
  }
