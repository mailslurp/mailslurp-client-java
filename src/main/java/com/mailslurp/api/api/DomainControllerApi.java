...
public class DomainControllerApi {
     ...
     */
    public DomainPlusVerificationRecordsAndStatus createDomain(CreateDomainOptions domainOptions) throws ApiException {
        ApiResponse<DomainPlusVerificationRecordsAndStatus> localVarResp = createDomainWithHttpInfo(domainOptions);
     ...
     */
    public ApiResponse<DomainPlusVerificationRecordsAndStatus> createDomainWithHttpInfo(CreateDomainOptions domainOptions) throws ApiException {
     ...
     */
    public okhttp3.Call createDomainAsync(CreateDomainOptions domainOptions, final ApiCallback<DomainPlusVerificationRecordsAndStatus> _callback) throws ApiException {
    ...
    public DomainPlusVerificationRecordsAndStatus getDomain(UUID id) throws ApiException {
        ApiResponse<DomainPlusVerificationRecordsAndStatus> localVarResp = getDomainWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call getDomainAsync(UUID id, final ApiCallback<DomainPlusVerificationRecordsAndStatus> _callback) throws ApiException {
