...
import com.mailslurp.models.DomainRegionGroupsDto;
...
public class DomainControllerApi {
    ...
    private okhttp3.Call getAvailableDomainRegionsCall(@javax.annotation.Nullable String inboxType, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/domains/available-domain-regions";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAvailableDomainRegionsValidateBeforeCall(@javax.annotation.Nullable String inboxType, final ApiCallback _callback) throws ApiException {
        return getAvailableDomainRegionsCall(inboxType, _callback);

    }


    private ApiResponse<DomainRegionGroupsDto> getAvailableDomainRegionsWithHttpInfo(@javax.annotation.Nullable String inboxType) throws ApiException {
        okhttp3.Call localVarCall = getAvailableDomainRegionsValidateBeforeCall(inboxType, null);
        Type localVarReturnType = new TypeToken<DomainRegionGroupsDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getAvailableDomainRegionsAsync(@javax.annotation.Nullable String inboxType, final ApiCallback<DomainRegionGroupsDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAvailableDomainRegionsValidateBeforeCall(inboxType, _callback);
        Type localVarReturnType = new TypeToken<DomainRegionGroupsDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIgetAvailableDomainRegionsRequest {
        @javax.annotation.Nullable
        private String inboxType;

        private APIgetAvailableDomainRegionsRequest() {
        }

        /**
         * Set inboxType
         * @param inboxType  (optional)
         * @return APIgetAvailableDomainRegionsRequest
         */
        public APIgetAvailableDomainRegionsRequest inboxType(@javax.annotation.Nullable String inboxType) {
            this.inboxType = inboxType;
            return this;
        }

        /**
         * Build call for getAvailableDomainRegions
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute getAvailableDomainRegions request
       ...
       <caption>Response Details</caption>
         ...
         */
        public DomainRegionGroupsDto execute() throws ApiException {
            ApiResponse<DomainRegionGroupsDto> localVarResp = getAvailableDomainRegionsWithHttpInfo(inboxType);
            return localVarResp.getData();
        }

        /**
         * Execute getAvailableDomainRegions request with HTTP info returned
         * @return ApiResponse&lt;DomainRegionGroupsDto&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<DomainRegionGroupsDto> executeWithHttpInfo() throws ApiException {
            return getAvailableDomainRegionsWithHttpInfo(inboxType);
        }

        /**
         * Execute getAvailableDomainRegions request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<DomainRegionGroupsDto> _callback) throws ApiException {
            return getAvailableDomainRegionsAsync(inboxType, _callback);
        }
    }
     ...
     */
    public APIgetAvailableDomainRegionsRequest getAvailableDomainRegions() {
        return new APIgetAvailableDomainRegionsRequest();
    }
