...
public class DomainControllerApi {
     ...
     * @param id id (required)
     * @param updateDomainDto updateDomainDto (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updateDomainCall(UUID id, UpdateDomainOptions updateDomainDto, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = updateDomainDto;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateDomainValidateBeforeCall(UUID id, UpdateDomainOptions updateDomainDto, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateDomainCall(id, updateDomainDto, _callback);
        return localVarCall;
    ...
    public DomainDto updateDomain(UUID id, UpdateDomainOptions updateDomainDto) throws ApiException {
        ApiResponse<DomainDto> localVarResp = updateDomainWithHttpInfo(id, updateDomainDto);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<DomainDto> updateDomainWithHttpInfo(UUID id, UpdateDomainOptions updateDomainDto) throws ApiException {
        okhttp3.Call localVarCall = updateDomainValidateBeforeCall(id, updateDomainDto, null);
        Type localVarReturnType = new TypeToken<DomainDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateDomainAsync(UUID id, UpdateDomainOptions updateDomainDto, final ApiCallback<DomainDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateDomainValidateBeforeCall(id, updateDomainDto, _callback);
        Type localVarReturnType = new TypeToken<DomainDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
