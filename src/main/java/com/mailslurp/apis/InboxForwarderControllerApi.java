...
public class InboxForwarderControllerApi {
     ...
     */
    public okhttp3.Call getInboxForwardersCall(UUID inboxId, Integer page, String searchFilter, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getInboxForwardersValidateBeforeCall(UUID inboxId, Integer page, String searchFilter, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getInboxForwardersCall(inboxId, page, searchFilter, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageInboxForwarderDto getInboxForwarders(UUID inboxId, Integer page, String searchFilter, Integer size, String sort) throws ApiException {
        ApiResponse<PageInboxForwarderDto> localVarResp = getInboxForwardersWithHttpInfo(inboxId, page, searchFilter, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageInboxForwarderDto> getInboxForwardersWithHttpInfo(UUID inboxId, Integer page, String searchFilter, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getInboxForwardersValidateBeforeCall(inboxId, page, searchFilter, size, sort, null);
     ...
     */
    public okhttp3.Call getInboxForwardersAsync(UUID inboxId, Integer page, String searchFilter, Integer size, String sort, final ApiCallback<PageInboxForwarderDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = getInboxForwardersValidateBeforeCall(inboxId, page, searchFilter, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageInboxForwarderDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
