...
public class CommonActionsControllerApi {
     ...
     */
    public okhttp3.Call createNewEmailAddressCall(Boolean allowTeamAccess, OffsetDateTime expiresAt, Long expiresIn, Boolean useDomainPool, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createNewEmailAddressValidateBeforeCall(Boolean allowTeamAccess, OffsetDateTime expiresAt, Long expiresIn, Boolean useDomainPool, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = createNewEmailAddressCall(allowTeamAccess, expiresAt, expiresIn, useDomainPool, _callback);
        return localVarCall;
    ...
    public Inbox createNewEmailAddress(Boolean allowTeamAccess, OffsetDateTime expiresAt, Long expiresIn, Boolean useDomainPool) throws ApiException {
        ApiResponse<Inbox> localVarResp = createNewEmailAddressWithHttpInfo(allowTeamAccess, expiresAt, expiresIn, useDomainPool);
    ...
    public ApiResponse<Inbox> createNewEmailAddressWithHttpInfo(Boolean allowTeamAccess, OffsetDateTime expiresAt, Long expiresIn, Boolean useDomainPool) throws ApiException {
        okhttp3.Call localVarCall = createNewEmailAddressValidateBeforeCall(allowTeamAccess, expiresAt, expiresIn, useDomainPool, null);
     ...
     */
    public okhttp3.Call createNewEmailAddressAsync(Boolean allowTeamAccess, OffsetDateTime expiresAt, Long expiresIn, Boolean useDomainPool, final ApiCallback<Inbox> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewEmailAddressValidateBeforeCall(allowTeamAccess, expiresAt, expiresIn, useDomainPool, _callback);
        Type localVarReturnType = new TypeToken<Inbox>(){}.getType();
     ...
     */
    public okhttp3.Call createNewEmailAddress1Call(Boolean allowTeamAccess, OffsetDateTime expiresAt, Long expiresIn, Boolean useDomainPool, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createNewEmailAddress1ValidateBeforeCall(Boolean allowTeamAccess, OffsetDateTime expiresAt, Long expiresIn, Boolean useDomainPool, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = createNewEmailAddress1Call(allowTeamAccess, expiresAt, expiresIn, useDomainPool, _callback);
        return localVarCall;
    ...
    public Inbox createNewEmailAddress1(Boolean allowTeamAccess, OffsetDateTime expiresAt, Long expiresIn, Boolean useDomainPool) throws ApiException {
        ApiResponse<Inbox> localVarResp = createNewEmailAddress1WithHttpInfo(allowTeamAccess, expiresAt, expiresIn, useDomainPool);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Inbox> createNewEmailAddress1WithHttpInfo(Boolean allowTeamAccess, OffsetDateTime expiresAt, Long expiresIn, Boolean useDomainPool) throws ApiException {
        okhttp3.Call localVarCall = createNewEmailAddress1ValidateBeforeCall(allowTeamAccess, expiresAt, expiresIn, useDomainPool, null);
        Type localVarReturnType = new TypeToken<Inbox>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call createNewEmailAddress1Async(Boolean allowTeamAccess, OffsetDateTime expiresAt, Long expiresIn, Boolean useDomainPool, final ApiCallback<Inbox> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewEmailAddress1ValidateBeforeCall(allowTeamAccess, expiresAt, expiresIn, useDomainPool, _callback);
        Type localVarReturnType = new TypeToken<Inbox>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
