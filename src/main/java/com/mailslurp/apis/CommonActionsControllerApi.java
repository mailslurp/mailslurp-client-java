...
public class CommonActionsControllerApi {
     ...
     */
    public okhttp3.Call createNewEmailAddress1Call(Boolean allowTeamAccess, Boolean useDomainPool, OffsetDateTime expiresAt, Long expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, Boolean favourite, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createNewEmailAddress1ValidateBeforeCall(Boolean allowTeamAccess, Boolean useDomainPool, OffsetDateTime expiresAt, Long expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, Boolean favourite, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = createNewEmailAddress1Call(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, _callback);
        return localVarCall;
     ...
     */
    public InboxDto createNewEmailAddress1(Boolean allowTeamAccess, Boolean useDomainPool, OffsetDateTime expiresAt, Long expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, Boolean favourite) throws ApiException {
        ApiResponse<InboxDto> localVarResp = createNewEmailAddress1WithHttpInfo(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InboxDto> createNewEmailAddress1WithHttpInfo(Boolean allowTeamAccess, Boolean useDomainPool, OffsetDateTime expiresAt, Long expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, Boolean favourite) throws ApiException {
        okhttp3.Call localVarCall = createNewEmailAddress1ValidateBeforeCall(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, null);
        Type localVarReturnType = new TypeToken<InboxDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call createNewEmailAddress1Async(Boolean allowTeamAccess, Boolean useDomainPool, OffsetDateTime expiresAt, Long expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, Boolean favourite, final ApiCallback<InboxDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewEmailAddress1ValidateBeforeCall(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, _callback);
        Type localVarReturnType = new TypeToken<InboxDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
