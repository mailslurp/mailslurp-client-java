...
public class CommonActionsControllerApi {
     ...
     */
    public okhttp3.Call createNewEmailAddressCall(Boolean allowTeamAccess, Boolean useDomainPool, OffsetDateTime expiresAt, Long expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, Boolean favourite, Boolean virtualInbox, Boolean useShortAddress, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createNewEmailAddressValidateBeforeCall(Boolean allowTeamAccess, Boolean useDomainPool, OffsetDateTime expiresAt, Long expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, Boolean favourite, Boolean virtualInbox, Boolean useShortAddress, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createNewEmailAddressCall(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, _callback);
        return localVarCall;
     ...
     */
    public InboxDto createNewEmailAddress(Boolean allowTeamAccess, Boolean useDomainPool, OffsetDateTime expiresAt, Long expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, Boolean favourite, Boolean virtualInbox, Boolean useShortAddress) throws ApiException {
        ApiResponse<InboxDto> localVarResp = createNewEmailAddressWithHttpInfo(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress);
     ...
     */
    public ApiResponse<InboxDto> createNewEmailAddressWithHttpInfo(Boolean allowTeamAccess, Boolean useDomainPool, OffsetDateTime expiresAt, Long expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, Boolean favourite, Boolean virtualInbox, Boolean useShortAddress) throws ApiException {
        okhttp3.Call localVarCall = createNewEmailAddressValidateBeforeCall(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, null);
     ...
     */
    public okhttp3.Call createNewEmailAddressAsync(Boolean allowTeamAccess, Boolean useDomainPool, OffsetDateTime expiresAt, Long expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, Boolean favourite, Boolean virtualInbox, Boolean useShortAddress, final ApiCallback<InboxDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewEmailAddressValidateBeforeCall(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, _callback);
        Type localVarReturnType = new TypeToken<InboxDto>(){}.getType();
    ...
    private okhttp3.Call createRandomInboxValidateBeforeCall(Boolean allowTeamAccess, Boolean useDomainPool, OffsetDateTime expiresAt, Long expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, Boolean favourite, Boolean virtualInbox, Boolean useShortAddress, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createRandomInboxCall(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, _callback);
        return localVarCall;
     ...
     */
    public InboxDto createRandomInbox(Boolean allowTeamAccess, Boolean useDomainPool, OffsetDateTime expiresAt, Long expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, Boolean favourite, Boolean virtualInbox, Boolean useShortAddress) throws ApiException {
        ApiResponse<InboxDto> localVarResp = createRandomInboxWithHttpInfo(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<InboxDto> createRandomInboxWithHttpInfo(Boolean allowTeamAccess, Boolean useDomainPool, OffsetDateTime expiresAt, Long expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, Boolean favourite, Boolean virtualInbox, Boolean useShortAddress) throws ApiException {
        okhttp3.Call localVarCall = createRandomInboxValidateBeforeCall(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, null);
        Type localVarReturnType = new TypeToken<InboxDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
    ...
    public okhttp3.Call createRandomInboxAsync(Boolean allowTeamAccess, Boolean useDomainPool, OffsetDateTime expiresAt, Long expiresIn, String emailAddress, String inboxType, String description, String name, List<String> tags, Boolean favourite, Boolean virtualInbox, Boolean useShortAddress, final ApiCallback<InboxDto> _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createRandomInboxValidateBeforeCall(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, _callback);
        Type localVarReturnType = new TypeToken<InboxDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
