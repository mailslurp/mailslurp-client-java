...
public class MissedEmailControllerApi {
     ...
     */
    public okhttp3.Call getAllUnknownMissedEmailsCall(UUID inboxId, Integer page, String searchFilter, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllUnknownMissedEmailsValidateBeforeCall(UUID inboxId, Integer page, String searchFilter, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAllUnknownMissedEmailsCall(inboxId, page, searchFilter, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageUnknownMissedEmailProjection getAllUnknownMissedEmails(UUID inboxId, Integer page, String searchFilter, Integer size, String sort) throws ApiException {
        ApiResponse<PageUnknownMissedEmailProjection> localVarResp = getAllUnknownMissedEmailsWithHttpInfo(inboxId, page, searchFilter, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageUnknownMissedEmailProjection> getAllUnknownMissedEmailsWithHttpInfo(UUID inboxId, Integer page, String searchFilter, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getAllUnknownMissedEmailsValidateBeforeCall(inboxId, page, searchFilter, size, sort, null);
     ...
     */
    public okhttp3.Call getAllUnknownMissedEmailsAsync(UUID inboxId, Integer page, String searchFilter, Integer size, String sort, final ApiCallback<PageUnknownMissedEmailProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllUnknownMissedEmailsValidateBeforeCall(inboxId, page, searchFilter, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageUnknownMissedEmailProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
