...
public class MissedEmailControllerApi {
     ...
     * @param inboxId Optional inbox ID filter (required)
     * @param timeout Optional timeout milliseconds (required)
     ...
     */
    public okhttp3.Call waitForNthMissedEmailCall(UUID inboxId, Long timeout, Integer index, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
        ...
        String localVarPath = "/missed-emails/waitForNthMissedEmail"
            ...
            .replaceAll("\\{" + "timeout" + "\\}", localVarApiClient.escapeString(timeout.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call waitForNthMissedEmailValidateBeforeCall(UUID inboxId, Long timeout, Integer index, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = waitForNthMissedEmailCall(inboxId, timeout, index, _callback);
        return localVarCall;
     ...
     */
    public MissedEmail waitForNthMissedEmail(UUID inboxId, Long timeout, Integer index) throws ApiException {
        ApiResponse<MissedEmail> localVarResp = waitForNthMissedEmailWithHttpInfo(inboxId, timeout, index);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<MissedEmail> waitForNthMissedEmailWithHttpInfo(UUID inboxId, Long timeout, Integer index) throws ApiException {
        okhttp3.Call localVarCall = waitForNthMissedEmailValidateBeforeCall(inboxId, timeout, index, null);
        Type localVarReturnType = new TypeToken<MissedEmail>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call waitForNthMissedEmailAsync(UUID inboxId, Long timeout, Integer index, final ApiCallback<MissedEmail> _callback) throws ApiException {

        okhttp3.Call localVarCall = waitForNthMissedEmailValidateBeforeCall(inboxId, timeout, index, _callback);
        Type localVarReturnType = new TypeToken<MissedEmail>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
