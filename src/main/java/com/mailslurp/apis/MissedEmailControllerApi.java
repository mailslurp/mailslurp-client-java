...
public class MissedEmailControllerApi {
     ...
     */
    public okhttp3.Call getAllMissedEmailsCall(Integer page, Integer size, String sort, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAllMissedEmailsValidateBeforeCall(Integer page, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAllMissedEmailsCall(page, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageMissedEmailProjection getAllMissedEmails(Integer page, Integer size, String sort) throws ApiException {
        ApiResponse<PageMissedEmailProjection> localVarResp = getAllMissedEmailsWithHttpInfo(page, size, sort);
     ...
     */
    public ApiResponse<PageMissedEmailProjection> getAllMissedEmailsWithHttpInfo(Integer page, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getAllMissedEmailsValidateBeforeCall(page, size, sort, null);
     ...
     */
    public okhttp3.Call getAllMissedEmailsAsync(Integer page, Integer size, String sort, final ApiCallback<PageMissedEmailProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllMissedEmailsValidateBeforeCall(page, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageMissedEmailProjection>(){}.getType();
