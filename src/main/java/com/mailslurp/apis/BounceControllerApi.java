...
public class BounceControllerApi {
     ...
     */
    public Bounce getBouncedEmail(UUID id) throws ApiException {
        ApiResponse<Bounce> localVarResp = getBouncedEmailWithHttpInfo(id);
     ...
     */
    public ApiResponse<Bounce> getBouncedEmailWithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = getBouncedEmailValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<Bounce>(){}.getType();
     ...
     */
    public okhttp3.Call getBouncedEmailAsync(UUID id, final ApiCallback<Bounce> _callback) throws ApiException {
     ...
     */
    public PageBouncedEmail getBouncedEmails(Integer page, Integer size, String sort) throws ApiException {
        ApiResponse<PageBouncedEmail> localVarResp = getBouncedEmailsWithHttpInfo(page, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageBouncedEmail> getBouncedEmailsWithHttpInfo(Integer page, Integer size, String sort) throws ApiException {
     ...
     */
    public okhttp3.Call getBouncedEmailsAsync(Integer page, Integer size, String sort, final ApiCallback<PageBouncedEmail> _callback) throws ApiException {
     ...
     */
    public BounceRecipient getBouncedRecipient(UUID id) throws ApiException {
        ApiResponse<BounceRecipient> localVarResp = getBouncedRecipientWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * Bounced emails are email you have sent that were rejected by a recipient
     * @param id ID of the bounced recipient (required)
     * @return ApiResponse&lt;BounceRecipient&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BounceRecipient> getBouncedRecipientWithHttpInfo(UUID id) throws ApiException {
        okhttp3.Call localVarCall = getBouncedRecipientValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<BounceRecipient>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getBouncedRecipientAsync(UUID id, final ApiCallback<BounceRecipient> _callback) throws ApiException {
     ...
     */
    public PageBouncedRecipients getBouncedRecipients(Integer page, Integer size, String sort) throws ApiException {
        ApiResponse<PageBouncedRecipients> localVarResp = getBouncedRecipientsWithHttpInfo(page, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageBouncedRecipients> getBouncedRecipientsWithHttpInfo(Integer page, Integer size, String sort) throws ApiException {
     ...
     */
    public okhttp3.Call getBouncedRecipientsAsync(Integer page, Integer size, String sort, final ApiCallback<PageBouncedRecipients> _callback) throws ApiException {
