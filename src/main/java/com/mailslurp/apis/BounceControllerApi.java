...
import com.mailslurp.models.TenantReputationFindingsDto;
import com.mailslurp.models.TenantReputationStatusSummaryDto;
...
public class BounceControllerApi {
    ...
    private okhttp3.Call getTenantReputationFindingsCall(@javax.annotation.Nullable String accountRegion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/bounce/tenant-findings";
        ...
        if (accountRegion != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("accountRegion", accountRegion));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTenantReputationFindingsValidateBeforeCall(@javax.annotation.Nullable String accountRegion, final ApiCallback _callback) throws ApiException {
        return getTenantReputationFindingsCall(accountRegion, _callback);

    }


    private ApiResponse<TenantReputationFindingsDto> getTenantReputationFindingsWithHttpInfo(@javax.annotation.Nullable String accountRegion) throws ApiException {
        okhttp3.Call localVarCall = getTenantReputationFindingsValidateBeforeCall(accountRegion, null);
        Type localVarReturnType = new TypeToken<TenantReputationFindingsDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getTenantReputationFindingsAsync(@javax.annotation.Nullable String accountRegion, final ApiCallback<TenantReputationFindingsDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTenantReputationFindingsValidateBeforeCall(accountRegion, _callback);
        Type localVarReturnType = new TypeToken<TenantReputationFindingsDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIgetTenantReputationFindingsRequest {
        @javax.annotation.Nullable
        private String accountRegion;

        private APIgetTenantReputationFindingsRequest() {
        }

        /**
         * Set accountRegion
         * @param accountRegion Optional account region filter (optional)
         * @return APIgetTenantReputationFindingsRequest
         */
        public APIgetTenantReputationFindingsRequest accountRegion(@javax.annotation.Nullable String accountRegion) {
            this.accountRegion = accountRegion;
            return this;
        }

        /**
         * Build call for getTenantReputationFindings
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute getTenantReputationFindings request
       ...
       <caption>Response Details</caption>
         ...
         */
        public TenantReputationFindingsDto execute() throws ApiException {
            ApiResponse<TenantReputationFindingsDto> localVarResp = getTenantReputationFindingsWithHttpInfo(accountRegion);
            return localVarResp.getData();
        }

        /**
         * Execute getTenantReputationFindings request with HTTP info returned
         * @return ApiResponse&lt;TenantReputationFindingsDto&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<TenantReputationFindingsDto> executeWithHttpInfo() throws ApiException {
            return getTenantReputationFindingsWithHttpInfo(accountRegion);
        }

        /**
         * Execute getTenantReputationFindings request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<TenantReputationFindingsDto> _callback) throws ApiException {
            return getTenantReputationFindingsAsync(accountRegion, _callback);
        }
    }
     ...
     */
    public APIgetTenantReputationFindingsRequest getTenantReputationFindings() {
        return new APIgetTenantReputationFindingsRequest();
    }
    private okhttp3.Call getTenantReputationStatusSummaryCall(@javax.annotation.Nullable String accountRegion, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/bounce/tenant-status";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTenantReputationStatusSummaryValidateBeforeCall(@javax.annotation.Nullable String accountRegion, final ApiCallback _callback) throws ApiException {
        return getTenantReputationStatusSummaryCall(accountRegion, _callback);

    }


    private ApiResponse<TenantReputationStatusSummaryDto> getTenantReputationStatusSummaryWithHttpInfo(@javax.annotation.Nullable String accountRegion) throws ApiException {
        okhttp3.Call localVarCall = getTenantReputationStatusSummaryValidateBeforeCall(accountRegion, null);
        Type localVarReturnType = new TypeToken<TenantReputationStatusSummaryDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getTenantReputationStatusSummaryAsync(@javax.annotation.Nullable String accountRegion, final ApiCallback<TenantReputationStatusSummaryDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTenantReputationStatusSummaryValidateBeforeCall(accountRegion, _callback);
        Type localVarReturnType = new TypeToken<TenantReputationStatusSummaryDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIgetTenantReputationStatusSummaryRequest {
        @javax.annotation.Nullable
        private String accountRegion;

        private APIgetTenantReputationStatusSummaryRequest() {
        }

        /**
         * Set accountRegion
         * @param accountRegion Optional account region filter (optional)
         * @return APIgetTenantReputationStatusSummaryRequest
         */
        public APIgetTenantReputationStatusSummaryRequest accountRegion(@javax.annotation.Nullable String accountRegion) {
            this.accountRegion = accountRegion;
            return this;
        }

        /**
         * Build call for getTenantReputationStatusSummary
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute getTenantReputationStatusSummary request
       ...
       <caption>Response Details</caption>
         ...
         */
        public TenantReputationStatusSummaryDto execute() throws ApiException {
            ApiResponse<TenantReputationStatusSummaryDto> localVarResp = getTenantReputationStatusSummaryWithHttpInfo(accountRegion);
            return localVarResp.getData();
        }

        /**
         * Execute getTenantReputationStatusSummary request with HTTP info returned
         * @return ApiResponse&lt;TenantReputationStatusSummaryDto&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<TenantReputationStatusSummaryDto> executeWithHttpInfo() throws ApiException {
            return getTenantReputationStatusSummaryWithHttpInfo(accountRegion);
        }

        /**
         * Execute getTenantReputationStatusSummary request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<TenantReputationStatusSummaryDto> _callback) throws ApiException {
            return getTenantReputationStatusSummaryAsync(accountRegion, _callback);
        }
    }
     ...
     */
    public APIgetTenantReputationStatusSummaryRequest getTenantReputationStatusSummary() {
        return new APIgetTenantReputationStatusSummaryRequest();
    }
}
