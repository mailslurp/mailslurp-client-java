...
public class ExpiredControllerApi {
     ...
     */
    public okhttp3.Call getExpiredInboxesCall(Integer page, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getExpiredInboxesValidateBeforeCall(Integer page, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getExpiredInboxesCall(page, size, sort, _callback);
        return localVarCall;
    ...
    public PageExpiredInboxRecordProjection getExpiredInboxes(Integer page, Integer size, String sort) throws ApiException {
        ApiResponse<PageExpiredInboxRecordProjection> localVarResp = getExpiredInboxesWithHttpInfo(page, size, sort);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<PageExpiredInboxRecordProjection> getExpiredInboxesWithHttpInfo(Integer page, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getExpiredInboxesValidateBeforeCall(page, size, sort, null);
     ...
     */
    public okhttp3.Call getExpiredInboxesAsync(Integer page, Integer size, String sort, final ApiCallback<PageExpiredInboxRecordProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getExpiredInboxesValidateBeforeCall(page, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageExpiredInboxRecordProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
