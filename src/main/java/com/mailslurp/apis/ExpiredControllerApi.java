...
public class ExpiredControllerApi {
     ...
     */
    public okhttp3.Call getExpiredInboxesCall(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getExpiredInboxesValidateBeforeCall(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getExpiredInboxesCall(before, page, since, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageExpiredInboxRecordProjection getExpiredInboxes(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        ApiResponse<PageExpiredInboxRecordProjection> localVarResp = getExpiredInboxesWithHttpInfo(before, page, since, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageExpiredInboxRecordProjection> getExpiredInboxesWithHttpInfo(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getExpiredInboxesValidateBeforeCall(before, page, since, size, sort, null);
     ...
     */
    public okhttp3.Call getExpiredInboxesAsync(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback<PageExpiredInboxRecordProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getExpiredInboxesValidateBeforeCall(before, page, since, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageExpiredInboxRecordProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
