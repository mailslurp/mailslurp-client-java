...
public class EmailVerificationControllerApi {
    ...
    private okhttp3.Call getEmailIntelligenceCall(@javax.annotation.Nonnull EmailIntelligenceOptions emailIntelligenceOptions, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = emailIntelligenceOptions;

        // create path and map variables
        String localVarPath = "/email-verification/intelligence";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getEmailIntelligenceValidateBeforeCall(@javax.annotation.Nonnull EmailIntelligenceOptions emailIntelligenceOptions, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'emailIntelligenceOptions' is set
        if (emailIntelligenceOptions == null) {
            throw new ApiException("Missing the required parameter 'emailIntelligenceOptions' when calling getEmailIntelligence(Async)");
        }

        return getEmailIntelligenceCall(emailIntelligenceOptions, _callback);

    }


    private ApiResponse<EmailIntelligenceListResult> getEmailIntelligenceWithHttpInfo(@javax.annotation.Nonnull EmailIntelligenceOptions emailIntelligenceOptions) throws ApiException {
        okhttp3.Call localVarCall = getEmailIntelligenceValidateBeforeCall(emailIntelligenceOptions, null);
        Type localVarReturnType = new TypeToken<EmailIntelligenceListResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getEmailIntelligenceAsync(@javax.annotation.Nonnull EmailIntelligenceOptions emailIntelligenceOptions, final ApiCallback<EmailIntelligenceListResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = getEmailIntelligenceValidateBeforeCall(emailIntelligenceOptions, _callback);
        Type localVarReturnType = new TypeToken<EmailIntelligenceListResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIgetEmailIntelligenceRequest {
        @javax.annotation.Nonnull
        private final EmailIntelligenceOptions emailIntelligenceOptions;

        private APIgetEmailIntelligenceRequest(@javax.annotation.Nonnull EmailIntelligenceOptions emailIntelligenceOptions) {
            this.emailIntelligenceOptions = emailIntelligenceOptions;
        }

        /**
         * Build call for getEmailIntelligence
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute getEmailIntelligence request
       ...
       <caption>Response Details</caption>
         ...
         */
        public EmailIntelligenceListResult execute() throws ApiException {
            ApiResponse<EmailIntelligenceListResult> localVarResp = getEmailIntelligenceWithHttpInfo(emailIntelligenceOptions);
            return localVarResp.getData();
        }

        /**
         * Execute getEmailIntelligence request with HTTP info returned
         * @return ApiResponse&lt;EmailIntelligenceListResult&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<EmailIntelligenceListResult> executeWithHttpInfo() throws ApiException {
            return getEmailIntelligenceWithHttpInfo(emailIntelligenceOptions);
        }

        /**
         * Execute getEmailIntelligence request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<EmailIntelligenceListResult> _callback) throws ApiException {
            return getEmailIntelligenceAsync(emailIntelligenceOptions, _callback);
        }
    }
     ...
     * @param emailIntelligenceOptions  (required)
     * @return APIgetEmailIntelligenceRequest
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIgetEmailIntelligenceRequest getEmailIntelligence(@javax.annotation.Nonnull EmailIntelligenceOptions emailIntelligenceOptions) {
        return new APIgetEmailIntelligenceRequest(emailIntelligenceOptions);
    }
