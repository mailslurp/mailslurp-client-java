...
public class InboxRulesetControllerApi {
     ...
     */
    public okhttp3.Call getInboxRulesetsCall(UUID inboxId, Integer page, String searchFilter, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getInboxRulesetsValidateBeforeCall(UUID inboxId, Integer page, String searchFilter, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getInboxRulesetsCall(inboxId, page, searchFilter, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageInboxRulesetDto getInboxRulesets(UUID inboxId, Integer page, String searchFilter, Integer size, String sort) throws ApiException {
        ApiResponse<PageInboxRulesetDto> localVarResp = getInboxRulesetsWithHttpInfo(inboxId, page, searchFilter, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageInboxRulesetDto> getInboxRulesetsWithHttpInfo(UUID inboxId, Integer page, String searchFilter, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getInboxRulesetsValidateBeforeCall(inboxId, page, searchFilter, size, sort, null);
     ...
     */
    public okhttp3.Call getInboxRulesetsAsync(UUID inboxId, Integer page, String searchFilter, Integer size, String sort, final ApiCallback<PageInboxRulesetDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = getInboxRulesetsValidateBeforeCall(inboxId, page, searchFilter, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageInboxRulesetDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
