...
public class InboxRulesetControllerApi {
     ...
     */
    public okhttp3.Call getInboxRulesetsCall(OffsetDateTime before, UUID inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getInboxRulesetsValidateBeforeCall(OffsetDateTime before, UUID inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getInboxRulesetsCall(before, inboxId, page, searchFilter, since, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageInboxRulesetDto getInboxRulesets(OffsetDateTime before, UUID inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort) throws ApiException {
        ApiResponse<PageInboxRulesetDto> localVarResp = getInboxRulesetsWithHttpInfo(before, inboxId, page, searchFilter, since, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageInboxRulesetDto> getInboxRulesetsWithHttpInfo(OffsetDateTime before, UUID inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getInboxRulesetsValidateBeforeCall(before, inboxId, page, searchFilter, since, size, sort, null);
     ...
     */
    public okhttp3.Call getInboxRulesetsAsync(OffsetDateTime before, UUID inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, final ApiCallback<PageInboxRulesetDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = getInboxRulesetsValidateBeforeCall(before, inboxId, page, searchFilter, since, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageInboxRulesetDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param id ID of inbox ruleset (required)
     * @param inboxRulesetTestOptions inboxRulesetTestOptions (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @param testNewInboxRulesetOptions testNewInboxRulesetOptions (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
