...
public class PhoneControllerApi {
     ...
     */
    public okhttp3.Call testPhoneNumberSendSmsCall(UUID phoneNumberId, TestPhoneNumberOptions testPhoneNumberOptions, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call testPhoneNumberSendSmsValidateBeforeCall(UUID phoneNumberId, TestPhoneNumberOptions testPhoneNumberOptions, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = testPhoneNumberSendSmsCall(phoneNumberId, testPhoneNumberOptions, _callback);
        return localVarCall;
     ...
     */
    public void testPhoneNumberSendSms(UUID phoneNumberId, TestPhoneNumberOptions testPhoneNumberOptions) throws ApiException {
     ...
     */
    public ApiResponse<Void> testPhoneNumberSendSmsWithHttpInfo(UUID phoneNumberId, TestPhoneNumberOptions testPhoneNumberOptions) throws ApiException {
        okhttp3.Call localVarCall = testPhoneNumberSendSmsValidateBeforeCall(phoneNumberId, testPhoneNumberOptions, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call testPhoneNumberSendSmsAsync(UUID phoneNumberId, TestPhoneNumberOptions testPhoneNumberOptions, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = testPhoneNumberSendSmsValidateBeforeCall(phoneNumberId, testPhoneNumberOptions, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
