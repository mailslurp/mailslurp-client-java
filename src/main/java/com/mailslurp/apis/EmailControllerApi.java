...
public class EmailControllerApi {
     ...
     */
    public okhttp3.Call getEmailsPaginatedCall(OffsetDateTime before, List<UUID> inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getEmailsPaginatedValidateBeforeCall(OffsetDateTime before, List<UUID> inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getEmailsPaginatedCall(before, inboxId, page, searchFilter, since, size, sort, unreadOnly, _callback);
        return localVarCall;
     ...
     */
    public PageEmailProjection getEmailsPaginated(OffsetDateTime before, List<UUID> inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly) throws ApiException {
        ApiResponse<PageEmailProjection> localVarResp = getEmailsPaginatedWithHttpInfo(before, inboxId, page, searchFilter, since, size, sort, unreadOnly);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageEmailProjection> getEmailsPaginatedWithHttpInfo(OffsetDateTime before, List<UUID> inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly) throws ApiException {
        okhttp3.Call localVarCall = getEmailsPaginatedValidateBeforeCall(before, inboxId, page, searchFilter, since, size, sort, unreadOnly, null);
     ...
     */
    public okhttp3.Call getEmailsPaginatedAsync(OffsetDateTime before, List<UUID> inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly, final ApiCallback<PageEmailProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getEmailsPaginatedValidateBeforeCall(before, inboxId, page, searchFilter, since, size, sort, unreadOnly, _callback);
        Type localVarReturnType = new TypeToken<PageEmailProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Get gravatar url for email address (asynchronously)
     * 
     * @param emailAddress emailAddress (required)
     * @param size size (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getOrganizationEmailsPaginatedCall(OffsetDateTime before, List<UUID> inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOrganizationEmailsPaginatedValidateBeforeCall(OffsetDateTime before, List<UUID> inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getOrganizationEmailsPaginatedCall(before, inboxId, page, searchFilter, since, size, sort, unreadOnly, _callback);
        return localVarCall;
     ...
     */
    public PageEmailProjection getOrganizationEmailsPaginated(OffsetDateTime before, List<UUID> inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly) throws ApiException {
        ApiResponse<PageEmailProjection> localVarResp = getOrganizationEmailsPaginatedWithHttpInfo(before, inboxId, page, searchFilter, since, size, sort, unreadOnly);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageEmailProjection> getOrganizationEmailsPaginatedWithHttpInfo(OffsetDateTime before, List<UUID> inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly) throws ApiException {
        okhttp3.Call localVarCall = getOrganizationEmailsPaginatedValidateBeforeCall(before, inboxId, page, searchFilter, since, size, sort, unreadOnly, null);
        Type localVarReturnType = new TypeToken<PageEmailProjection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getOrganizationEmailsPaginatedAsync(OffsetDateTime before, List<UUID> inboxId, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly, final ApiCallback<PageEmailProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOrganizationEmailsPaginatedValidateBeforeCall(before, inboxId, page, searchFilter, since, size, sort, unreadOnly, _callback);
        Type localVarReturnType = new TypeToken<PageEmailProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call sendEmailSourceOptionalCall(UUID inboxId, Boolean useDomainPool, SendEmailOptions sendEmailOptions, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call sendEmailSourceOptionalValidateBeforeCall(UUID inboxId, Boolean useDomainPool, SendEmailOptions sendEmailOptions, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = sendEmailSourceOptionalCall(inboxId, useDomainPool, sendEmailOptions, _callback);
        return localVarCall;
     ...
     */
    public void sendEmailSourceOptional(UUID inboxId, Boolean useDomainPool, SendEmailOptions sendEmailOptions) throws ApiException {
     ...
     */
    public ApiResponse<Void> sendEmailSourceOptionalWithHttpInfo(UUID inboxId, Boolean useDomainPool, SendEmailOptions sendEmailOptions) throws ApiException {
        okhttp3.Call localVarCall = sendEmailSourceOptionalValidateBeforeCall(inboxId, useDomainPool, sendEmailOptions, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call sendEmailSourceOptionalAsync(UUID inboxId, Boolean useDomainPool, SendEmailOptions sendEmailOptions, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = sendEmailSourceOptionalValidateBeforeCall(inboxId, useDomainPool, sendEmailOptions, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
