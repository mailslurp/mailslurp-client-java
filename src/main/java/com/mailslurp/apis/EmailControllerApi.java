...
public class EmailControllerApi {
     ...
     */
    public okhttp3.Call getEmailTextLinesCall(UUID emailId, Boolean decodeHtmlEntities, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getEmailTextLinesValidateBeforeCall(UUID emailId, Boolean decodeHtmlEntities, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getEmailTextLinesCall(emailId, decodeHtmlEntities, _callback);
        return localVarCall;
     ...
     */
    public EmailTextLinesResult getEmailTextLines(UUID emailId, Boolean decodeHtmlEntities) throws ApiException {
        ApiResponse<EmailTextLinesResult> localVarResp = getEmailTextLinesWithHttpInfo(emailId, decodeHtmlEntities);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<EmailTextLinesResult> getEmailTextLinesWithHttpInfo(UUID emailId, Boolean decodeHtmlEntities) throws ApiException {
        okhttp3.Call localVarCall = getEmailTextLinesValidateBeforeCall(emailId, decodeHtmlEntities, null);
        Type localVarReturnType = new TypeToken<EmailTextLinesResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getEmailTextLinesAsync(UUID emailId, Boolean decodeHtmlEntities, final ApiCallback<EmailTextLinesResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = getEmailTextLinesValidateBeforeCall(emailId, decodeHtmlEntities, _callback);
        Type localVarReturnType = new TypeToken<EmailTextLinesResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
