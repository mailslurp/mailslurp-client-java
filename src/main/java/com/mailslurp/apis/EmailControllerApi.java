...
public class EmailControllerApi {
     ...
     */
    public okhttp3.Call getEmailsPaginatedCall(List<UUID> inboxId, Integer page, String searchFilter, Integer size, String sort, Boolean unreadOnly, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getEmailsPaginatedValidateBeforeCall(List<UUID> inboxId, Integer page, String searchFilter, Integer size, String sort, Boolean unreadOnly, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getEmailsPaginatedCall(inboxId, page, searchFilter, size, sort, unreadOnly, _callback);
        return localVarCall;
     ...
     */
    public PageEmailProjection getEmailsPaginated(List<UUID> inboxId, Integer page, String searchFilter, Integer size, String sort, Boolean unreadOnly) throws ApiException {
        ApiResponse<PageEmailProjection> localVarResp = getEmailsPaginatedWithHttpInfo(inboxId, page, searchFilter, size, sort, unreadOnly);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageEmailProjection> getEmailsPaginatedWithHttpInfo(List<UUID> inboxId, Integer page, String searchFilter, Integer size, String sort, Boolean unreadOnly) throws ApiException {
        okhttp3.Call localVarCall = getEmailsPaginatedValidateBeforeCall(inboxId, page, searchFilter, size, sort, unreadOnly, null);
     ...
     */
    public okhttp3.Call getEmailsPaginatedAsync(List<UUID> inboxId, Integer page, String searchFilter, Integer size, String sort, Boolean unreadOnly, final ApiCallback<PageEmailProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getEmailsPaginatedValidateBeforeCall(inboxId, page, searchFilter, size, sort, unreadOnly, _callback);
        Type localVarReturnType = new TypeToken<PageEmailProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getOrganizationEmailsPaginatedCall(List<UUID> inboxId, Integer page, String searchFilter, Integer size, String sort, Boolean unreadOnly, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getOrganizationEmailsPaginatedValidateBeforeCall(List<UUID> inboxId, Integer page, String searchFilter, Integer size, String sort, Boolean unreadOnly, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getOrganizationEmailsPaginatedCall(inboxId, page, searchFilter, size, sort, unreadOnly, _callback);
        return localVarCall;
     ...
     */
    public PageEmailProjection getOrganizationEmailsPaginated(List<UUID> inboxId, Integer page, String searchFilter, Integer size, String sort, Boolean unreadOnly) throws ApiException {
        ApiResponse<PageEmailProjection> localVarResp = getOrganizationEmailsPaginatedWithHttpInfo(inboxId, page, searchFilter, size, sort, unreadOnly);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageEmailProjection> getOrganizationEmailsPaginatedWithHttpInfo(List<UUID> inboxId, Integer page, String searchFilter, Integer size, String sort, Boolean unreadOnly) throws ApiException {
        okhttp3.Call localVarCall = getOrganizationEmailsPaginatedValidateBeforeCall(inboxId, page, searchFilter, size, sort, unreadOnly, null);
        Type localVarReturnType = new TypeToken<PageEmailProjection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getOrganizationEmailsPaginatedAsync(List<UUID> inboxId, Integer page, String searchFilter, Integer size, String sort, Boolean unreadOnly, final ApiCallback<PageEmailProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOrganizationEmailsPaginatedValidateBeforeCall(inboxId, page, searchFilter, size, sort, unreadOnly, _callback);
        Type localVarReturnType = new TypeToken<PageEmailProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Mark an email as read (asynchronously)
     * Marks an email as read or unread. Pass boolean read flag to set value.
     * @param emailId emailId (required)
     * @param read What value to assign to email read property. Default true. (optional, default to true)
     * @param _callback The callback to be executed when the API call finishes
