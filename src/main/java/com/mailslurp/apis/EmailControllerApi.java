...
public class EmailControllerApi {
    ...
    public okhttp3.Call getEmailHTMLQueryCall(UUID emailId, String htmlSelector, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/emails/{emailId}/html-query"
            .replaceAll("\\{" + "emailId" + "\\}", localVarApiClient.escapeString(emailId.toString()))
            .replaceAll("\\{" + "htmlSelector" + "\\}", localVarApiClient.escapeString(htmlSelector.toString()));
     ...
     * @param decodeHtmlEntities Decode HTML entities (required)
     ...
     */
    public okhttp3.Call getEmailTextLinesCall(Boolean decodeHtmlEntities, UUID emailId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/emails/{emailId}/text"
            .replaceAll("\\{" + "decodeHtmlEntities" + "\\}", localVarApiClient.escapeString(decodeHtmlEntities.toString()))
            .replaceAll("\\{" + "emailId" + "\\}", localVarApiClient.escapeString(emailId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getEmailTextLinesValidateBeforeCall(Boolean decodeHtmlEntities, UUID emailId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'decodeHtmlEntities' is set
        if (decodeHtmlEntities == null) {
            throw new ApiException("Missing the required parameter 'decodeHtmlEntities' when calling getEmailTextLines(Async)");
        }
        ...
        okhttp3.Call localVarCall = getEmailTextLinesCall(decodeHtmlEntities, emailId, _callback);
        return localVarCall;
     ...
     */
    public EmailTextLinesResult getEmailTextLines(Boolean decodeHtmlEntities, UUID emailId) throws ApiException {
        ApiResponse<EmailTextLinesResult> localVarResp = getEmailTextLinesWithHttpInfo(decodeHtmlEntities, emailId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<EmailTextLinesResult> getEmailTextLinesWithHttpInfo(Boolean decodeHtmlEntities, UUID emailId) throws ApiException {
        okhttp3.Call localVarCall = getEmailTextLinesValidateBeforeCall(decodeHtmlEntities, emailId, null);
        Type localVarReturnType = new TypeToken<EmailTextLinesResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getEmailTextLinesAsync(Boolean decodeHtmlEntities, UUID emailId, final ApiCallback<EmailTextLinesResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = getEmailTextLinesValidateBeforeCall(decodeHtmlEntities, emailId, _callback);
        Type localVarReturnType = new TypeToken<EmailTextLinesResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
