...
public class EmailControllerApi {
     ...
     */
    public okhttp3.Call replyToEmail1Call(UUID emailId, ReplyToEmailOptions replyToEmailOptions, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replyToEmail1ValidateBeforeCall(UUID emailId, ReplyToEmailOptions replyToEmailOptions, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'emailId' is set
        if (emailId == null) {
            throw new ApiException("Missing the required parameter 'emailId' when calling replyToEmail1(Async)");
        }
        
        // verify the required parameter 'replyToEmailOptions' is set
        if (replyToEmailOptions == null) {
            throw new ApiException("Missing the required parameter 'replyToEmailOptions' when calling replyToEmail1(Async)");
        }
        

        okhttp3.Call localVarCall = replyToEmail1Call(emailId, replyToEmailOptions, _callback);
        return localVarCall;
     ...
     */
    public SentEmailDto replyToEmail1(UUID emailId, ReplyToEmailOptions replyToEmailOptions) throws ApiException {
        ApiResponse<SentEmailDto> localVarResp = replyToEmail1WithHttpInfo(emailId, replyToEmailOptions);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SentEmailDto> replyToEmail1WithHttpInfo(UUID emailId, ReplyToEmailOptions replyToEmailOptions) throws ApiException {
        okhttp3.Call localVarCall = replyToEmail1ValidateBeforeCall(emailId, replyToEmailOptions, null);
     ...
     */
    public okhttp3.Call replyToEmail1Async(UUID emailId, ReplyToEmailOptions replyToEmailOptions, final ApiCallback<SentEmailDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = replyToEmail1ValidateBeforeCall(emailId, replyToEmailOptions, _callback);
        Type localVarReturnType = new TypeToken<SentEmailDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
