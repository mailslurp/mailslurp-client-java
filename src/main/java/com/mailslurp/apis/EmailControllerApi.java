...
public class EmailControllerApi {
    ...
    private okhttp3.Call checkEmailAudit1Call(@javax.annotation.Nonnull UUID emailId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/emails/{emailId}/check-email-audit"
            .replace("{" + "emailId" + "}", localVarApiClient.escapeString(emailId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call checkEmailAudit1ValidateBeforeCall(@javax.annotation.Nonnull UUID emailId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'emailId' is set
        if (emailId == null) {
            throw new ApiException("Missing the required parameter 'emailId' when calling checkEmailAudit1(Async)");
        }

        return checkEmailAudit1Call(emailId, _callback);

    }


    private ApiResponse<EmailAuditAnalysisResult> checkEmailAudit1WithHttpInfo(@javax.annotation.Nonnull UUID emailId) throws ApiException {
        okhttp3.Call localVarCall = checkEmailAudit1ValidateBeforeCall(emailId, null);
        Type localVarReturnType = new TypeToken<EmailAuditAnalysisResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call checkEmailAudit1Async(@javax.annotation.Nonnull UUID emailId, final ApiCallback<EmailAuditAnalysisResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = checkEmailAudit1ValidateBeforeCall(emailId, _callback);
        Type localVarReturnType = new TypeToken<EmailAuditAnalysisResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIcheckEmailAudit1Request {
        @javax.annotation.Nonnull
        private final UUID emailId;

        private APIcheckEmailAudit1Request(@javax.annotation.Nonnull UUID emailId) {
            this.emailId = emailId;
        }

        /**
         * Build call for checkEmailAudit1
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute checkEmailAudit1 request
       ...
       <caption>Response Details</caption>
        ...
        public EmailAuditAnalysisResult execute() throws ApiException {
            ApiResponse<EmailAuditAnalysisResult> localVarResp = checkEmailAudit1WithHttpInfo(emailId);
            return localVarResp.getData();
        }

        /**
         * Execute checkEmailAudit1 request with HTTP info returned
       ...
       <caption>Response Details</caption>
        ...
        public ApiResponse<EmailAuditAnalysisResult> executeWithHttpInfo() throws ApiException {
            return checkEmailAudit1WithHttpInfo(emailId);
        }

        /**
         * Execute checkEmailAudit1 request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        public okhttp3.Call executeAsync(final ApiCallback<EmailAuditAnalysisResult> _callback) throws ApiException {
            return checkEmailAudit1Async(emailId, _callback);
        }
    }
     ...
     * @param emailId  (required)
     * @return APIcheckEmailAudit1Request
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIcheckEmailAudit1Request checkEmailAudit1(@javax.annotation.Nonnull UUID emailId) {
        return new APIcheckEmailAudit1Request(emailId);
    }
    ...
    private okhttp3.Call createEmailAuditForEmailCall(@javax.annotation.Nonnull UUID emailId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/emails/{emailId}/audit"
            .replace("{" + "emailId" + "}", localVarApiClient.escapeString(emailId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createEmailAuditForEmailValidateBeforeCall(@javax.annotation.Nonnull UUID emailId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'emailId' is set
        if (emailId == null) {
            throw new ApiException("Missing the required parameter 'emailId' when calling createEmailAuditForEmail(Async)");
        }

        return createEmailAuditForEmailCall(emailId, _callback);

    }


    private ApiResponse<EmailAuditDto> createEmailAuditForEmailWithHttpInfo(@javax.annotation.Nonnull UUID emailId) throws ApiException {
        okhttp3.Call localVarCall = createEmailAuditForEmailValidateBeforeCall(emailId, null);
        Type localVarReturnType = new TypeToken<EmailAuditDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createEmailAuditForEmailAsync(@javax.annotation.Nonnull UUID emailId, final ApiCallback<EmailAuditDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = createEmailAuditForEmailValidateBeforeCall(emailId, _callback);
        Type localVarReturnType = new TypeToken<EmailAuditDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIcreateEmailAuditForEmailRequest {
        @javax.annotation.Nonnull
        private final UUID emailId;

        private APIcreateEmailAuditForEmailRequest(@javax.annotation.Nonnull UUID emailId) {
            this.emailId = emailId;
        }

        /**
         * Build call for createEmailAuditForEmail
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute createEmailAuditForEmail request
       ...
       <caption>Response Details</caption>
        ...
        public EmailAuditDto execute() throws ApiException {
            ApiResponse<EmailAuditDto> localVarResp = createEmailAuditForEmailWithHttpInfo(emailId);
            return localVarResp.getData();
        }

        /**
         * Execute createEmailAuditForEmail request with HTTP info returned
       ...
       <caption>Response Details</caption>
        ...
        public ApiResponse<EmailAuditDto> executeWithHttpInfo() throws ApiException {
            return createEmailAuditForEmailWithHttpInfo(emailId);
        }

        /**
         * Execute createEmailAuditForEmail request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        public okhttp3.Call executeAsync(final ApiCallback<EmailAuditDto> _callback) throws ApiException {
            return createEmailAuditForEmailAsync(emailId, _callback);
        }
    }
     ...
     * @param emailId  (required)
     * @return APIcreateEmailAuditForEmailRequest
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIcreateEmailAuditForEmailRequest createEmailAuditForEmail(@javax.annotation.Nonnull UUID emailId) {
        return new APIcreateEmailAuditForEmailRequest(emailId);
    }
    ...
    private okhttp3.Call getEmailCodesCall(@javax.annotation.Nonnull UUID emailId, @javax.annotation.Nullable ExtractCodesOptions extractCodesOptions, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = extractCodesOptions;

        // create path and map variables
        String localVarPath = "/emails/{emailId}/codes"
            .replace("{" + "emailId" + "}", localVarApiClient.escapeString(emailId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getEmailCodesValidateBeforeCall(@javax.annotation.Nonnull UUID emailId, @javax.annotation.Nullable ExtractCodesOptions extractCodesOptions, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'emailId' is set
        if (emailId == null) {
            throw new ApiException("Missing the required parameter 'emailId' when calling getEmailCodes(Async)");
        }

        return getEmailCodesCall(emailId, extractCodesOptions, _callback);

    }


    private ApiResponse<ExtractCodesResult> getEmailCodesWithHttpInfo(@javax.annotation.Nonnull UUID emailId, @javax.annotation.Nullable ExtractCodesOptions extractCodesOptions) throws ApiException {
        okhttp3.Call localVarCall = getEmailCodesValidateBeforeCall(emailId, extractCodesOptions, null);
        Type localVarReturnType = new TypeToken<ExtractCodesResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getEmailCodesAsync(@javax.annotation.Nonnull UUID emailId, @javax.annotation.Nullable ExtractCodesOptions extractCodesOptions, final ApiCallback<ExtractCodesResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = getEmailCodesValidateBeforeCall(emailId, extractCodesOptions, _callback);
        Type localVarReturnType = new TypeToken<ExtractCodesResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIgetEmailCodesRequest {
        @javax.annotation.Nonnull
        private final UUID emailId;
        @javax.annotation.Nullable
        private ExtractCodesOptions extractCodesOptions;

        private APIgetEmailCodesRequest(@javax.annotation.Nonnull UUID emailId) {
            this.emailId = emailId;
        }

        /**
         * Set extractCodesOptions
         * @param extractCodesOptions  (optional)
         * @return APIgetEmailCodesRequest
         */
        public APIgetEmailCodesRequest extractCodesOptions(@javax.annotation.Nullable ExtractCodesOptions extractCodesOptions) {
            this.extractCodesOptions = extractCodesOptions;
            return this;
        }

        /**
         * Build call for getEmailCodes
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public ExtractCodesResult execute() throws ApiException {
            ApiResponse<ExtractCodesResult> localVarResp = getEmailCodesWithHttpInfo(emailId, extractCodesOptions);
            return localVarResp.getData();
        }

        /**
         * Execute getEmailCodes request with HTTP info returned
         * @return ApiResponse&lt;ExtractCodesResult&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<ExtractCodesResult> executeWithHttpInfo() throws ApiException {
            return getEmailCodesWithHttpInfo(emailId, extractCodesOptions);
        }

        /**
         * Execute getEmailCodes request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ExtractCodesResult> _callback) throws ApiException {
            return getEmailCodesAsync(emailId, extractCodesOptions, _callback);
        }
    }
     ...
     * @param emailId ID of email to extract codes from (required)
     * @return APIgetEmailCodesRequest
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public APIgetEmailCodesRequest getEmailCodes(@javax.annotation.Nonnull UUID emailId) {
        return new APIgetEmailCodesRequest(emailId);
    }
    ...
    private okhttp3.Call getEmailSignatureCall(@javax.annotation.Nonnull UUID emailId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/emails/{emailId}/signature"
            .replace("{" + "emailId" + "}", localVarApiClient.escapeString(emailId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getEmailSignatureValidateBeforeCall(@javax.annotation.Nonnull UUID emailId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'emailId' is set
        if (emailId == null) {
            throw new ApiException("Missing the required parameter 'emailId' when calling getEmailSignature(Async)");
        }

        return getEmailSignatureCall(emailId, _callback);

    }


    private ApiResponse<EmailSignatureParseResult> getEmailSignatureWithHttpInfo(@javax.annotation.Nonnull UUID emailId) throws ApiException {
        okhttp3.Call localVarCall = getEmailSignatureValidateBeforeCall(emailId, null);
        Type localVarReturnType = new TypeToken<EmailSignatureParseResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getEmailSignatureAsync(@javax.annotation.Nonnull UUID emailId, final ApiCallback<EmailSignatureParseResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = getEmailSignatureValidateBeforeCall(emailId, _callback);
        Type localVarReturnType = new TypeToken<EmailSignatureParseResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIgetEmailSignatureRequest {
        @javax.annotation.Nonnull
        private final UUID emailId;

        private APIgetEmailSignatureRequest(@javax.annotation.Nonnull UUID emailId) {
            this.emailId = emailId;
        }

        /**
         * Build call for getEmailSignature
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute getEmailSignature request
       ...
       <caption>Response Details</caption>
         ...
         */
        public EmailSignatureParseResult execute() throws ApiException {
            ApiResponse<EmailSignatureParseResult> localVarResp = getEmailSignatureWithHttpInfo(emailId);
            return localVarResp.getData();
        }

        /**
         * Execute getEmailSignature request with HTTP info returned
         * @return ApiResponse&lt;EmailSignatureParseResult&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<EmailSignatureParseResult> executeWithHttpInfo() throws ApiException {
            return getEmailSignatureWithHttpInfo(emailId);
        }

        /**
         * Execute getEmailSignature request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<EmailSignatureParseResult> _callback) throws ApiException {
            return getEmailSignatureAsync(emailId, _callback);
        }
    }
     ...
     * @param emailId ID of email to extract signature from (required)
     * @return APIgetEmailSignatureRequest
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIgetEmailSignatureRequest getEmailSignature(@javax.annotation.Nonnull UUID emailId) {
        return new APIgetEmailSignatureRequest(emailId);
    }
    ...
    private okhttp3.Call getEmailsOffsetPaginatedValidateBeforeCall(@javax.annotation.Nullable List<UUID> inboxId, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort, @javax.annotation.Nullable Boolean unreadOnly, @javax.annotation.Nullable String searchFilter, @javax.annotation.Nullable OffsetDateTime since, @javax.annotation.Nullable OffsetDateTime before, @javax.annotation.Nullable Boolean favourited, @javax.annotation.Nullable Boolean syncConnectors, @javax.annotation.Nullable UUID plusAddressId, @javax.annotation.Nullable List<UUID> include, final ApiCallback _callback) throws ApiException {
        return getEmailsOffsetPaginatedCall(inboxId, page, size, sort, unreadOnly, searchFilter, since, before, favourited, syncConnectors, plusAddressId, include, _callback);

    }


    private ApiResponse<PageEmailProjection> getEmailsOffsetPaginatedWithHttpInfo(@javax.annotation.Nullable List<UUID> inboxId, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort, @javax.annotation.Nullable Boolean unreadOnly, @javax.annotation.Nullable String searchFilter, @javax.annotation.Nullable OffsetDateTime since, @javax.annotation.Nullable OffsetDateTime before, @javax.annotation.Nullable Boolean favourited, @javax.annotation.Nullable Boolean syncConnectors, @javax.annotation.Nullable UUID plusAddressId, @javax.annotation.Nullable List<UUID> include) throws ApiException {
        okhttp3.Call localVarCall = getEmailsOffsetPaginatedValidateBeforeCall(inboxId, page, size, sort, unreadOnly, searchFilter, since, before, favourited, syncConnectors, plusAddressId, include, null);
        Type localVarReturnType = new TypeToken<PageEmailProjection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getEmailsOffsetPaginatedAsync(@javax.annotation.Nullable List<UUID> inboxId, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort, @javax.annotation.Nullable Boolean unreadOnly, @javax.annotation.Nullable String searchFilter, @javax.annotation.Nullable OffsetDateTime since, @javax.annotation.Nullable OffsetDateTime before, @javax.annotation.Nullable Boolean favourited, @javax.annotation.Nullable Boolean syncConnectors, @javax.annotation.Nullable UUID plusAddressId, @javax.annotation.Nullable List<UUID> include, final ApiCallback<PageEmailProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getEmailsOffsetPaginatedValidateBeforeCall(inboxId, page, size, sort, unreadOnly, searchFilter, since, before, favourited, syncConnectors, plusAddressId, include, _callback);
        Type localVarReturnType = new TypeToken<PageEmailProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIgetEmailsOffsetPaginatedRequest {
         ...
         * @return APIgetEmailsOffsetPaginatedRequest
         */
        public APIgetEmailsOffsetPaginatedRequest include(@javax.annotation.Nullable List<UUID> include) {
       ...
       <caption>Response Details</caption>
        ...
        public PageEmailProjection execute() throws ApiException {
            ApiResponse<PageEmailProjection> localVarResp = getEmailsOffsetPaginatedWithHttpInfo(inboxId, page, size, sort, unreadOnly, searchFilter, since, before, favourited, syncConnectors, plusAddressId, include);
            return localVarResp.getData();
        }
       ...
       <caption>Response Details</caption>
        ...
        public ApiResponse<PageEmailProjection> executeWithHttpInfo() throws ApiException {
            return getEmailsOffsetPaginatedWithHttpInfo(inboxId, page, size, sort, unreadOnly, searchFilter, since, before, favourited, syncConnectors, plusAddressId, include);
        }
       ...
       <caption>Response Details</caption>
        ...
        public okhttp3.Call executeAsync(final ApiCallback<PageEmailProjection> _callback) throws ApiException {
            return getEmailsOffsetPaginatedAsync(inboxId, page, size, sort, unreadOnly, searchFilter, since, before, favourited, syncConnectors, plusAddressId, include, _callback);
        }
    }
