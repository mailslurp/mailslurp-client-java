...
public class AliasControllerApi {
     ...
     */
    public okhttp3.Call replyToEmailCall(UUID aliasId, UUID emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replyToEmailValidateBeforeCall(UUID aliasId, UUID emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'aliasId' is set
        if (aliasId == null) {
            throw new ApiException("Missing the required parameter 'aliasId' when calling replyToEmail(Async)");
        }
        ...
        if (replyToAliasEmailOptions == null) {
            throw new ApiException("Missing the required parameter 'replyToAliasEmailOptions' when calling replyToEmail(Async)");
        }
        

        okhttp3.Call localVarCall = replyToEmailCall(aliasId, emailId, replyToAliasEmailOptions, _callback);
        return localVarCall;
     ...
     */
    public SentEmailDto replyToEmail(UUID aliasId, UUID emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions) throws ApiException {
        ApiResponse<SentEmailDto> localVarResp = replyToEmailWithHttpInfo(aliasId, emailId, replyToAliasEmailOptions);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SentEmailDto> replyToEmailWithHttpInfo(UUID aliasId, UUID emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions) throws ApiException {
        okhttp3.Call localVarCall = replyToEmailValidateBeforeCall(aliasId, emailId, replyToAliasEmailOptions, null);
     ...
     */
    public okhttp3.Call replyToEmailAsync(UUID aliasId, UUID emailId, ReplyToAliasEmailOptions replyToAliasEmailOptions, final ApiCallback<SentEmailDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = replyToEmailValidateBeforeCall(aliasId, emailId, replyToAliasEmailOptions, _callback);
        Type localVarReturnType = new TypeToken<SentEmailDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
