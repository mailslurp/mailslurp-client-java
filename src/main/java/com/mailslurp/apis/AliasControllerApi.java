...
public class AliasControllerApi {
     ...
     */
    public okhttp3.Call getAliasEmailsCall(UUID aliasId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAliasEmailsValidateBeforeCall(UUID aliasId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAliasEmailsCall(aliasId, before, page, since, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageEmailProjection getAliasEmails(UUID aliasId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        ApiResponse<PageEmailProjection> localVarResp = getAliasEmailsWithHttpInfo(aliasId, before, page, since, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageEmailProjection> getAliasEmailsWithHttpInfo(UUID aliasId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getAliasEmailsValidateBeforeCall(aliasId, before, page, since, size, sort, null);
     ...
     */
    public okhttp3.Call getAliasEmailsAsync(UUID aliasId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback<PageEmailProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAliasEmailsValidateBeforeCall(aliasId, before, page, since, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageEmailProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getAliasThreadsCall(UUID aliasId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAliasThreadsValidateBeforeCall(UUID aliasId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAliasThreadsCall(aliasId, before, page, since, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageThreadProjection getAliasThreads(UUID aliasId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        ApiResponse<PageThreadProjection> localVarResp = getAliasThreadsWithHttpInfo(aliasId, before, page, since, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageThreadProjection> getAliasThreadsWithHttpInfo(UUID aliasId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getAliasThreadsValidateBeforeCall(aliasId, before, page, since, size, sort, null);
     ...
     */
    public okhttp3.Call getAliasThreadsAsync(UUID aliasId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback<PageThreadProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAliasThreadsValidateBeforeCall(aliasId, before, page, since, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageThreadProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getAliasesCall(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAliasesValidateBeforeCall(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAliasesCall(before, page, since, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageAlias getAliases(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        ApiResponse<PageAlias> localVarResp = getAliasesWithHttpInfo(before, page, since, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageAlias> getAliasesWithHttpInfo(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getAliasesValidateBeforeCall(before, page, since, size, sort, null);
     ...
     */
    public okhttp3.Call getAliasesAsync(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback<PageAlias> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAliasesValidateBeforeCall(before, page, since, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageAlias>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
