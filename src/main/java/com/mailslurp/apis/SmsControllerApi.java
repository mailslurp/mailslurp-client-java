...
public class SmsControllerApi {
    ...
    public okhttp3.Call deleteSmsMessageCall(UUID smsId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/sms/{smsId}"
            .replaceAll("\\{" + "smsId" + "\\}", localVarApiClient.escapeString(smsId.toString()));
    ...
    private okhttp3.Call deleteSmsMessageValidateBeforeCall(UUID smsId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteSmsMessageCall(smsId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call deleteSmsMessagesValidateBeforeCall(UUID phoneNumberId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteSmsMessagesCall(phoneNumberId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getSmsMessageValidateBeforeCall(UUID smsId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getSmsMessageCall(smsId, _callback);
        return localVarCall;
     ...
     */
    public SmsMessage getSmsMessage(UUID smsId) throws ApiException {
        ApiResponse<SmsMessage> localVarResp = getSmsMessageWithHttpInfo(smsId);
     ...
     */
    public ApiResponse<SmsMessage> getSmsMessageWithHttpInfo(UUID smsId) throws ApiException {
        okhttp3.Call localVarCall = getSmsMessageValidateBeforeCall(smsId, null);
        Type localVarReturnType = new TypeToken<SmsMessage>(){}.getType();
     ...
     */
    public okhttp3.Call getSmsMessageAsync(UUID smsId, final ApiCallback<SmsMessage> _callback) throws ApiException {
    ...
    private okhttp3.Call getSmsMessagesPaginatedValidateBeforeCall(UUID phoneNumber, Integer page, Integer size, String sort, Boolean unreadOnly, OffsetDateTime since, OffsetDateTime before, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getSmsMessagesPaginatedCall(phoneNumber, page, size, sort, unreadOnly, since, before, _callback);
        return localVarCall;
