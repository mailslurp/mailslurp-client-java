...
public class SmsControllerApi {
    ...
    public class APIgetAllSmsMessagesRequest {
         ...
         * @return APIgetAllSmsMessagesRequest
         */
        public APIgetAllSmsMessagesRequest include(@javax.annotation.Nullable List<UUID> include) {
       ...
       <caption>Response Details</caption>
        ...
        public PageSmsProjection execute() throws ApiException {
            ApiResponse<PageSmsProjection> localVarResp = getAllSmsMessagesWithHttpInfo(phoneNumber, page, size, sort, since, before, search, favourite, include);
       ...
       <caption>Response Details</caption>
        ...
        public ApiResponse<PageSmsProjection> executeWithHttpInfo() throws ApiException {
            return getAllSmsMessagesWithHttpInfo(phoneNumber, page, size, sort, since, before, search, favourite, include);
        }
       ...
       <caption>Response Details</caption>
        ...
        public okhttp3.Call executeAsync(final ApiCallback<PageSmsProjection> _callback) throws ApiException {
            return getAllSmsMessagesAsync(phoneNumber, page, size, sort, since, before, search, favourite, include, _callback);
        }
    }
    ...
    private okhttp3.Call getSmsCodesCall(@javax.annotation.Nonnull UUID smsId, @javax.annotation.Nullable ExtractCodesOptions extractCodesOptions, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/sms/{smsId}/codes"
            .replace("{" + "smsId" + "}", localVarApiClient.escapeString(smsId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSmsCodesValidateBeforeCall(@javax.annotation.Nonnull UUID smsId, @javax.annotation.Nullable ExtractCodesOptions extractCodesOptions, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'smsId' is set
        if (smsId == null) {
            throw new ApiException("Missing the required parameter 'smsId' when calling getSmsCodes(Async)");
        }

        return getSmsCodesCall(smsId, extractCodesOptions, _callback);

    }


    private ApiResponse<ExtractCodesResult> getSmsCodesWithHttpInfo(@javax.annotation.Nonnull UUID smsId, @javax.annotation.Nullable ExtractCodesOptions extractCodesOptions) throws ApiException {
        okhttp3.Call localVarCall = getSmsCodesValidateBeforeCall(smsId, extractCodesOptions, null);
        Type localVarReturnType = new TypeToken<ExtractCodesResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSmsCodesAsync(@javax.annotation.Nonnull UUID smsId, @javax.annotation.Nullable ExtractCodesOptions extractCodesOptions, final ApiCallback<ExtractCodesResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = getSmsCodesValidateBeforeCall(smsId, extractCodesOptions, _callback);
        Type localVarReturnType = new TypeToken<ExtractCodesResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIgetSmsCodesRequest {
        @javax.annotation.Nonnull
        private final UUID smsId;
        @javax.annotation.Nullable
        private ExtractCodesOptions extractCodesOptions;

        private APIgetSmsCodesRequest(@javax.annotation.Nonnull UUID smsId) {
            this.smsId = smsId;
        }
         ...
         * @return APIgetSmsCodesRequest
         */
        public APIgetSmsCodesRequest extractCodesOptions(@javax.annotation.Nullable ExtractCodesOptions extractCodesOptions) {
            this.extractCodesOptions = extractCodesOptions;
            return this;
        }

        /**
         * Build call for getSmsCodes
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        public ExtractCodesResult execute() throws ApiException {
            ApiResponse<ExtractCodesResult> localVarResp = getSmsCodesWithHttpInfo(smsId, extractCodesOptions);
            return localVarResp.getData();
        }

        /**
         * Execute getSmsCodes request with HTTP info returned
       ...
       <caption>Response Details</caption>
        ...
        public ApiResponse<ExtractCodesResult> executeWithHttpInfo() throws ApiException {
            return getSmsCodesWithHttpInfo(smsId, extractCodesOptions);
        }

        /**
         * Execute getSmsCodes request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        public okhttp3.Call executeAsync(final ApiCallback<ExtractCodesResult> _callback) throws ApiException {
            return getSmsCodesAsync(smsId, extractCodesOptions, _callback);
        }
    }
     ...
     * @param smsId ID of SMS to extract codes from (required)
     * @return APIgetSmsCodesRequest
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public APIgetSmsCodesRequest getSmsCodes(@javax.annotation.Nonnull UUID smsId) {
        return new APIgetSmsCodesRequest(smsId);
    }
    ...
    private okhttp3.Call markAllSmsAsReadCall(@javax.annotation.Nullable Boolean read, @javax.annotation.Nullable UUID phoneNumberId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call markAllSmsAsReadValidateBeforeCall(@javax.annotation.Nullable Boolean read, @javax.annotation.Nullable UUID phoneNumberId, final ApiCallback _callback) throws ApiException {
        return markAllSmsAsReadCall(read, phoneNumberId, _callback);

    }


    private ApiResponse<Void> markAllSmsAsReadWithHttpInfo(@javax.annotation.Nullable Boolean read, @javax.annotation.Nullable UUID phoneNumberId) throws ApiException {
        okhttp3.Call localVarCall = markAllSmsAsReadValidateBeforeCall(read, phoneNumberId, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call markAllSmsAsReadAsync(@javax.annotation.Nullable Boolean read, @javax.annotation.Nullable UUID phoneNumberId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = markAllSmsAsReadValidateBeforeCall(read, phoneNumberId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }

    public class APImarkAllSmsAsReadRequest {
        @javax.annotation.Nullable
        private Boolean read;
        @javax.annotation.Nullable
        private UUID phoneNumberId;

        private APImarkAllSmsAsReadRequest() {
        }

        /**
         * Set read
         * @param read  (optional, default to true)
         * @return APImarkAllSmsAsReadRequest
         */
        public APImarkAllSmsAsReadRequest read(@javax.annotation.Nullable Boolean read) {
            this.read = read;
            return this;
        }
         ...
         * @return APImarkAllSmsAsReadRequest
         */
        public APImarkAllSmsAsReadRequest phoneNumberId(@javax.annotation.Nullable UUID phoneNumberId) {
            this.phoneNumberId = phoneNumberId;
            return this;
        }

        /**
         * Build call for markAllSmsAsRead
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute markAllSmsAsRead request
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public void execute() throws ApiException {
            markAllSmsAsReadWithHttpInfo(read, phoneNumberId);
        }

        /**
         * Execute markAllSmsAsRead request with HTTP info returned
         * @return ApiResponse&lt;Void&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            return markAllSmsAsReadWithHttpInfo(read, phoneNumberId);
        }

        /**
         * Execute markAllSmsAsRead request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            return markAllSmsAsReadAsync(read, phoneNumberId, _callback);
        }
    }
     ...
     */
    public APImarkAllSmsAsReadRequest markAllSmsAsRead() {
        return new APImarkAllSmsAsReadRequest();
    }
    private okhttp3.Call markSmsAsReadCall(@javax.annotation.Nonnull UUID smsId, @javax.annotation.Nullable Boolean read, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/sms/{smsId}/read"
            .replace("{" + "smsId" + "}", localVarApiClient.escapeString(smsId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call markSmsAsReadValidateBeforeCall(@javax.annotation.Nonnull UUID smsId, @javax.annotation.Nullable Boolean read, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'smsId' is set
        if (smsId == null) {
            throw new ApiException("Missing the required parameter 'smsId' when calling markSmsAsRead(Async)");
        }

        return markSmsAsReadCall(smsId, read, _callback);

    }


    private ApiResponse<SmsDto> markSmsAsReadWithHttpInfo(@javax.annotation.Nonnull UUID smsId, @javax.annotation.Nullable Boolean read) throws ApiException {
        okhttp3.Call localVarCall = markSmsAsReadValidateBeforeCall(smsId, read, null);
        Type localVarReturnType = new TypeToken<SmsDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call markSmsAsReadAsync(@javax.annotation.Nonnull UUID smsId, @javax.annotation.Nullable Boolean read, final ApiCallback<SmsDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = markSmsAsReadValidateBeforeCall(smsId, read, _callback);
        Type localVarReturnType = new TypeToken<SmsDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APImarkSmsAsReadRequest {
        @javax.annotation.Nonnull
        private final UUID smsId;
        @javax.annotation.Nullable
        private Boolean read;

        private APImarkSmsAsReadRequest(@javax.annotation.Nonnull UUID smsId) {
            this.smsId = smsId;
        }
         ...
         * Set read
         * @param read  (optional, default to true)
         * @return APImarkSmsAsReadRequest
         */
        public APImarkSmsAsReadRequest read(@javax.annotation.Nullable Boolean read) {
            this.read = read;
            return this;
        }

        /**
         * Build call for markSmsAsRead
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public SmsDto execute() throws ApiException {
            ApiResponse<SmsDto> localVarResp = markSmsAsReadWithHttpInfo(smsId, read);
            return localVarResp.getData();
        }

        /**
         * Execute markSmsAsRead request with HTTP info returned
         * @return ApiResponse&lt;SmsDto&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<SmsDto> executeWithHttpInfo() throws ApiException {
            return markSmsAsReadWithHttpInfo(smsId, read);
        }

        /**
         * Execute markSmsAsRead request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<SmsDto> _callback) throws ApiException {
            return markSmsAsReadAsync(smsId, read, _callback);
        }
    }
     ...
     */
    public APImarkSmsAsReadRequest markSmsAsRead(@javax.annotation.Nonnull UUID smsId) {
        return new APImarkSmsAsReadRequest(smsId);
    }
