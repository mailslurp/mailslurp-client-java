...
import com.mailslurp.models.ExtractAttachmentTextOptions;
import com.mailslurp.models.ExtractAttachmentTextResult;
import com.mailslurp.models.ImportEmailIntoInboxMultipartRequest;
...
public class AttachmentControllerApi {
    ...
    private okhttp3.Call extractAttachmentTextCall(@javax.annotation.Nonnull String attachmentId, @javax.annotation.Nullable ExtractAttachmentTextOptions extractAttachmentTextOptions, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = extractAttachmentTextOptions;

        // create path and map variables
        String localVarPath = "/attachments/{attachmentId}/text"
            .replace("{" + "attachmentId" + "}", localVarApiClient.escapeString(attachmentId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call extractAttachmentTextValidateBeforeCall(@javax.annotation.Nonnull String attachmentId, @javax.annotation.Nullable ExtractAttachmentTextOptions extractAttachmentTextOptions, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'attachmentId' is set
        if (attachmentId == null) {
            throw new ApiException("Missing the required parameter 'attachmentId' when calling extractAttachmentText(Async)");
        }

        return extractAttachmentTextCall(attachmentId, extractAttachmentTextOptions, _callback);

    }


    private ApiResponse<ExtractAttachmentTextResult> extractAttachmentTextWithHttpInfo(@javax.annotation.Nonnull String attachmentId, @javax.annotation.Nullable ExtractAttachmentTextOptions extractAttachmentTextOptions) throws ApiException {
        okhttp3.Call localVarCall = extractAttachmentTextValidateBeforeCall(attachmentId, extractAttachmentTextOptions, null);
        Type localVarReturnType = new TypeToken<ExtractAttachmentTextResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call extractAttachmentTextAsync(@javax.annotation.Nonnull String attachmentId, @javax.annotation.Nullable ExtractAttachmentTextOptions extractAttachmentTextOptions, final ApiCallback<ExtractAttachmentTextResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = extractAttachmentTextValidateBeforeCall(attachmentId, extractAttachmentTextOptions, _callback);
        Type localVarReturnType = new TypeToken<ExtractAttachmentTextResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIextractAttachmentTextRequest {
        @javax.annotation.Nonnull
        private final String attachmentId;
        @javax.annotation.Nullable
        private ExtractAttachmentTextOptions extractAttachmentTextOptions;

        private APIextractAttachmentTextRequest(@javax.annotation.Nonnull String attachmentId) {
            this.attachmentId = attachmentId;
        }

        /**
         * Set extractAttachmentTextOptions
         * @param extractAttachmentTextOptions  (optional)
         * @return APIextractAttachmentTextRequest
         */
        public APIextractAttachmentTextRequest extractAttachmentTextOptions(@javax.annotation.Nullable ExtractAttachmentTextOptions extractAttachmentTextOptions) {
            this.extractAttachmentTextOptions = extractAttachmentTextOptions;
            return this;
        }

        /**
         * Build call for extractAttachmentText
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute extractAttachmentText request
       ...
       <caption>Response Details</caption>
         ...
         */
        public ExtractAttachmentTextResult execute() throws ApiException {
            ApiResponse<ExtractAttachmentTextResult> localVarResp = extractAttachmentTextWithHttpInfo(attachmentId, extractAttachmentTextOptions);
            return localVarResp.getData();
        }

        /**
         * Execute extractAttachmentText request with HTTP info returned
         * @return ApiResponse&lt;ExtractAttachmentTextResult&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<ExtractAttachmentTextResult> executeWithHttpInfo() throws ApiException {
            return extractAttachmentTextWithHttpInfo(attachmentId, extractAttachmentTextOptions);
        }

        /**
         * Execute extractAttachmentText request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ExtractAttachmentTextResult> _callback) throws ApiException {
            return extractAttachmentTextAsync(attachmentId, extractAttachmentTextOptions, _callback);
        }
    }
     ...
     */
    public APIextractAttachmentTextRequest extractAttachmentText(@javax.annotation.Nonnull String attachmentId) {
        return new APIextractAttachmentTextRequest(attachmentId);
    }
    ...
    private okhttp3.Call uploadMultipartFormCall(@javax.annotation.Nullable String contentId, @javax.annotation.Nullable String contentType, @javax.annotation.Nullable String filename, @javax.annotation.Nullable String contentTypeHeader, @javax.annotation.Nullable String xFilename, @javax.annotation.Nullable String xFilenameRaw, @javax.annotation.Nullable Long xFilesize, @javax.annotation.Nullable ImportEmailIntoInboxMultipartRequest importEmailIntoInboxMultipartRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = importEmailIntoInboxMultipartRequest;
    ...
    private okhttp3.Call uploadMultipartFormValidateBeforeCall(@javax.annotation.Nullable String contentId, @javax.annotation.Nullable String contentType, @javax.annotation.Nullable String filename, @javax.annotation.Nullable String contentTypeHeader, @javax.annotation.Nullable String xFilename, @javax.annotation.Nullable String xFilenameRaw, @javax.annotation.Nullable Long xFilesize, @javax.annotation.Nullable ImportEmailIntoInboxMultipartRequest importEmailIntoInboxMultipartRequest, final ApiCallback _callback) throws ApiException {
        return uploadMultipartFormCall(contentId, contentType, filename, contentTypeHeader, xFilename, xFilenameRaw, xFilesize, importEmailIntoInboxMultipartRequest, _callback);

    }


    private ApiResponse<List<String>> uploadMultipartFormWithHttpInfo(@javax.annotation.Nullable String contentId, @javax.annotation.Nullable String contentType, @javax.annotation.Nullable String filename, @javax.annotation.Nullable String contentTypeHeader, @javax.annotation.Nullable String xFilename, @javax.annotation.Nullable String xFilenameRaw, @javax.annotation.Nullable Long xFilesize, @javax.annotation.Nullable ImportEmailIntoInboxMultipartRequest importEmailIntoInboxMultipartRequest) throws ApiException {
        okhttp3.Call localVarCall = uploadMultipartFormValidateBeforeCall(contentId, contentType, filename, contentTypeHeader, xFilename, xFilenameRaw, xFilesize, importEmailIntoInboxMultipartRequest, null);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call uploadMultipartFormAsync(@javax.annotation.Nullable String contentId, @javax.annotation.Nullable String contentType, @javax.annotation.Nullable String filename, @javax.annotation.Nullable String contentTypeHeader, @javax.annotation.Nullable String xFilename, @javax.annotation.Nullable String xFilenameRaw, @javax.annotation.Nullable Long xFilesize, @javax.annotation.Nullable ImportEmailIntoInboxMultipartRequest importEmailIntoInboxMultipartRequest, final ApiCallback<List<String>> _callback) throws ApiException {

        okhttp3.Call localVarCall = uploadMultipartFormValidateBeforeCall(contentId, contentType, filename, contentTypeHeader, xFilename, xFilenameRaw, xFilesize, importEmailIntoInboxMultipartRequest, _callback);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIuploadMultipartFormRequest {
        ...
        @javax.annotation.Nullable
        private ImportEmailIntoInboxMultipartRequest importEmailIntoInboxMultipartRequest;
        ...
        /**
         * Set importEmailIntoInboxMultipartRequest
         * @param importEmailIntoInboxMultipartRequest  (optional)
         * @return APIuploadMultipartFormRequest
         */
        public APIuploadMultipartFormRequest importEmailIntoInboxMultipartRequest(@javax.annotation.Nullable ImportEmailIntoInboxMultipartRequest importEmailIntoInboxMultipartRequest) {
            this.importEmailIntoInboxMultipartRequest = importEmailIntoInboxMultipartRequest;
            return this;
        }
       ...
       <caption>Response Details</caption>
         ...
         */
        public List<String> execute() throws ApiException {
            ApiResponse<List<String>> localVarResp = uploadMultipartFormWithHttpInfo(contentId, contentType, filename, contentTypeHeader, xFilename, xFilenameRaw, xFilesize, importEmailIntoInboxMultipartRequest);
            return localVarResp.getData();
        }
       ...
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<List<String>> executeWithHttpInfo() throws ApiException {
            return uploadMultipartFormWithHttpInfo(contentId, contentType, filename, contentTypeHeader, xFilename, xFilenameRaw, xFilesize, importEmailIntoInboxMultipartRequest);
        }
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<List<String>> _callback) throws ApiException {
            return uploadMultipartFormAsync(contentId, contentType, filename, contentTypeHeader, xFilename, xFilenameRaw, xFilesize, importEmailIntoInboxMultipartRequest, _callback);
        }
    }
