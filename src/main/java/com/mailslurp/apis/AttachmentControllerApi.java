...
public class AttachmentControllerApi {
    ...
    /**
     * Upload an attachment for sending using base64 file encoding (asynchronously)
     * When sending emails with attachments first upload each attachment with this endpoint. Record the returned attachment IDs. Then use these attachment IDs in the SendEmailOptions when sending an email. This means that attachments can easily be reused.
     * @param uploadOptions uploadOptions (required)
     ...
     */
    public okhttp3.Call uploadAttachmentBytesCall(String filename, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = filename;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call uploadAttachmentBytesValidateBeforeCall(String filename, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = uploadAttachmentBytesCall(filename, _callback);
        return localVarCall;
     ...
     */
    public List<String> uploadAttachmentBytes(String filename) throws ApiException {
        ApiResponse<List<String>> localVarResp = uploadAttachmentBytesWithHttpInfo(filename);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<String>> uploadAttachmentBytesWithHttpInfo(String filename) throws ApiException {
        okhttp3.Call localVarCall = uploadAttachmentBytesValidateBeforeCall(filename, null);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Upload an attachment for sending using file byte stream input octet stream (asynchronously)
     * When sending emails with attachments first upload each attachment with this endpoint. Record the returned attachment IDs. Then use these attachment IDs in the SendEmailOptions when sending an email. This means that attachments can easily be reused.
     * @param filename Optional filename to save upload with (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call uploadAttachmentBytesAsync(String filename, final ApiCallback<List<String>> _callback) throws ApiException {

        okhttp3.Call localVarCall = uploadAttachmentBytesValidateBeforeCall(filename, _callback);
        Type localVarReturnType = new TypeToken<List<String>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
