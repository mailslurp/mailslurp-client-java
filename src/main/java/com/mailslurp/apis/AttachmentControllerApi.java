...
public class AttachmentControllerApi {
     ...
     */
    public okhttp3.Call getAttachmentsCall(String fileNameFilter, Integer page, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAttachmentsValidateBeforeCall(String fileNameFilter, Integer page, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAttachmentsCall(fileNameFilter, page, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageAttachmentEntity getAttachments(String fileNameFilter, Integer page, Integer size, String sort) throws ApiException {
        ApiResponse<PageAttachmentEntity> localVarResp = getAttachmentsWithHttpInfo(fileNameFilter, page, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageAttachmentEntity> getAttachmentsWithHttpInfo(String fileNameFilter, Integer page, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getAttachmentsValidateBeforeCall(fileNameFilter, page, size, sort, null);
     ...
     */
    public okhttp3.Call getAttachmentsAsync(String fileNameFilter, Integer page, Integer size, String sort, final ApiCallback<PageAttachmentEntity> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAttachmentsValidateBeforeCall(fileNameFilter, page, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageAttachmentEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
