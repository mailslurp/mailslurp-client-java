...
public class AttachmentControllerApi {
     ...
     */
    public okhttp3.Call getAttachmentsCall(Integer page, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAttachmentsValidateBeforeCall(Integer page, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAttachmentsCall(page, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageAttachmentEntity getAttachments(Integer page, Integer size, String sort) throws ApiException {
        ApiResponse<PageAttachmentEntity> localVarResp = getAttachmentsWithHttpInfo(page, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageAttachmentEntity> getAttachmentsWithHttpInfo(Integer page, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getAttachmentsValidateBeforeCall(page, size, sort, null);
     ...
     */
    public okhttp3.Call getAttachmentsAsync(Integer page, Integer size, String sort, final ApiCallback<PageAttachmentEntity> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAttachmentsValidateBeforeCall(page, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageAttachmentEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
