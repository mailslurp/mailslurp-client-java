...
public class AttachmentControllerApi {
     ...
     */
    public List<byte[]> downloadAttachmentAsBytes(String attachmentId) throws ApiException {
        ApiResponse<List<byte[]>> localVarResp = downloadAttachmentAsBytesWithHttpInfo(attachmentId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<byte[]>> downloadAttachmentAsBytesWithHttpInfo(String attachmentId) throws ApiException {
     ...
     */
    public okhttp3.Call downloadAttachmentAsBytesAsync(String attachmentId, final ApiCallback<List<byte[]>> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getAttachments1Call(Integer page, Integer size, String sort, String fileNameFilter, OffsetDateTime since, OffsetDateTime before, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAttachments1ValidateBeforeCall(Integer page, Integer size, String sort, String fileNameFilter, OffsetDateTime since, OffsetDateTime before, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAttachments1Call(page, size, sort, fileNameFilter, since, before, _callback);
        return localVarCall;
     ...
     */
    public PageAttachmentEntity getAttachments1(Integer page, Integer size, String sort, String fileNameFilter, OffsetDateTime since, OffsetDateTime before) throws ApiException {
        ApiResponse<PageAttachmentEntity> localVarResp = getAttachments1WithHttpInfo(page, size, sort, fileNameFilter, since, before);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageAttachmentEntity> getAttachments1WithHttpInfo(Integer page, Integer size, String sort, String fileNameFilter, OffsetDateTime since, OffsetDateTime before) throws ApiException {
        okhttp3.Call localVarCall = getAttachments1ValidateBeforeCall(page, size, sort, fileNameFilter, since, before, null);
     ...
     */
    public okhttp3.Call getAttachments1Async(Integer page, Integer size, String sort, String fileNameFilter, OffsetDateTime since, OffsetDateTime before, final ApiCallback<PageAttachmentEntity> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAttachments1ValidateBeforeCall(page, size, sort, fileNameFilter, since, before, _callback);
        Type localVarReturnType = new TypeToken<PageAttachmentEntity>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
