...
public class TrackingControllerApi {
     ...
     */
    public okhttp3.Call getAllTrackingPixelsCall(Integer page, Integer size, String sort, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllTrackingPixelsValidateBeforeCall(Integer page, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAllTrackingPixelsCall(page, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageTrackingPixelProjection getAllTrackingPixels(Integer page, Integer size, String sort) throws ApiException {
        ApiResponse<PageTrackingPixelProjection> localVarResp = getAllTrackingPixelsWithHttpInfo(page, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageTrackingPixelProjection> getAllTrackingPixelsWithHttpInfo(Integer page, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getAllTrackingPixelsValidateBeforeCall(page, size, sort, null);
     ...
     */
    public okhttp3.Call getAllTrackingPixelsAsync(Integer page, Integer size, String sort, final ApiCallback<PageTrackingPixelProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllTrackingPixelsValidateBeforeCall(page, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageTrackingPixelProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
