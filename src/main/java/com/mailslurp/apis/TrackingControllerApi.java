...
public class TrackingControllerApi {
     ...
     */
    public okhttp3.Call getAllTrackingPixelsCall(Integer page, String searchFilter, Integer size, String sort, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllTrackingPixelsValidateBeforeCall(Integer page, String searchFilter, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAllTrackingPixelsCall(page, searchFilter, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageTrackingPixelProjection getAllTrackingPixels(Integer page, String searchFilter, Integer size, String sort) throws ApiException {
        ApiResponse<PageTrackingPixelProjection> localVarResp = getAllTrackingPixelsWithHttpInfo(page, searchFilter, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageTrackingPixelProjection> getAllTrackingPixelsWithHttpInfo(Integer page, String searchFilter, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getAllTrackingPixelsValidateBeforeCall(page, searchFilter, size, sort, null);
     ...
     */
    public okhttp3.Call getAllTrackingPixelsAsync(Integer page, String searchFilter, Integer size, String sort, final ApiCallback<PageTrackingPixelProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllTrackingPixelsValidateBeforeCall(page, searchFilter, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageTrackingPixelProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
