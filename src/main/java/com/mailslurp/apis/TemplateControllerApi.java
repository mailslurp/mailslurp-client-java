...
public class TemplateControllerApi {
     ...
     */
    public okhttp3.Call getAllTemplatesCall(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllTemplatesValidateBeforeCall(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAllTemplatesCall(before, page, since, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageTemplateProjection getAllTemplates(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        ApiResponse<PageTemplateProjection> localVarResp = getAllTemplatesWithHttpInfo(before, page, since, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageTemplateProjection> getAllTemplatesWithHttpInfo(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getAllTemplatesValidateBeforeCall(before, page, since, size, sort, null);
     ...
     */
    public okhttp3.Call getAllTemplatesAsync(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback<PageTemplateProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllTemplatesValidateBeforeCall(before, page, since, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageTemplateProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
