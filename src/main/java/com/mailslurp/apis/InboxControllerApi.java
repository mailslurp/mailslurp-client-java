...
public class InboxControllerApi {
     ...
     */
    public okhttp3.Call createInboxCall(String description, String emailAddress, OffsetDateTime expiresAt, Boolean favourite, String name, List<String> tags, Boolean useDomainPool, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createInboxValidateBeforeCall(String description, String emailAddress, OffsetDateTime expiresAt, Boolean favourite, String name, List<String> tags, Boolean useDomainPool, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = createInboxCall(description, emailAddress, expiresAt, favourite, name, tags, useDomainPool, _callback);
        return localVarCall;
     ...
     */
    public Inbox createInbox(String description, String emailAddress, OffsetDateTime expiresAt, Boolean favourite, String name, List<String> tags, Boolean useDomainPool) throws ApiException {
        ApiResponse<Inbox> localVarResp = createInboxWithHttpInfo(description, emailAddress, expiresAt, favourite, name, tags, useDomainPool);
     ...
     */
    public ApiResponse<Inbox> createInboxWithHttpInfo(String description, String emailAddress, OffsetDateTime expiresAt, Boolean favourite, String name, List<String> tags, Boolean useDomainPool) throws ApiException {
        okhttp3.Call localVarCall = createInboxValidateBeforeCall(description, emailAddress, expiresAt, favourite, name, tags, useDomainPool, null);
     ...
     */
    public okhttp3.Call createInboxAsync(String description, String emailAddress, OffsetDateTime expiresAt, Boolean favourite, String name, List<String> tags, Boolean useDomainPool, final ApiCallback<Inbox> _callback) throws ApiException {

        okhttp3.Call localVarCall = createInboxValidateBeforeCall(description, emailAddress, expiresAt, favourite, name, tags, useDomainPool, _callback);
        Type localVarReturnType = new TypeToken<Inbox>(){}.getType();
