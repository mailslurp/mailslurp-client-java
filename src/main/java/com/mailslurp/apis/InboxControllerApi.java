...
public class InboxControllerApi {
     ...
     */
    public okhttp3.Call getEmailsCall(UUID inboxId, Long delayTimeout, Integer limit, Long minCount, Long retryTimeout, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getEmailsValidateBeforeCall(UUID inboxId, Long delayTimeout, Integer limit, Long minCount, Long retryTimeout, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getEmailsCall(inboxId, delayTimeout, limit, minCount, retryTimeout, since, size, sort, unreadOnly, _callback);
        return localVarCall;
     ...
     */
    public List<EmailPreview> getEmails(UUID inboxId, Long delayTimeout, Integer limit, Long minCount, Long retryTimeout, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly) throws ApiException {
        ApiResponse<List<EmailPreview>> localVarResp = getEmailsWithHttpInfo(inboxId, delayTimeout, limit, minCount, retryTimeout, since, size, sort, unreadOnly);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<EmailPreview>> getEmailsWithHttpInfo(UUID inboxId, Long delayTimeout, Integer limit, Long minCount, Long retryTimeout, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly) throws ApiException {
        okhttp3.Call localVarCall = getEmailsValidateBeforeCall(inboxId, delayTimeout, limit, minCount, retryTimeout, since, size, sort, unreadOnly, null);
     ...
     */
    public okhttp3.Call getEmailsAsync(UUID inboxId, Long delayTimeout, Integer limit, Long minCount, Long retryTimeout, OffsetDateTime since, Integer size, String sort, Boolean unreadOnly, final ApiCallback<List<EmailPreview>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getEmailsValidateBeforeCall(inboxId, delayTimeout, limit, minCount, retryTimeout, since, size, sort, unreadOnly, _callback);
        Type localVarReturnType = new TypeToken<List<EmailPreview>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
