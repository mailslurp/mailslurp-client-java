...
import com.mailslurp.models.AITransformMappingMatchResult;
...
import com.mailslurp.models.ExportTransformerOptions;
import com.mailslurp.models.ExportTransformerResponse;
import com.mailslurp.models.ExportTransformerResultJobDto;
...
import com.mailslurp.models.PageTableData;
...
public class AiControllerApi {
    ...
    private okhttp3.Call exportTransformerResultsCall(@javax.annotation.Nonnull ExportTransformerOptions exportTransformerOptions, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = exportTransformerOptions;

        // create path and map variables
        String localVarPath = "/ai/transformer/results/export";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call exportTransformerResultsValidateBeforeCall(@javax.annotation.Nonnull ExportTransformerOptions exportTransformerOptions, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'exportTransformerOptions' is set
        if (exportTransformerOptions == null) {
            throw new ApiException("Missing the required parameter 'exportTransformerOptions' when calling exportTransformerResults(Async)");
        }

        return exportTransformerResultsCall(exportTransformerOptions, _callback);

    }


    private ApiResponse<ExportTransformerResponse> exportTransformerResultsWithHttpInfo(@javax.annotation.Nonnull ExportTransformerOptions exportTransformerOptions) throws ApiException {
        okhttp3.Call localVarCall = exportTransformerResultsValidateBeforeCall(exportTransformerOptions, null);
        Type localVarReturnType = new TypeToken<ExportTransformerResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call exportTransformerResultsAsync(@javax.annotation.Nonnull ExportTransformerOptions exportTransformerOptions, final ApiCallback<ExportTransformerResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = exportTransformerResultsValidateBeforeCall(exportTransformerOptions, _callback);
        Type localVarReturnType = new TypeToken<ExportTransformerResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIexportTransformerResultsRequest {
        @javax.annotation.Nonnull
        private final ExportTransformerOptions exportTransformerOptions;

        private APIexportTransformerResultsRequest(@javax.annotation.Nonnull ExportTransformerOptions exportTransformerOptions) {
            this.exportTransformerOptions = exportTransformerOptions;
        }

        /**
         * Build call for exportTransformerResults
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute exportTransformerResults request
       ...
       <caption>Response Details</caption>
         ...
         */
        public ExportTransformerResponse execute() throws ApiException {
            ApiResponse<ExportTransformerResponse> localVarResp = exportTransformerResultsWithHttpInfo(exportTransformerOptions);
            return localVarResp.getData();
        }

        /**
         * Execute exportTransformerResults request with HTTP info returned
         * @return ApiResponse&lt;ExportTransformerResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<ExportTransformerResponse> executeWithHttpInfo() throws ApiException {
            return exportTransformerResultsWithHttpInfo(exportTransformerOptions);
        }

        /**
         * Execute exportTransformerResults request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ExportTransformerResponse> _callback) throws ApiException {
            return exportTransformerResultsAsync(exportTransformerOptions, _callback);
        }
    }
     ...
     * @param exportTransformerOptions  (required)
     * @return APIexportTransformerResultsRequest
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIexportTransformerResultsRequest exportTransformerResults(@javax.annotation.Nonnull ExportTransformerOptions exportTransformerOptions) {
        return new APIexportTransformerResultsRequest(exportTransformerOptions);
    }
    ...
    private okhttp3.Call getExportTransformerResultsJobCall(@javax.annotation.Nonnull UUID id, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/ai/transformer/results/export/{id}"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getExportTransformerResultsJobValidateBeforeCall(@javax.annotation.Nonnull UUID id, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getExportTransformerResultsJob(Async)");
        }

        return getExportTransformerResultsJobCall(id, _callback);

    }


    private ApiResponse<ExportTransformerResultJobDto> getExportTransformerResultsJobWithHttpInfo(@javax.annotation.Nonnull UUID id) throws ApiException {
        okhttp3.Call localVarCall = getExportTransformerResultsJobValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<ExportTransformerResultJobDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getExportTransformerResultsJobAsync(@javax.annotation.Nonnull UUID id, final ApiCallback<ExportTransformerResultJobDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = getExportTransformerResultsJobValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<ExportTransformerResultJobDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIgetExportTransformerResultsJobRequest {
        @javax.annotation.Nonnull
        private final UUID id;

        private APIgetExportTransformerResultsJobRequest(@javax.annotation.Nonnull UUID id) {
            this.id = id;
        }

        /**
         * Build call for getExportTransformerResultsJob
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute getExportTransformerResultsJob request
       ...
       <caption>Response Details</caption>
         ...
         */
        public ExportTransformerResultJobDto execute() throws ApiException {
            ApiResponse<ExportTransformerResultJobDto> localVarResp = getExportTransformerResultsJobWithHttpInfo(id);
            return localVarResp.getData();
        }

        /**
         * Execute getExportTransformerResultsJob request with HTTP info returned
         * @return ApiResponse&lt;ExportTransformerResultJobDto&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<ExportTransformerResultJobDto> executeWithHttpInfo() throws ApiException {
            return getExportTransformerResultsJobWithHttpInfo(id);
        }

        /**
         * Execute getExportTransformerResultsJob request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<ExportTransformerResultJobDto> _callback) throws ApiException {
            return getExportTransformerResultsJobAsync(id, _callback);
        }
    }
     ...
     * @param id  (required)
     * @return APIgetExportTransformerResultsJobRequest
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIgetExportTransformerResultsJobRequest getExportTransformerResultsJob(@javax.annotation.Nonnull UUID id) {
        return new APIgetExportTransformerResultsJobRequest(id);
    }
    ...
    private okhttp3.Call getTransformerResultsCall(@javax.annotation.Nullable UUID emailId, @javax.annotation.Nullable UUID smsId, @javax.annotation.Nullable String attachmentId, @javax.annotation.Nullable UUID aiTransformId, @javax.annotation.Nullable UUID aiTransformMappingId, @javax.annotation.Nullable UUID entityId, @javax.annotation.Nullable String entityType, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTransformerResultsValidateBeforeCall(@javax.annotation.Nullable UUID emailId, @javax.annotation.Nullable UUID smsId, @javax.annotation.Nullable String attachmentId, @javax.annotation.Nullable UUID aiTransformId, @javax.annotation.Nullable UUID aiTransformMappingId, @javax.annotation.Nullable UUID entityId, @javax.annotation.Nullable String entityType, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort, final ApiCallback _callback) throws ApiException {
        return getTransformerResultsCall(emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort, _callback);

    }


    private ApiResponse<PageAITransformResultProjection> getTransformerResultsWithHttpInfo(@javax.annotation.Nullable UUID emailId, @javax.annotation.Nullable UUID smsId, @javax.annotation.Nullable String attachmentId, @javax.annotation.Nullable UUID aiTransformId, @javax.annotation.Nullable UUID aiTransformMappingId, @javax.annotation.Nullable UUID entityId, @javax.annotation.Nullable String entityType, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort) throws ApiException {
        okhttp3.Call localVarCall = getTransformerResultsValidateBeforeCall(emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort, null);
        Type localVarReturnType = new TypeToken<PageAITransformResultProjection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getTransformerResultsAsync(@javax.annotation.Nullable UUID emailId, @javax.annotation.Nullable UUID smsId, @javax.annotation.Nullable String attachmentId, @javax.annotation.Nullable UUID aiTransformId, @javax.annotation.Nullable UUID aiTransformMappingId, @javax.annotation.Nullable UUID entityId, @javax.annotation.Nullable String entityType, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort, final ApiCallback<PageAITransformResultProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTransformerResultsValidateBeforeCall(emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageAITransformResultProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIgetTransformerResultsRequest {
         ...
         */
        public APIgetTransformerResultsRequest emailId(@javax.annotation.Nullable UUID emailId) {
        ...
        /**
         * Set smsId
         * @param smsId  (optional)
         * @return APIgetTransformerResultsRequest
         */
        public APIgetTransformerResultsRequest smsId(@javax.annotation.Nullable UUID smsId) {
            this.smsId = smsId;
            return this;
        }
         ...
         * @return APIgetTransformerResultsRequest
         */
        public APIgetTransformerResultsRequest attachmentId(@javax.annotation.Nullable String attachmentId) {
       ...
       <caption>Response Details</caption>
        ...
        public PageAITransformResultProjection execute() throws ApiException {
            ApiResponse<PageAITransformResultProjection> localVarResp = getTransformerResultsWithHttpInfo(emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort);
            return localVarResp.getData();
        }
       ...
       <caption>Response Details</caption>
        ...
        public ApiResponse<PageAITransformResultProjection> executeWithHttpInfo() throws ApiException {
            return getTransformerResultsWithHttpInfo(emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort);
        }
       ...
       <caption>Response Details</caption>
        ...
        public okhttp3.Call executeAsync(final ApiCallback<PageAITransformResultProjection> _callback) throws ApiException {
            return getTransformerResultsAsync(emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort, _callback);
        }
    }
    ...
    private okhttp3.Call getTransformerResultsTableCall(@javax.annotation.Nonnull Boolean includeMetaData, @javax.annotation.Nonnull Boolean flattenArraysToRows, @javax.annotation.Nullable UUID emailId, @javax.annotation.Nullable UUID smsId, @javax.annotation.Nullable String attachmentId, @javax.annotation.Nullable UUID aiTransformId, @javax.annotation.Nullable UUID aiTransformMappingId, @javax.annotation.Nullable UUID entityId, @javax.annotation.Nullable String entityType, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/ai/transformer/results/table";
        ...
        if (flattenArraysToRows != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("flattenArraysToRows", flattenArraysToRows));
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTransformerResultsTableValidateBeforeCall(@javax.annotation.Nonnull Boolean includeMetaData, @javax.annotation.Nonnull Boolean flattenArraysToRows, @javax.annotation.Nullable UUID emailId, @javax.annotation.Nullable UUID smsId, @javax.annotation.Nullable String attachmentId, @javax.annotation.Nullable UUID aiTransformId, @javax.annotation.Nullable UUID aiTransformMappingId, @javax.annotation.Nullable UUID entityId, @javax.annotation.Nullable String entityType, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'includeMetaData' is set
        if (includeMetaData == null) {
            throw new ApiException("Missing the required parameter 'includeMetaData' when calling getTransformerResultsTable(Async)");
        }

        // verify the required parameter 'flattenArraysToRows' is set
        if (flattenArraysToRows == null) {
            throw new ApiException("Missing the required parameter 'flattenArraysToRows' when calling getTransformerResultsTable(Async)");
        }

        return getTransformerResultsTableCall(includeMetaData, flattenArraysToRows, emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort, _callback);

    }


    private ApiResponse<PageTableData> getTransformerResultsTableWithHttpInfo(@javax.annotation.Nonnull Boolean includeMetaData, @javax.annotation.Nonnull Boolean flattenArraysToRows, @javax.annotation.Nullable UUID emailId, @javax.annotation.Nullable UUID smsId, @javax.annotation.Nullable String attachmentId, @javax.annotation.Nullable UUID aiTransformId, @javax.annotation.Nullable UUID aiTransformMappingId, @javax.annotation.Nullable UUID entityId, @javax.annotation.Nullable String entityType, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort) throws ApiException {
        okhttp3.Call localVarCall = getTransformerResultsTableValidateBeforeCall(includeMetaData, flattenArraysToRows, emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort, null);
        Type localVarReturnType = new TypeToken<PageTableData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getTransformerResultsTableAsync(@javax.annotation.Nonnull Boolean includeMetaData, @javax.annotation.Nonnull Boolean flattenArraysToRows, @javax.annotation.Nullable UUID emailId, @javax.annotation.Nullable UUID smsId, @javax.annotation.Nullable String attachmentId, @javax.annotation.Nullable UUID aiTransformId, @javax.annotation.Nullable UUID aiTransformMappingId, @javax.annotation.Nullable UUID entityId, @javax.annotation.Nullable String entityType, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort, final ApiCallback<PageTableData> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTransformerResultsTableValidateBeforeCall(includeMetaData, flattenArraysToRows, emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageTableData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIgetTransformerResultsTableRequest {
        @javax.annotation.Nonnull
        private final Boolean includeMetaData;
        @javax.annotation.Nonnull
        private final Boolean flattenArraysToRows;
        @javax.annotation.Nullable
        private UUID emailId;
        @javax.annotation.Nullable
        private UUID smsId;
        ...
        private APIgetTransformerResultsTableRequest(@javax.annotation.Nonnull Boolean includeMetaData, @javax.annotation.Nonnull Boolean flattenArraysToRows) {
            this.includeMetaData = includeMetaData;
            this.flattenArraysToRows = flattenArraysToRows;
        }

        /**
         * Set emailId
         * @param emailId  (optional)
         * @return APIgetTransformerResultsTableRequest
         */
        public APIgetTransformerResultsTableRequest emailId(@javax.annotation.Nullable UUID emailId) {
            this.emailId = emailId;
            return this;
        }
         ...
         * @return APIgetTransformerResultsTableRequest
         */
        public APIgetTransformerResultsTableRequest smsId(@javax.annotation.Nullable UUID smsId) {
            this.smsId = smsId;
            return this;
        }
         ...
         * @return APIgetTransformerResultsTableRequest
         */
        public APIgetTransformerResultsTableRequest attachmentId(@javax.annotation.Nullable String attachmentId) {
            this.attachmentId = attachmentId;
            return this;
        }
         ...
         * @return APIgetTransformerResultsTableRequest
         */
        public APIgetTransformerResultsTableRequest aiTransformId(@javax.annotation.Nullable UUID aiTransformId) {
            this.aiTransformId = aiTransformId;
            return this;
        }
         ...
         * @return APIgetTransformerResultsTableRequest
         */
        public APIgetTransformerResultsTableRequest aiTransformMappingId(@javax.annotation.Nullable UUID aiTransformMappingId) {
            this.aiTransformMappingId = aiTransformMappingId;
            return this;
        }
         ...
         * @return APIgetTransformerResultsTableRequest
         */
        public APIgetTransformerResultsTableRequest entityId(@javax.annotation.Nullable UUID entityId) {
            this.entityId = entityId;
            return this;
        }
         ...
         * @return APIgetTransformerResultsTableRequest
         */
        public APIgetTransformerResultsTableRequest entityType(@javax.annotation.Nullable String entityType) {
            this.entityType = entityType;
            return this;
        }
         ...
         * @return APIgetTransformerResultsTableRequest
         */
        public APIgetTransformerResultsTableRequest page(@javax.annotation.Nullable Integer page) {
            this.page = page;
            return this;
        }
         ...
         * @return APIgetTransformerResultsTableRequest
         */
        public APIgetTransformerResultsTableRequest size(@javax.annotation.Nullable Integer size) {
            this.size = size;
            return this;
        }
         ...
         * @return APIgetTransformerResultsTableRequest
         */
        public APIgetTransformerResultsTableRequest sort(@javax.annotation.Nullable String sort) {
            this.sort = sort;
            return this;
        }

        /**
         * Build call for getTransformerResultsTable
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute getTransformerResultsTable request
       ...
       <caption>Response Details</caption>
         ...
         */
        public PageTableData execute() throws ApiException {
            ApiResponse<PageTableData> localVarResp = getTransformerResultsTableWithHttpInfo(includeMetaData, flattenArraysToRows, emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort);
            return localVarResp.getData();
        }

        /**
         * Execute getTransformerResultsTable request with HTTP info returned
         * @return ApiResponse&lt;PageTableData&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<PageTableData> executeWithHttpInfo() throws ApiException {
            return getTransformerResultsTableWithHttpInfo(includeMetaData, flattenArraysToRows, emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort);
        }

        /**
         * Execute getTransformerResultsTable request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<PageTableData> _callback) throws ApiException {
            return getTransformerResultsTableAsync(includeMetaData, flattenArraysToRows, emailId, smsId, attachmentId, aiTransformId, aiTransformMappingId, entityId, entityType, page, size, sort, _callback);
        }
    }
     ...
     * @param includeMetaData  (required)
     * @param flattenArraysToRows  (required)
     * @return APIgetTransformerResultsTableRequest
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public APIgetTransformerResultsTableRequest getTransformerResultsTable(@javax.annotation.Nonnull Boolean includeMetaData, @javax.annotation.Nonnull Boolean flattenArraysToRows) {
        return new APIgetTransformerResultsTableRequest(includeMetaData, flattenArraysToRows);
    }
    ...
    private okhttp3.Call testTransformerMappingMatchCall(@javax.annotation.Nonnull UUID id, @javax.annotation.Nullable UUID emailId, @javax.annotation.Nullable UUID smsId, @javax.annotation.Nullable String attachmentId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/ai/transformer/mappings/{id}/match"
            .replace("{" + "id" + "}", localVarApiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call testTransformerMappingMatchValidateBeforeCall(@javax.annotation.Nonnull UUID id, @javax.annotation.Nullable UUID emailId, @javax.annotation.Nullable UUID smsId, @javax.annotation.Nullable String attachmentId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling testTransformerMappingMatch(Async)");
        }

        return testTransformerMappingMatchCall(id, emailId, smsId, attachmentId, _callback);

    }


    private ApiResponse<AITransformMappingMatchResult> testTransformerMappingMatchWithHttpInfo(@javax.annotation.Nonnull UUID id, @javax.annotation.Nullable UUID emailId, @javax.annotation.Nullable UUID smsId, @javax.annotation.Nullable String attachmentId) throws ApiException {
        okhttp3.Call localVarCall = testTransformerMappingMatchValidateBeforeCall(id, emailId, smsId, attachmentId, null);
        Type localVarReturnType = new TypeToken<AITransformMappingMatchResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call testTransformerMappingMatchAsync(@javax.annotation.Nonnull UUID id, @javax.annotation.Nullable UUID emailId, @javax.annotation.Nullable UUID smsId, @javax.annotation.Nullable String attachmentId, final ApiCallback<AITransformMappingMatchResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = testTransformerMappingMatchValidateBeforeCall(id, emailId, smsId, attachmentId, _callback);
        Type localVarReturnType = new TypeToken<AITransformMappingMatchResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APItestTransformerMappingMatchRequest {
        @javax.annotation.Nonnull
        private final UUID id;
        @javax.annotation.Nullable
        private UUID emailId;
        ...
        private APItestTransformerMappingMatchRequest(@javax.annotation.Nonnull UUID id) {
            this.id = id;
        }
         ...
         * Set emailId
         * @param emailId  (optional)
         * @return APItestTransformerMappingMatchRequest
         */
        public APItestTransformerMappingMatchRequest emailId(@javax.annotation.Nullable UUID emailId) {
            this.emailId = emailId;
            return this;
        }
         ...
         * @return APItestTransformerMappingMatchRequest
         */
        public APItestTransformerMappingMatchRequest smsId(@javax.annotation.Nullable UUID smsId) {
            this.smsId = smsId;
            return this;
        }
         ...
         * @return APItestTransformerMappingMatchRequest
         */
        public APItestTransformerMappingMatchRequest attachmentId(@javax.annotation.Nullable String attachmentId) {
            this.attachmentId = attachmentId;
            return this;
        }

        /**
         * Build call for testTransformerMappingMatch
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute testTransformerMappingMatch request
       ...
       <caption>Response Details</caption>
         ...
         */
        public AITransformMappingMatchResult execute() throws ApiException {
            ApiResponse<AITransformMappingMatchResult> localVarResp = testTransformerMappingMatchWithHttpInfo(id, emailId, smsId, attachmentId);
            return localVarResp.getData();
        }

        /**
         * Execute testTransformerMappingMatch request with HTTP info returned
         * @return ApiResponse&lt;AITransformMappingMatchResult&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table border="1">
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<AITransformMappingMatchResult> executeWithHttpInfo() throws ApiException {
            return testTransformerMappingMatchWithHttpInfo(id, emailId, smsId, attachmentId);
        }

        /**
         * Execute testTransformerMappingMatch request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<AITransformMappingMatchResult> _callback) throws ApiException {
            return testTransformerMappingMatchAsync(id, emailId, smsId, attachmentId, _callback);
        }
    }
     ...
     */
    public APItestTransformerMappingMatchRequest testTransformerMappingMatch(@javax.annotation.Nonnull UUID id) {
        return new APItestTransformerMappingMatchRequest(id);
    }
