...
import com.mailslurp.models.AITranformCreateOptions;
...
public class AiControllerApi {
    ...
    private okhttp3.Call createTransformerCall(@javax.annotation.Nonnull AITranformCreateOptions options, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createTransformerValidateBeforeCall(@javax.annotation.Nonnull AITranformCreateOptions options, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'options' is set
        if (options == null) {
            throw new ApiException("Missing the required parameter 'options' when calling createTransformer(Async)");
        }

        return createTransformerCall(options, page, size, sort, _callback);

    }


    private ApiResponse<PageAITransformProjection> createTransformerWithHttpInfo(@javax.annotation.Nonnull AITranformCreateOptions options, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort) throws ApiException {
        okhttp3.Call localVarCall = createTransformerValidateBeforeCall(options, page, size, sort, null);
        Type localVarReturnType = new TypeToken<PageAITransformProjection>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createTransformerAsync(@javax.annotation.Nonnull AITranformCreateOptions options, @javax.annotation.Nullable Integer page, @javax.annotation.Nullable Integer size, @javax.annotation.Nullable String sort, final ApiCallback<PageAITransformProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = createTransformerValidateBeforeCall(options, page, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageAITransformProjection>(){}.getType();
    ...
    public class APIcreateTransformerRequest {
        ...
        private final AITranformCreateOptions options;
        ...
        private APIcreateTransformerRequest(@javax.annotation.Nonnull AITranformCreateOptions options) {
         ...
         */
        public APIcreateTransformerRequest page(@javax.annotation.Nullable Integer page) {
            this.page = page;
            return this;
        }
         ...
         * @return APIcreateTransformerRequest
         */
        public APIcreateTransformerRequest size(@javax.annotation.Nullable Integer size) {
            this.size = size;
            return this;
        }
         ...
         * @return APIcreateTransformerRequest
         */
        public APIcreateTransformerRequest sort(@javax.annotation.Nullable String sort) {
            this.sort = sort;
            return this;
        }
       ...
       <caption>Response Details</caption>
        ...
        public PageAITransformProjection execute() throws ApiException {
            ApiResponse<PageAITransformProjection> localVarResp = createTransformerWithHttpInfo(options, page, size, sort);
       ...
       <caption>Response Details</caption>
        ...
        public ApiResponse<PageAITransformProjection> executeWithHttpInfo() throws ApiException {
            return createTransformerWithHttpInfo(options, page, size, sort);
        }
       ...
       <caption>Response Details</caption>
        ...
        public okhttp3.Call executeAsync(final ApiCallback<PageAITransformProjection> _callback) throws ApiException {
            return createTransformerAsync(options, page, size, sort, _callback);
        }
    }
     ...
     */
    public APIcreateTransformerRequest createTransformer(@javax.annotation.Nonnull AITranformCreateOptions options) {
        return new APIcreateTransformerRequest(options);
    }
    private okhttp3.Call createTransformer1Call(@javax.annotation.Nonnull AITranformCreateOptions aiTranformCreateOptions, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = aiTranformCreateOptions;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createTransformer1ValidateBeforeCall(@javax.annotation.Nonnull AITranformCreateOptions aiTranformCreateOptions, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'aiTranformCreateOptions' is set
        if (aiTranformCreateOptions == null) {
            throw new ApiException("Missing the required parameter 'aiTranformCreateOptions' when calling createTransformer1(Async)");
        }

        return createTransformer1Call(aiTranformCreateOptions, _callback);

    }


    private ApiResponse<AITransformDto> createTransformer1WithHttpInfo(@javax.annotation.Nonnull AITranformCreateOptions aiTranformCreateOptions) throws ApiException {
        okhttp3.Call localVarCall = createTransformer1ValidateBeforeCall(aiTranformCreateOptions, null);
        Type localVarReturnType = new TypeToken<AITransformDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createTransformer1Async(@javax.annotation.Nonnull AITranformCreateOptions aiTranformCreateOptions, final ApiCallback<AITransformDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = createTransformer1ValidateBeforeCall(aiTranformCreateOptions, _callback);
        Type localVarReturnType = new TypeToken<AITransformDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIcreateTransformer1Request {
        @javax.annotation.Nonnull
        private final AITranformCreateOptions aiTranformCreateOptions;

        private APIcreateTransformer1Request(@javax.annotation.Nonnull AITranformCreateOptions aiTranformCreateOptions) {
            this.aiTranformCreateOptions = aiTranformCreateOptions;
        }

        /**
         * Build call for createTransformer1
         * @param _callback ApiCallback API callback
         * @return Call to execute
         * @throws ApiException If fail to serialize the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute createTransformer1 request
       ...
       <caption>Response Details</caption>
        ...
        public AITransformDto execute() throws ApiException {
            ApiResponse<AITransformDto> localVarResp = createTransformer1WithHttpInfo(aiTranformCreateOptions);
            return localVarResp.getData();
        }

        /**
         * Execute createTransformer1 request with HTTP info returned
       ...
       <caption>Response Details</caption>
        ...
        public ApiResponse<AITransformDto> executeWithHttpInfo() throws ApiException {
            return createTransformer1WithHttpInfo(aiTranformCreateOptions);
        }

        /**
         * Execute createTransformer1 request (asynchronously)
         * @param _callback The callback to be executed when the API call finishes
         * @return The request call
         * @throws ApiException If fail to process the API call, e.g. serializing the request body object
         * @http.response.details
       ...
       <caption>Response Details</caption>
        ...
        public okhttp3.Call executeAsync(final ApiCallback<AITransformDto> _callback) throws ApiException {
            return createTransformer1Async(aiTranformCreateOptions, _callback);
        }
    }
     ...
     * @param aiTranformCreateOptions  (required)
     * @return APIcreateTransformer1Request
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIcreateTransformer1Request createTransformer1(@javax.annotation.Nonnull AITranformCreateOptions aiTranformCreateOptions) {
        return new APIcreateTransformer1Request(aiTranformCreateOptions);
    }
