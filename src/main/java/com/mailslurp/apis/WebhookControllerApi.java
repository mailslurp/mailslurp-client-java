...
public class WebhookControllerApi {
     ...
     */
    public okhttp3.Call getAllWebhookResultsCall(OffsetDateTime before, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllWebhookResultsValidateBeforeCall(OffsetDateTime before, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAllWebhookResultsCall(before, page, searchFilter, since, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageWebhookResult getAllWebhookResults(OffsetDateTime before, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort) throws ApiException {
        ApiResponse<PageWebhookResult> localVarResp = getAllWebhookResultsWithHttpInfo(before, page, searchFilter, since, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageWebhookResult> getAllWebhookResultsWithHttpInfo(OffsetDateTime before, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getAllWebhookResultsValidateBeforeCall(before, page, searchFilter, since, size, sort, null);
     ...
     */
    public okhttp3.Call getAllWebhookResultsAsync(OffsetDateTime before, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, final ApiCallback<PageWebhookResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllWebhookResultsValidateBeforeCall(before, page, searchFilter, since, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageWebhookResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getWebhookResultsCall(UUID webhookId, OffsetDateTime before, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getWebhookResultsValidateBeforeCall(UUID webhookId, OffsetDateTime before, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getWebhookResultsCall(webhookId, before, page, searchFilter, since, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageWebhookResult getWebhookResults(UUID webhookId, OffsetDateTime before, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort) throws ApiException {
        ApiResponse<PageWebhookResult> localVarResp = getWebhookResultsWithHttpInfo(webhookId, before, page, searchFilter, since, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageWebhookResult> getWebhookResultsWithHttpInfo(UUID webhookId, OffsetDateTime before, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getWebhookResultsValidateBeforeCall(webhookId, before, page, searchFilter, since, size, sort, null);
        Type localVarReturnType = new TypeToken<PageWebhookResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getWebhookResultsAsync(UUID webhookId, OffsetDateTime before, Integer page, String searchFilter, OffsetDateTime since, Integer size, String sort, final ApiCallback<PageWebhookResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = getWebhookResultsValidateBeforeCall(webhookId, before, page, searchFilter, since, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageWebhookResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
