...
import com.mailslurp.models.WebhookPayload;
...
public class WebhookControllerApi {
     ...
     */
    public okhttp3.Call getTestWebhookPayloadCall(final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTestWebhookPayloadValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getTestWebhookPayloadCall(_callback);
        return localVarCall;
     ...
     */
    public WebhookPayload getTestWebhookPayload() throws ApiException {
        ApiResponse<WebhookPayload> localVarResp = getTestWebhookPayloadWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     * Get test webhook payload example
     * 
     * @return ApiResponse&lt;WebhookPayload&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<WebhookPayload> getTestWebhookPayloadWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getTestWebhookPayloadValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<WebhookPayload>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get test webhook payload example (asynchronously)
     * 
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     ...
     */
    public okhttp3.Call getTestWebhookPayloadAsync(final ApiCallback<WebhookPayload> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTestWebhookPayloadValidateBeforeCall(_callback);
        Type localVarReturnType = new TypeToken<WebhookPayload>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
