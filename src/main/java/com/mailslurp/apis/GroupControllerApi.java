...
public class GroupControllerApi {
     ...
     */
    public okhttp3.Call getAllGroupsCall(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllGroupsValidateBeforeCall(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAllGroupsCall(before, page, since, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageGroupProjection getAllGroups(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        ApiResponse<PageGroupProjection> localVarResp = getAllGroupsWithHttpInfo(before, page, since, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageGroupProjection> getAllGroupsWithHttpInfo(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getAllGroupsValidateBeforeCall(before, page, since, size, sort, null);
     ...
     */
    public okhttp3.Call getAllGroupsAsync(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback<PageGroupProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllGroupsValidateBeforeCall(before, page, since, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageGroupProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getGroupWithContactsPaginatedCall(UUID groupId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getGroupWithContactsPaginatedValidateBeforeCall(UUID groupId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getGroupWithContactsPaginatedCall(groupId, before, page, since, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageContactProjection getGroupWithContactsPaginated(UUID groupId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        ApiResponse<PageContactProjection> localVarResp = getGroupWithContactsPaginatedWithHttpInfo(groupId, before, page, since, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageContactProjection> getGroupWithContactsPaginatedWithHttpInfo(UUID groupId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getGroupWithContactsPaginatedValidateBeforeCall(groupId, before, page, since, size, sort, null);
     ...
     */
    public okhttp3.Call getGroupWithContactsPaginatedAsync(UUID groupId, OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback<PageContactProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getGroupWithContactsPaginatedValidateBeforeCall(groupId, before, page, since, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageContactProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
