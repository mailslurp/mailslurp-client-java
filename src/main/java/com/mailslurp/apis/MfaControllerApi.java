...
import com.mailslurp.models.CreateTotpDeviceBase32SecretKeyOptions;
import com.mailslurp.models.CreateTotpDeviceCustomOptions;
...
public class MfaControllerApi {
    ...
    private okhttp3.Call createTotpDeviceForBase32SecretKeyCall(@javax.annotation.Nonnull CreateTotpDeviceBase32SecretKeyOptions createTotpDeviceBase32SecretKeyOptions, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = createTotpDeviceBase32SecretKeyOptions;

        // create path and map variables
        String localVarPath = "/mfa/totp/device/base32SecretKey";
    ...
    private okhttp3.Call createTotpDeviceForBase32SecretKeyValidateBeforeCall(@javax.annotation.Nonnull CreateTotpDeviceBase32SecretKeyOptions createTotpDeviceBase32SecretKeyOptions, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'createTotpDeviceBase32SecretKeyOptions' is set
        if (createTotpDeviceBase32SecretKeyOptions == null) {
            throw new ApiException("Missing the required parameter 'createTotpDeviceBase32SecretKeyOptions' when calling createTotpDeviceForBase32SecretKey(Async)");
        }

        return createTotpDeviceForBase32SecretKeyCall(createTotpDeviceBase32SecretKeyOptions, _callback);

    }


    private ApiResponse<TotpDeviceDto> createTotpDeviceForBase32SecretKeyWithHttpInfo(@javax.annotation.Nonnull CreateTotpDeviceBase32SecretKeyOptions createTotpDeviceBase32SecretKeyOptions) throws ApiException {
        okhttp3.Call localVarCall = createTotpDeviceForBase32SecretKeyValidateBeforeCall(createTotpDeviceBase32SecretKeyOptions, null);
        Type localVarReturnType = new TypeToken<TotpDeviceDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createTotpDeviceForBase32SecretKeyAsync(@javax.annotation.Nonnull CreateTotpDeviceBase32SecretKeyOptions createTotpDeviceBase32SecretKeyOptions, final ApiCallback<TotpDeviceDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = createTotpDeviceForBase32SecretKeyValidateBeforeCall(createTotpDeviceBase32SecretKeyOptions, _callback);
        Type localVarReturnType = new TypeToken<TotpDeviceDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class APIcreateTotpDeviceForBase32SecretKeyRequest {
        @javax.annotation.Nonnull
        private final CreateTotpDeviceBase32SecretKeyOptions createTotpDeviceBase32SecretKeyOptions;

        private APIcreateTotpDeviceForBase32SecretKeyRequest(@javax.annotation.Nonnull CreateTotpDeviceBase32SecretKeyOptions createTotpDeviceBase32SecretKeyOptions) {
            this.createTotpDeviceBase32SecretKeyOptions = createTotpDeviceBase32SecretKeyOptions;
        }

        /**
         * Build call for createTotpDeviceForBase32SecretKey
       ...
       <caption>Response Details</caption>
        ...
        /**
         * Execute createTotpDeviceForBase32SecretKey request
       ...
       <caption>Response Details</caption>
        ...
        public TotpDeviceDto execute() throws ApiException {
            ApiResponse<TotpDeviceDto> localVarResp = createTotpDeviceForBase32SecretKeyWithHttpInfo(createTotpDeviceBase32SecretKeyOptions);
            return localVarResp.getData();
        }

        /**
         * Execute createTotpDeviceForBase32SecretKey request with HTTP info returned
       ...
       <caption>Response Details</caption>
        ...
        public ApiResponse<TotpDeviceDto> executeWithHttpInfo() throws ApiException {
            return createTotpDeviceForBase32SecretKeyWithHttpInfo(createTotpDeviceBase32SecretKeyOptions);
        }

        /**
         * Execute createTotpDeviceForBase32SecretKey request (asynchronously)
       ...
       <caption>Response Details</caption>
        ...
        public okhttp3.Call executeAsync(final ApiCallback<TotpDeviceDto> _callback) throws ApiException {
            return createTotpDeviceForBase32SecretKeyAsync(createTotpDeviceBase32SecretKeyOptions, _callback);
        }
    }
     ...
     * @param createTotpDeviceBase32SecretKeyOptions  (required)
     * @return APIcreateTotpDeviceForBase32SecretKeyRequest
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public APIcreateTotpDeviceForBase32SecretKeyRequest createTotpDeviceForBase32SecretKey(@javax.annotation.Nonnull CreateTotpDeviceBase32SecretKeyOptions createTotpDeviceBase32SecretKeyOptions) {
        return new APIcreateTotpDeviceForBase32SecretKeyRequest(createTotpDeviceBase32SecretKeyOptions);
    }
    private okhttp3.Call createTotpDeviceForCustomCall(@javax.annotation.Nonnull CreateTotpDeviceCustomOptions createTotpDeviceCustomOptions, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = createTotpDeviceCustomOptions;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createTotpDeviceForCustomValidateBeforeCall(@javax.annotation.Nonnull CreateTotpDeviceCustomOptions createTotpDeviceCustomOptions, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'createTotpDeviceCustomOptions' is set
        if (createTotpDeviceCustomOptions == null) {
            throw new ApiException("Missing the required parameter 'createTotpDeviceCustomOptions' when calling createTotpDeviceForCustom(Async)");
        }

        return createTotpDeviceForCustomCall(createTotpDeviceCustomOptions, _callback);

    }


    private ApiResponse<TotpDeviceDto> createTotpDeviceForCustomWithHttpInfo(@javax.annotation.Nonnull CreateTotpDeviceCustomOptions createTotpDeviceCustomOptions) throws ApiException {
        okhttp3.Call localVarCall = createTotpDeviceForCustomValidateBeforeCall(createTotpDeviceCustomOptions, null);
        Type localVarReturnType = new TypeToken<TotpDeviceDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createTotpDeviceForCustomAsync(@javax.annotation.Nonnull CreateTotpDeviceCustomOptions createTotpDeviceCustomOptions, final ApiCallback<TotpDeviceDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = createTotpDeviceForCustomValidateBeforeCall(createTotpDeviceCustomOptions, _callback);
        Type localVarReturnType = new TypeToken<TotpDeviceDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIcreateTotpDeviceForCustomRequest {
        @javax.annotation.Nonnull
        private final CreateTotpDeviceCustomOptions createTotpDeviceCustomOptions;

        private APIcreateTotpDeviceForCustomRequest(@javax.annotation.Nonnull CreateTotpDeviceCustomOptions createTotpDeviceCustomOptions) {
            this.createTotpDeviceCustomOptions = createTotpDeviceCustomOptions;
        }
       ...
       <caption>Response Details</caption>
         ...
         */
        public TotpDeviceDto execute() throws ApiException {
            ApiResponse<TotpDeviceDto> localVarResp = createTotpDeviceForCustomWithHttpInfo(createTotpDeviceCustomOptions);
            return localVarResp.getData();
        }
       ...
       <caption>Response Details</caption>
         ...
         */
        public ApiResponse<TotpDeviceDto> executeWithHttpInfo() throws ApiException {
            return createTotpDeviceForCustomWithHttpInfo(createTotpDeviceCustomOptions);
        }
       ...
       <caption>Response Details</caption>
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<TotpDeviceDto> _callback) throws ApiException {
            return createTotpDeviceForCustomAsync(createTotpDeviceCustomOptions, _callback);
        }
    }
     ...
     * @param createTotpDeviceCustomOptions  (required)
     ...
     */
    public APIcreateTotpDeviceForCustomRequest createTotpDeviceForCustom(@javax.annotation.Nonnull CreateTotpDeviceCustomOptions createTotpDeviceCustomOptions) {
        return new APIcreateTotpDeviceForCustomRequest(createTotpDeviceCustomOptions);
    }
