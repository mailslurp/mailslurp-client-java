...
public class MfaControllerApi {
    ...
    private okhttp3.Call getTotpDeviceCodeCall(@javax.annotation.Nonnull UUID id, @javax.annotation.Nullable OffsetDateTime at, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTotpDeviceCodeValidateBeforeCall(@javax.annotation.Nonnull UUID id, @javax.annotation.Nullable OffsetDateTime at, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getTotpDeviceCode(Async)");
        }

        return getTotpDeviceCodeCall(id, at, _callback);

    }


    private ApiResponse<TotpDeviceCodeDto> getTotpDeviceCodeWithHttpInfo(@javax.annotation.Nonnull UUID id, @javax.annotation.Nullable OffsetDateTime at) throws ApiException {
        okhttp3.Call localVarCall = getTotpDeviceCodeValidateBeforeCall(id, at, null);
        Type localVarReturnType = new TypeToken<TotpDeviceCodeDto>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getTotpDeviceCodeAsync(@javax.annotation.Nonnull UUID id, @javax.annotation.Nullable OffsetDateTime at, final ApiCallback<TotpDeviceCodeDto> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTotpDeviceCodeValidateBeforeCall(id, at, _callback);
        Type localVarReturnType = new TypeToken<TotpDeviceCodeDto>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public class APIgetTotpDeviceCodeRequest {
       ...
       <caption>Response Details</caption>
        ...
        public TotpDeviceCodeDto execute() throws ApiException {
            ApiResponse<TotpDeviceCodeDto> localVarResp = getTotpDeviceCodeWithHttpInfo(id, at);
            return localVarResp.getData();
        }
       ...
       <caption>Response Details</caption>
        ...
        public ApiResponse<TotpDeviceCodeDto> executeWithHttpInfo() throws ApiException {
            return getTotpDeviceCodeWithHttpInfo(id, at);
        }
       ...
       <caption>Response Details</caption>
        ...
        public okhttp3.Call executeAsync(final ApiCallback<TotpDeviceCodeDto> _callback) throws ApiException {
            return getTotpDeviceCodeAsync(id, at, _callback);
        }
    }
