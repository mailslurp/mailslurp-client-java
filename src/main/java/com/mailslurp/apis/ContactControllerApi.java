...
public class ContactControllerApi {
     ...
     */
    public okhttp3.Call getAllContactsCall(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAllContactsValidateBeforeCall(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getAllContactsCall(before, page, since, size, sort, _callback);
        return localVarCall;
     ...
     */
    public PageContactProjection getAllContacts(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        ApiResponse<PageContactProjection> localVarResp = getAllContactsWithHttpInfo(before, page, since, size, sort);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageContactProjection> getAllContactsWithHttpInfo(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort) throws ApiException {
        okhttp3.Call localVarCall = getAllContactsValidateBeforeCall(before, page, since, size, sort, null);
     ...
     */
    public okhttp3.Call getAllContactsAsync(OffsetDateTime before, Integer page, OffsetDateTime since, Integer size, String sort, final ApiCallback<PageContactProjection> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAllContactsValidateBeforeCall(before, page, since, size, sort, _callback);
        Type localVarReturnType = new TypeToken<PageContactProjection>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public byte[] getContactVCard(UUID contactId) throws ApiException {
        ApiResponse<byte[]> localVarResp = getContactVCardWithHttpInfo(contactId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<byte[]> getContactVCardWithHttpInfo(UUID contactId) throws ApiException {
     ...
     */
    public okhttp3.Call getContactVCardAsync(UUID contactId, final ApiCallback<byte[]> _callback) throws ApiException {
