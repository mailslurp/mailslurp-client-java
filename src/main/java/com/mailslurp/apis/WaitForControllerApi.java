...
public class WaitForControllerApi {
     ...
     */
    public okhttp3.Call waitForMatchingFirstEmailCall(MatchOptions matchOptions, UUID inboxId, Long timeout, Boolean unreadOnly, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = matchOptions;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call waitForMatchingFirstEmailValidateBeforeCall(MatchOptions matchOptions, UUID inboxId, Long timeout, Boolean unreadOnly, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = waitForMatchingFirstEmailCall(matchOptions, inboxId, timeout, unreadOnly, _callback);
        return localVarCall;
    ...
    public Email waitForMatchingFirstEmail(MatchOptions matchOptions, UUID inboxId, Long timeout, Boolean unreadOnly) throws ApiException {
        ApiResponse<Email> localVarResp = waitForMatchingFirstEmailWithHttpInfo(matchOptions, inboxId, timeout, unreadOnly);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<Email> waitForMatchingFirstEmailWithHttpInfo(MatchOptions matchOptions, UUID inboxId, Long timeout, Boolean unreadOnly) throws ApiException {
        okhttp3.Call localVarCall = waitForMatchingFirstEmailValidateBeforeCall(matchOptions, inboxId, timeout, unreadOnly, null);
        Type localVarReturnType = new TypeToken<Email>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call waitForMatchingFirstEmailAsync(MatchOptions matchOptions, UUID inboxId, Long timeout, Boolean unreadOnly, final ApiCallback<Email> _callback) throws ApiException {

        okhttp3.Call localVarCall = waitForMatchingFirstEmailValidateBeforeCall(matchOptions, inboxId, timeout, unreadOnly, _callback);
        Type localVarReturnType = new TypeToken<Email>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Wait for or fetch the email with a given index in the inbox specified. IF indx doesn&#39;t exist waits for it to exist or timeout to occur. (asynchronously)
     * If nth email is already present in inbox then return it. If not hold the connection open until timeout expires or the nth email is received and returned.
     * @param inboxId Id of the inbox you are fetching emails from (optional)
     * @param index Zero based index of the email to wait for. If an inbox has 1 email already and you want to wait for the 2nd email pass index&#x3D;1 (optional, default to 0)
     * @param timeout Max milliseconds to wait for the nth email if not already present (optional)
