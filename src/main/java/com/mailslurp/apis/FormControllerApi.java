...
public class FormControllerApi {
     ...
     */
    public okhttp3.Call submitFormCall(String emailAddress, String redirectTo, String spamCheck, String subject, String successMessage, String to, String otherParameters, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call submitFormValidateBeforeCall(String emailAddress, String redirectTo, String spamCheck, String subject, String successMessage, String to, String otherParameters, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = submitFormCall(emailAddress, redirectTo, spamCheck, subject, successMessage, to, otherParameters, _callback);
        return localVarCall;
    ...
    public String submitForm(String emailAddress, String redirectTo, String spamCheck, String subject, String successMessage, String to, String otherParameters) throws ApiException {
        ApiResponse<String> localVarResp = submitFormWithHttpInfo(emailAddress, redirectTo, spamCheck, subject, successMessage, to, otherParameters);
    ...
    public ApiResponse<String> submitFormWithHttpInfo(String emailAddress, String redirectTo, String spamCheck, String subject, String successMessage, String to, String otherParameters) throws ApiException {
        okhttp3.Call localVarCall = submitFormValidateBeforeCall(emailAddress, redirectTo, spamCheck, subject, successMessage, to, otherParameters, null);
     ...
     */
    public okhttp3.Call submitFormAsync(String emailAddress, String redirectTo, String spamCheck, String subject, String successMessage, String to, String otherParameters, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = submitFormValidateBeforeCall(emailAddress, redirectTo, spamCheck, subject, successMessage, to, otherParameters, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
