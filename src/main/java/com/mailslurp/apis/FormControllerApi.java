...
public class FormControllerApi {
    ...
    private okhttp3.Call submitFormCall(@javax.annotation.Nullable String to, @javax.annotation.Nullable String subject, @javax.annotation.Nullable String redirectTo, @javax.annotation.Nullable String emailAddress, @javax.annotation.Nullable String successMessage, @javax.annotation.Nullable String spamCheck, @javax.annotation.Nullable String otherParameters, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call submitFormValidateBeforeCall(@javax.annotation.Nullable String to, @javax.annotation.Nullable String subject, @javax.annotation.Nullable String redirectTo, @javax.annotation.Nullable String emailAddress, @javax.annotation.Nullable String successMessage, @javax.annotation.Nullable String spamCheck, @javax.annotation.Nullable String otherParameters, final ApiCallback _callback) throws ApiException {
        return submitFormCall(to, subject, redirectTo, emailAddress, successMessage, spamCheck, otherParameters, _callback);

    }


    private ApiResponse<String> submitFormWithHttpInfo(@javax.annotation.Nullable String to, @javax.annotation.Nullable String subject, @javax.annotation.Nullable String redirectTo, @javax.annotation.Nullable String emailAddress, @javax.annotation.Nullable String successMessage, @javax.annotation.Nullable String spamCheck, @javax.annotation.Nullable String otherParameters) throws ApiException {
    ...
    private okhttp3.Call submitFormAsync(@javax.annotation.Nullable String to, @javax.annotation.Nullable String subject, @javax.annotation.Nullable String redirectTo, @javax.annotation.Nullable String emailAddress, @javax.annotation.Nullable String successMessage, @javax.annotation.Nullable String spamCheck, @javax.annotation.Nullable String otherParameters, final ApiCallback<String> _callback) throws ApiException {
    ...
    public class APIsubmitFormRequest {
         ...
         * @return APIsubmitFormRequest
         */
        public APIsubmitFormRequest redirectTo(@javax.annotation.Nullable String redirectTo) {
       ...
       <caption>Response Details</caption>
        ...
        public ApiResponse<String> executeWithHttpInfo() throws ApiException {
            return submitFormWithHttpInfo(to, subject, redirectTo, emailAddress, successMessage, spamCheck, otherParameters);
        }
       ...
       <caption>Response Details</caption>
        ...
        public okhttp3.Call executeAsync(final ApiCallback<String> _callback) throws ApiException {
            return submitFormAsync(to, subject, redirectTo, emailAddress, successMessage, spamCheck, otherParameters, _callback);
        }
    }
