...
# **createTemplate**
> TemplateDto createTemplate(createTemplateOptions).execute();
...
# **deleteTemplate**
> deleteTemplate(templateId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    TemplateControllerApi apiInstance = new TemplateControllerApi(defaultClient);
    UUID templateId = UUID.randomUUID(); // UUID | Template ID
    try {
...
# **getAllTemplates**
> PageTemplateProjection getAllTemplates().page(page).size(size).sort(sort).since(since).before(before).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PageTemplateProjection result = apiInstance.getAllTemplates()
            .page(page)
            .size(size)
            .sort(sort)
            .since(since)
...
<a id="getTemplate"></a>
# **getTemplate**
> TemplateDto getTemplate(templateId).execute();
...
<a id="getTemplatePreviewHtml"></a>
# **getTemplatePreviewHtml**
> String getTemplatePreviewHtml(templateId).execute();
...
<a id="getTemplatePreviewJson"></a>
# **getTemplatePreviewJson**
> TemplatePreview getTemplatePreviewJson(templateId).execute();
...
<a id="getTemplates"></a>
# **getTemplates**
> List&lt;TemplateProjection&gt; getTemplates().execute();
...
# **updateTemplate**
> TemplateDto updateTemplate(templateId, createTemplateOptions).execute();
