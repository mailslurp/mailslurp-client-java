...
<a id="createTrackingPixel"></a>
# **createTrackingPixel**
> TrackingPixelDto createTrackingPixel(createTrackingPixelOptions).execute();
...
<a id="getAllTrackingPixels"></a>
# **getAllTrackingPixels**
> PageTrackingPixelProjection getAllTrackingPixels().page(page).size(size).sort(sort).searchFilter(searchFilter).since(since).before(before).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      PageTrackingPixelProjection result = apiInstance.getAllTrackingPixels()
            .page(page)
            .size(size)
            .sort(sort)
...
<a id="getTrackingPixel"></a>
# **getTrackingPixel**
> TrackingPixelDto getTrackingPixel(id).execute();
