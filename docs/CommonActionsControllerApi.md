...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean favourite = true; // Boolean | favourite
    String inboxType = "inboxType_example"; // String | inboxType
    String name = "name_example"; // String | name
    List<String> tags = Arrays.asList(); // List<String> | tags
 ...
 **inboxType** | **String**| inboxType | [optional] [enum: HTTP_INBOX, SMTP_INBOX]
