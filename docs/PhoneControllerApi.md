...
public class Example {
  public static void main(String[] args) {
    ...
    PhoneControllerApi apiInstance = new PhoneControllerApi(defaultClient);
    String phoneCountry = "phoneCountry_example"; // String | Optional phone country
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **phoneCountry** | **String**| Optional phone country | [optional] [enum: US, GB, AU]
