...
<a id="addPhoneNumberTags"></a>
# **addPhoneNumberTags**
> PhoneNumberDto addPhoneNumberTags(phoneNumberId, phoneNumberTagsOptions).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    PhoneNumberTagsOptions phoneNumberTagsOptions = new PhoneNumberTagsOptions(); // PhoneNumberTagsOptions | 
    try {
      PhoneNumberDto result = apiInstance.addPhoneNumberTags(phoneNumberId, phoneNumberTagsOptions)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PhoneControllerApi#addPhoneNumberTags");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getPhoneNumberTags"></a>
# **getPhoneNumberTags**
> List&lt;String&gt; getPhoneNumberTags(phoneNumberId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID phoneNumberId = UUID.randomUUID(); // UUID | 
    try {
      List<String> result = apiInstance.getPhoneNumberTags(phoneNumberId)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PhoneControllerApi#getPhoneNumberTags");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    List<String> tag = Arrays.asList(); // List<String> | Optional tags to filter by. A phone must include all provided tags
...
| **tag** | [**List&lt;String&gt;**](String)| Optional tags to filter by. A phone must include all provided tags | [optional] |
...
<a id="getPhoneTags"></a>
# **getPhoneTags**
> List&lt;String&gt; getPhoneTags().search(search).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String search = "search_example"; // String | Optional search filter
    try {
      List<String> result = apiInstance.getPhoneTags()
            .search(search)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PhoneControllerApi#getPhoneTags");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="removePhoneNumberTags"></a>
# **removePhoneNumberTags**
> PhoneNumberDto removePhoneNumberTags(phoneNumberId, phoneNumberTagsOptions).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    PhoneNumberTagsOptions phoneNumberTagsOptions = new PhoneNumberTagsOptions(); // PhoneNumberTagsOptions | 
    try {
      PhoneNumberDto result = apiInstance.removePhoneNumberTags(phoneNumberId, phoneNumberTagsOptions)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PhoneControllerApi#removePhoneNumberTags");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="setPhoneNumberTags"></a>
# **setPhoneNumberTags**
> PhoneNumberDto setPhoneNumberTags(phoneNumberId, phoneNumberTagsOptions).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    PhoneNumberTagsOptions phoneNumberTagsOptions = new PhoneNumberTagsOptions(); // PhoneNumberTagsOptions | 
    try {
      PhoneNumberDto result = apiInstance.setPhoneNumberTags(phoneNumberId, phoneNumberTagsOptions)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling PhoneControllerApi#setPhoneNumberTags");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
