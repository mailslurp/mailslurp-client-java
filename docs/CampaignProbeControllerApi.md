...
<a id="compareCampaignProbeRuns"></a>
# **compareCampaignProbeRuns**
> CampaignProbeRunComparisonDto compareCampaignProbeRuns(probeId, runId, otherRunId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      CampaignProbeRunComparisonDto result = apiInstance.compareCampaignProbeRuns(probeId, runId, otherRunId)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CampaignProbeControllerApi#compareCampaignProbeRuns");
...
<a id="getCampaignProbeRun"></a>
# **getCampaignProbeRun**
> CampaignProbeRunDto getCampaignProbeRun(probeId, runId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID runId = UUID.randomUUID(); // UUID | 
    try {
      CampaignProbeRunDto result = apiInstance.getCampaignProbeRun(probeId, runId)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling CampaignProbeControllerApi#getCampaignProbeRun");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
