...
<a id="getAvailableDomainRegions"></a>
# **getAvailableDomainRegions**
> DomainRegionGroupsDto getAvailableDomainRegions().inboxType(inboxType).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DomainRegionGroupsDto result = apiInstance.getAvailableDomainRegions()
            .inboxType(inboxType)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DomainControllerApi#getAvailableDomainRegions");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
