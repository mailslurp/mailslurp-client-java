...
public class Example {
  public static void main(String[] args) {
    ...
    UUID domainId = new UUID(); // UUID | ID of custom domain to use for email address.
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean allowCatchAll = true; // Boolean | 
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID inboxId = new UUID(); // UUID | ID of the inbox you want to send the email from
    SendEmailOptions sendEmailOptions = new SendEmailOptions(); // SendEmailOptions | 
    OffsetDateTime sendAtTimestamp = new OffsetDateTime(); // OffsetDateTime | Sending timestamp
