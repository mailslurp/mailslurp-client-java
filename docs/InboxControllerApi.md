...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean allowTeamAccess = true; // Boolean | Grant team access to this inbox and the emails that belong to it for team members of your organization.
    ...
    try {
      Inbox result = apiInstance.createInbox(allowTeamAccess, description, emailAddress, expiresAt, expiresIn, favourite, name, tags, useDomainPool);
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean teamAccess = false; // Boolean | Optionally filter by team access. Defaults to false so organization inboxes are not included
    try {
