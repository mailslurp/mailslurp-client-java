...
public class Example {
  public static void main(String[] args) {
    ...
    String search = "search_example"; // String | Optionally filter by search words partial matching name and email address
...
<a id="getOrCreateInboxPlusAddress"></a>
# **getOrCreateInboxPlusAddress**
> PlusAddressDto getOrCreateInboxPlusAddress(inboxId, fullAddress).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    InboxControllerApi apiInstance = new InboxControllerApi(defaultClient);
    UUID inboxId = UUID.randomUUID(); // UUID | ID of the inbox you want to target
    String fullAddress = "fullAddress_example"; // String | Full recipient address including +suffix. Example: `inbox+alias@domain.com`
    try {
      PlusAddressDto result = apiInstance.getOrCreateInboxPlusAddress(inboxId, fullAddress)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling InboxControllerApi#getOrCreateInboxPlusAddress");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **inboxId** | **UUID**| ID of the inbox you want to target | |
...
<a id="getOrCreatePlusAddressByFullAddress"></a>
# **getOrCreatePlusAddressByFullAddress**
> PlusAddressDto getOrCreatePlusAddressByFullAddress(fullAddress).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String fullAddress = "fullAddress_example"; // String | Full recipient address including +suffix. Example: `inbox+alias@domain.com`
    try {
      PlusAddressDto result = apiInstance.getOrCreatePlusAddressByFullAddress(fullAddress)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling InboxControllerApi#getOrCreatePlusAddressByFullAddress");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="importEmailIntoInbox"></a>
# **importEmailIntoInbox**
> Email importEmailIntoInbox(inboxId, importEmailOptions).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    InboxControllerApi apiInstance = new InboxControllerApi(defaultClient);
    UUID inboxId = UUID.randomUUID(); // UUID | 
    ImportEmailOptions importEmailOptions = new ImportEmailOptions(); // ImportEmailOptions | 
    try {
      Email result = apiInstance.importEmailIntoInbox(inboxId, importEmailOptions)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling InboxControllerApi#importEmailIntoInbox");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="importEmailIntoInboxBytes"></a>
# **importEmailIntoInboxBytes**
> Email importEmailIntoInboxBytes(inboxId, body).externalId(externalId).runPipeline(runPipeline).overrideMessageId(overrideMessageId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean runPipeline = false; // Boolean | 
    Boolean overrideMessageId = true; // Boolean | 
    try {
      Email result = apiInstance.importEmailIntoInboxBytes(inboxId, body)
      ...
      System.err.println("Exception when calling InboxControllerApi#importEmailIntoInboxBytes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| **runPipeline** | **Boolean**|  | [optional] [default to false] |
| **overrideMessageId** | **Boolean**|  | [optional] [default to true] |
...
<a id="importEmailIntoInboxMultipart"></a>
# **importEmailIntoInboxMultipart**
> Email importEmailIntoInboxMultipart(inboxId, _file).externalId(externalId).runPipeline(runPipeline).overrideMessageId(overrideMessageId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean overrideMessageId = true; // Boolean | 
    try {
      Email result = apiInstance.importEmailIntoInboxMultipart(inboxId, _file)
            .externalId(externalId)
            .runPipeline(runPipeline)
            .overrideMessageId(overrideMessageId)
            .execute();
      ...
      System.err.println("Exception when calling InboxControllerApi#importEmailIntoInboxMultipart");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
# **listInboxRulesets**
> PageRulesetDto listInboxRulesets(inboxId).page(page).size(size).sort(sort).searchFilter(searchFilter).since(since).before(before).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    OffsetDateTime before = OffsetDateTime.now(); // OffsetDateTime | Optional filter by created before given date time
    try {
      PageRulesetDto result = apiInstance.listInboxRulesets(inboxId)
            .page(page)
            .size(size)
            .sort(sort)
            .searchFilter(searchFilter)
