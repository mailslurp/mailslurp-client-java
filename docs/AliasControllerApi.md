...
public class Example {
  public static void main(String[] args) {
    ...
    String verificationToken = "verificationToken_example"; // String | verificationToken
    try {
      AliasVerificationResult result = apiInstance.getAliasVerification(aliasId, emailAddress, verificationToken);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AliasControllerApi#getAliasVerification");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
