...
|------------ | ------------- | ------------- | -------------|
|**field** | [**FieldEnum**](#FieldEnum) | Fields of an email, sms, or attachment object that can be used to filter results |  |
|**should** | [**ShouldEnum**](#ShouldEnum) | How the value of the field specified should be compared to the value given in the match options. |  |
