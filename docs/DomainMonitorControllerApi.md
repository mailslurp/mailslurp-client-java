...
<a id="compareDomainMonitorRuns"></a>
# **compareDomainMonitorRuns**
> DomainMonitorRunComparisonDto compareDomainMonitorRuns(monitorId, runId, otherRunId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID otherRunId = UUID.randomUUID(); // UUID | 
    try {
      DomainMonitorRunComparisonDto result = apiInstance.compareDomainMonitorRuns(monitorId, runId, otherRunId)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DomainMonitorControllerApi#compareDomainMonitorRuns");
...
<a id="getDomainMonitorAuthStack"></a>
# **getDomainMonitorAuthStack**
> CheckEmailAuthStackResults getDomainMonitorAuthStack(monitorId).dkimSelector(dkimSelector).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    DomainMonitorControllerApi apiInstance = new DomainMonitorControllerApi(defaultClient);
    UUID monitorId = UUID.randomUUID(); // UUID | 
    String dkimSelector = "dkimSelector_example"; // String | 
    try {
      CheckEmailAuthStackResults result = apiInstance.getDomainMonitorAuthStack(monitorId)
            .dkimSelector(dkimSelector)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DomainMonitorControllerApi#getDomainMonitorAuthStack");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getDomainMonitorRun"></a>
# **getDomainMonitorRun**
> DomainMonitorRunDto getDomainMonitorRun(monitorId, runId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID runId = UUID.randomUUID(); // UUID | 
    try {
      DomainMonitorRunDto result = apiInstance.getDomainMonitorRun(monitorId, runId)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DomainMonitorControllerApi#getDomainMonitorRun");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getDomainMonitorSummary"></a>
# **getDomainMonitorSummary**
> DomainMonitorSummaryDto getDomainMonitorSummary(monitorId).dkimSelector(dkimSelector).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String dkimSelector = "dkimSelector_example"; // String | 
    try {
      DomainMonitorSummaryDto result = apiInstance.getDomainMonitorSummary(monitorId)
            .dkimSelector(dkimSelector)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling DomainMonitorControllerApi#getDomainMonitorSummary");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
