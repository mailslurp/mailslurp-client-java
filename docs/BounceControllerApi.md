...
<a id="getTenantReputationFindings"></a>
# **getTenantReputationFindings**
> TenantReputationFindingsDto getTenantReputationFindings().accountRegion(accountRegion).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    BounceControllerApi apiInstance = new BounceControllerApi(defaultClient);
    String accountRegion = "US_WEST_2_ACCOUNT_STAGING"; // String | Optional account region filter
    try {
      TenantReputationFindingsDto result = apiInstance.getTenantReputationFindings()
            .accountRegion(accountRegion)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling BounceControllerApi#getTenantReputationFindings");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **accountRegion** | **String**| Optional account region filter | [optional] [enum: US_WEST_2_ACCOUNT_STAGING, US_EAST_1_ACCOUNT_STAGING, EU_WEST_1_ACCOUNT_STAGING, US_WEST_2_ACCOUNT_SES_1, EU_WEST_1_ACCOUNT_SES_1, US_WEST_2_ACCOUNT_SES_2, EU_WEST_1_ACCOUNT_SES_2, US_WEST_2_ACCOUNT_BYTEWISE, EU_WEST_1_ACCOUNT_BYTEWISE, US_WEST_2, EU_WEST_1, US_EAST_1] |
...
<a id="getTenantReputationStatusSummary"></a>
# **getTenantReputationStatusSummary**
> TenantReputationStatusSummaryDto getTenantReputationStatusSummary().accountRegion(accountRegion).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String accountRegion = "US_WEST_2_ACCOUNT_STAGING"; // String | Optional account region filter
    try {
      TenantReputationStatusSummaryDto result = apiInstance.getTenantReputationStatusSummary()
            .accountRegion(accountRegion)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling BounceControllerApi#getTenantReputationStatusSummary");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
