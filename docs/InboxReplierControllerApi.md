...
public class Example {
  public static void main(String[] args) {
    ...
    InboxReplierControllerApi apiInstance = new InboxReplierControllerApi(defaultClient);
    UUID id = new UUID(); // UUID | ID of inbox replier
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    InboxReplierControllerApi apiInstance = new InboxReplierControllerApi(defaultClient);
    UUID inboxId = new UUID(); // UUID | Optional inbox id to attach replier to
    try {
...
public class Example {
  public static void main(String[] args) {
    ...
    InboxReplierControllerApi apiInstance = new InboxReplierControllerApi(defaultClient);
    UUID inboxId = new UUID(); // UUID | Optional inbox id to get repliers from
