...
<a id="exportTransformerResults"></a>
# **exportTransformerResults**
> ExportTransformerResponse exportTransformerResults(exportTransformerOptions).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    AiControllerApi apiInstance = new AiControllerApi(defaultClient);
    ExportTransformerOptions exportTransformerOptions = new ExportTransformerOptions(); // ExportTransformerOptions | 
    try {
      ExportTransformerResponse result = apiInstance.exportTransformerResults(exportTransformerOptions)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AiControllerApi#exportTransformerResults");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="getExportTransformerResultsJob"></a>
# **getExportTransformerResultsJob**
> ExportTransformerResultJobDto getExportTransformerResultsJob(id).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID id = UUID.randomUUID(); // UUID | 
    try {
      ExportTransformerResultJobDto result = apiInstance.getExportTransformerResultsJob(id)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling AiControllerApi#getExportTransformerResultsJob");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
> PageAITransformResultProjection getTransformerResults().emailId(emailId).smsId(smsId).attachmentId(attachmentId).aiTransformId(aiTransformId).aiTransformMappingId(aiTransformMappingId).entityId(entityId).entityType(entityType).page(page).size(size).sort(sort).execute();
...
<a id="getTransformerResultsTable"></a>
# **getTransformerResultsTable**
> PageTableData getTransformerResultsTable(includeMetaData, flattenArraysToRows).emailId(emailId).smsId(smsId).attachmentId(attachmentId).aiTransformId(aiTransformId).aiTransformMappingId(aiTransformMappingId).entityId(entityId).entityType(entityType).page(page).size(size).sort(sort).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    AiControllerApi apiInstance = new AiControllerApi(defaultClient);
    Boolean includeMetaData = true; // Boolean | 
    Boolean flattenArraysToRows = true; // Boolean | 
    UUID emailId = UUID.randomUUID(); // UUID | 
    UUID smsId = UUID.randomUUID(); // UUID | 
    String attachmentId = "attachmentId_example"; // String | 
    UUID aiTransformId = UUID.randomUUID(); // UUID | 
    ...
    String sort = "ASC"; // String | Optional createdAt sort direction ASC or DESC
    try {
      PageTableData result = apiInstance.getTransformerResultsTable(includeMetaData, flattenArraysToRows)
            .emailId(emailId)
            .smsId(smsId)
            .attachmentId(attachmentId)
            .aiTransformId(aiTransformId)
      ...
      System.err.println("Exception when calling AiControllerApi#getTransformerResultsTable");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="testTransformerMappingMatch"></a>
# **testTransformerMappingMatch**
> AITransformMappingMatchResult testTransformerMappingMatch(id).emailId(emailId).smsId(smsId).attachmentId(attachmentId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String attachmentId = "attachmentId_example"; // String | 
    try {
      AITransformMappingMatchResult result = apiInstance.testTransformerMappingMatch(id)
            .emailId(emailId)
            .smsId(smsId)
            .attachmentId(attachmentId)
            .execute();
      ...
      System.err.println("Exception when calling AiControllerApi#testTransformerMappingMatch");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
