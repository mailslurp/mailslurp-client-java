...
<a id="checkEmailAudit1"></a>
# **checkEmailAudit1**
> EmailAuditAnalysisResult checkEmailAudit1(emailId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID emailId = UUID.randomUUID(); // UUID | 
    try {
      EmailAuditAnalysisResult result = apiInstance.checkEmailAudit1(emailId)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EmailControllerApi#checkEmailAudit1");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="createEmailAuditForEmail"></a>
# **createEmailAuditForEmail**
> EmailAuditDto createEmailAuditForEmail(emailId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID emailId = UUID.randomUUID(); // UUID | 
    try {
      EmailAuditDto result = apiInstance.createEmailAuditForEmail(emailId)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling EmailControllerApi#createEmailAuditForEmail");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
