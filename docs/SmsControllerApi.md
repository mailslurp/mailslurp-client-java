...
<a id="getSmsCodes"></a>
# **getSmsCodes**
> ExtractCodesResult getSmsCodes(smsId).extractCodesOptions(extractCodesOptions).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    SmsControllerApi apiInstance = new SmsControllerApi(defaultClient);
    UUID smsId = UUID.randomUUID(); // UUID | ID of SMS to extract codes from
    ExtractCodesOptions extractCodesOptions = new ExtractCodesOptions(); // ExtractCodesOptions | 
    try {
      ExtractCodesResult result = apiInstance.getSmsCodes(smsId)
            .extractCodesOptions(extractCodesOptions)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SmsControllerApi#getSmsCodes");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **smsId** | **UUID**| ID of SMS to extract codes from | |
...
<a id="markAllSmsAsRead"></a>
# **markAllSmsAsRead**
> markAllSmsAsRead().read(read).phoneNumberId(phoneNumberId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    UUID phoneNumberId = UUID.randomUUID(); // UUID | 
    try {
      apiInstance.markAllSmsAsRead()
            .read(read)
            .phoneNumberId(phoneNumberId)
            .execute();
    } catch (ApiException e) {
      System.err.println("Exception when calling SmsControllerApi#markAllSmsAsRead");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
<a id="markSmsAsRead"></a>
# **markSmsAsRead**
> SmsDto markSmsAsRead(smsId).read(read).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    Boolean read = true; // Boolean | 
    try {
      SmsDto result = apiInstance.markSmsAsRead(smsId)
            .read(read)
            .execute();
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling SmsControllerApi#markSmsAsRead");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
